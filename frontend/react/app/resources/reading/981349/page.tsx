...
export default function Reading981349Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – An Architectural Revolution</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>An Architectural Revolution</h3>

               {passageHtml === null ? (
                 <div id="passage3" ref={passageRef}>
                   <p>An expert on architectural history expresses his views on trends in urban planning.</p>
                   <p>
                     In the medieval period (5th–15th centuries), the towns and cities of Europe spread in a natural,
                     organic and sometimes haphazard way, according to the social, economic and political needs of the
                     people who lived there. Fortifying towns with high city walls for protection was essential, as was
                     situating them on high ground, giving the residents advance knowledge of any attack. Houses were
                     built from local materials with decorated doorways and windows, usually in a style that reflected a
                     long-standing consensus about architecture. Shops, workshops, schools and communal buildings were
                     inserted between the houses, and streets would converge on a square in the middle of the town where
                     a church and marketplace together symbolised the forces that held the community together.
                   </p>
                   <p>
                     This traditional town design continued for many centuries, but was disrupted in the early
                     twentieth century in the United States, where the new ‘zoning concept’ was introduced. This
                     involved the introduction of the ‘downtown plus suburbs’ template, in which the downtown area was a
                     place dedicated entirely to commerce, and the residential suburbs were where people escaped to after
                     work. Soon afterwards, when cars arrived on the scene, they smashed their way through the narrow
                     streets of the towns and laid for themselves a carpet of tarmac into the surrounding countryside.
                     The result has been an environmental, aesthetic and social disaster, which can continue unchecked
                     in the US only because of the abundance of land there. Europeans, on the other hand, when faced with
                     the suburbanisation of their ancient towns, tend to dedicate themselves to preventing it.
                   </p>
                   <p>
                     But the fight to retain the original character of European towns was complicated by two major
                     events: the First World War of 1914–18 and the rise of the International Style in architecture in
                     the 1920s. The two events were connected. Following the war, Europe experienced the first of many
                     housing crises, as displaced populations and returning soldiers wanted to settle in cities that were
                     already crowded. Meanwhile, the rural population took advantage of improved transport links and
                     greater social mobility and began to migrate to the towns. It was also at this time that the
                     architects of the innovative International Style, such as Le Corbusier, celebrated clean, simple
                     lines created out of concrete, steel and glass. The supporters of this new architectural style
                     rapidly took over the architecture schools and the professional journals, and presented themselves
                     as the only ones who could deal with a housing challenge on a scale that politicians had not
                     encountered before.
                   </p>
                   <p>
                     The International Style started out as revolutionary, with its emphasis on simplicity and
                     industrialised mass-production techniques. It arose from an admirable if rather idealistic desire
                     to soften and blur the barriers between different countries after years of conflict. The style was
                     considered universal because it had no association with any particular culture or nation, and by
                     the 1950s it had become accepted as the only viable one for modern cities. However, by this time it
                     had become less imaginative and varied. Endless demands for new buildings in Europe in the 1960s and
                     1970s meant that there was increasing reliance on a few standard templates, none of them
                     particularly popular with local residents, and many requiring the demolition of much-loved
                     neighbourhoods with a long history.
                   </p>
                   <p>
                     The reconstruction and redevelopment of many British towns in the decades after the Second World
                     War (1939–1945) involved not only the necessary widening of roads but also the destruction of the
                     old fabric of rows of small houses and local shops, sloping roofs, alleyways and interesting little
                     corners and quiet spots. All the colourful, distinctive features of individual urban areas were
                     swept away and replaced with identical high-rise blocks and anonymous shopping malls, glass boxes
                     and concrete squares, none of which had any cultural association with the places where they were
                     built.
                   </p>
                   <p>
                     There is overwhelming evidence that bleak impersonal environments such as these can lead to
                     depression, anxiety and feelings of isolation. The ideal is to have an environment that actively
                     encourages people to come across one another in their local area. This means creating and
                     sustaining a neighbourhood in which it is possible for residents to pass in the street, greet one
                     another, and feel secure because they share a pleasant environment which is cared for reasonably
                     well. Our sense of beauty is rooted in these feelings, and it is the principal reason why people
                     fight to preserve the character of their local area.
                   </p>
                   <p>
                     So what new approach do urban planners need to take? Firstly, new architecture must be of a style
                     which suits the aesthetics of the location and fits in well with the appearance of existing
                     buildings, taking account of the ways in which buildings in that area have been constructed for
                     hundreds of years. What matters as much as an aesthetically pleasing home is having neighbouring
                     houses that conform to similar ideas about what is beautiful; ideally the design of all the
                     buildings in an area should be based on similar architectural values. Fortunately, in many parts of
                     the world there is now increasing pressure being exerted on urban planners and architects to shift
                     their approach towards this ideal. Nowadays, coordinated campaigns against standard ways of
                     building are so common that it has become difficult in some places to build anything new at all,
                     let alone to build in the quantities required. But at least the appearance of a building, rather
                     than just its function, has moved to the top of the agenda.
                   </p>
                 </div>
               ) : (
             ...
             >
               ...
               <div className="question-group">
                 ...
                 <p>
                   ...
                   <br />
                   In boxes <strong>27–30</strong> on your answer sheet, write:
                   <br />
                 ...
                 <div className="question question--plain">
                   <div className="question-text">27. The growth of European towns in the medieval era had to follow strictly organised plans.</div>
                   {renderTfngRadio("q27")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">28. Ensuring the safety of inhabitants was a vital consideration in the design and location of medieval towns.</div>
                   {renderTfngRadio("q28")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">29. In medieval times, the challenges of transporting heavy goods over long distances made it necessary to build houses out of local materials.</div>
                   {renderTfngRadio("q29")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">30. The function of the central square of medieval towns represented two key aspects of urban society.</div>
                   {renderTfngRadio("q30")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Write the correct letter in boxes <strong>31–34</strong> on your answer sheet.
                 </p>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     ...
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> It relied on building materials that were regarded as unattractive.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> It became very fashionable only after an initially sceptical reaction.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> It proposed a solution to the post-war shortage of accommodation.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> It incorporated a few of the best features of traditional urban design.</span>
                   </div>
                   {renderAbcdRadio("q31")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     ...
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> attempting to minimise cultural differences.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> avoiding designs that were over-complicated.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> challenging conservative attitudes to architecture.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> making full use of modern technological advances.</span>
                   </div>
                   {renderAbcdRadio("q32")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     ...
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> consistently ignored the objections of local people.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> based their designs on ideas that were impractical.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> used only a limited number of very predictable forms.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> wasted money by removing long-established districts.</span>
                   </div>
                   {renderAbcdRadio("q33")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     34. What impact of trends in building style in post-war Britain does the writer mention?
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> an increase in the range of construction techniques used</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> a significant expansion in the number of residential streets</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> the creation of areas where people could escape the traffic</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> the loss of architectural details that had made towns unique</span>
                   </div>
                   {renderAbcdRadio("q34")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p style={{ marginBottom: 10 }}>
                   ...
                   <br />
                   Write the correct letter, A–H, in boxes <strong>35–40</strong> on your answer sheet.
                 </p>

                 <div className="parncutt-summary">
                   <p style={{ margin: 0 }}>
                     <strong>Taking a new approach to urban planning</strong>
                     <br />
                     New buildings should be in {renderLetterDropdown("q35", summaryDropdownOptions, true)} with their location and they should be
                     constructed using {renderLetterDropdown("q36", summaryDropdownOptions, true)}. As well as being attractive, homes should have a
                     similar {renderLetterDropdown("q37", summaryDropdownOptions, true)} to that of the surrounding properties. In addition, there
                     should be certain {renderLetterDropdown("q38", summaryDropdownOptions, true)} that a new building shares with older buildings in
                     the area.
                     <br />
                     Fortunately, there is now often a considerable amount of {renderLetterDropdown("q39", summaryDropdownOptions, true)} to the
                     proposals of urban planners. Increasingly, people are realising that focusing purely on a building’s
                     {" "}{renderLetterDropdown("q40", summaryDropdownOptions, true)} is undesirable, and that more importance should be attached to its
