...
export default function Reading856932Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – The New Zealand Writer Maurice Gee</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage3" ref={passageRef}>
                   <p>
                     Maurice Gee was born in Whakatane, a popular coastal town in New Zealand. However, he spent his
                     childhood in the country town of Henderson and it is only the latter that plays a major role in
                     his fiction. Of special significance is Henderson Creek — a small stream — where, Gee said, "I
                     seem to have spent half my boyhood." There, he says, he saw dead animals for the first time,
                     which made a deep impression on him. "I'd run home from the creek to the safety and security of
                     the kitchen," he once said. Gee claimed that the two places were of equal significance: "one the
                     place of safety and affection, the other the place of adventure, danger, excitement."
                   </p>
                   <p>
                     Gee's father was a carpenter who happily allowed Maurice and his brothers free access to tools
                     and materials for making boats in which to explore the creek. His mother's tales of family
                     history were fundamental to Gee's emerging interest in narrative, providing a sense of social
                     history that he would later use in his writing. His memories of primary school in Henderson are
                     intense and detailed. Furthermore, he seems also to transfer their atmosphere to other schools.
                     There can be few factual accounts of a primary school as vivid as Gee's <em>Nelson Central School</em> (1978),
                     which was a major contributor to the history of schooling and one based on extensive oral research.
                   </p>
                   <p>
                     For two years he was a schoolteacher in the town of Paeroa, but he moved on feeling disillusioned
                     with the profession. After three years' casual work in various parts of New Zealand, he spent
                     1961 teaching and writing in England. Ever since university he had been writing. The publication
                     of two stories in the British collection <em>New Authors - Short Story I</em> (1961) created a
                     wider audience for this new voice.
                   </p>
                   <p>
                     A year later <em>The Big Season</em>, Gee's first published novel, was greeted enthusiastically.
                     The poet Louis Johnson wrote it challenges the common idea that most New Zealand novels showed rural life as dull.
                     <em>The New Zealand Herald</em> newspaper found it "not always pleasant, but certainly forceful and sincere."
                     The novel celebrates joy in the game of rugby, New Zealand's national sport and passion. It was unusual in those days
                     for writers to express interest in this topic. The central character, Rob Andrews, tries hard on the rugby field but
                     is distracted by his personal romantic interests. He seems to have betrayed the rugby world, but he has not betrayed
                     himself: for all his confusion he is discovering his own potential. It's possible to say that the author is doing the
                     same thing, because patterns and themes that will shape his subsequent books are seen here for the first time.
                   </p>
                   <p>
                     Gee's third novel was the mystery story <em>In My Father's Den</em> (1972). Despite a rather exaggerated and emotional ending,
                     Gee seems to be more self-assured as an author and in more control of his writing than previously. It was followed by the
                     collection of short stories <em>A Glorious Morning, Comrade</em> (1975), though many of these stories had been written before the
                     novels and could be viewed as apprentice work. In <em>Games of Choice</em> (1976) it is clear that Gee's writing skills are developing
                     quickly. For example, he was able to create a genuine sense of tension and fear. And he really built on this skill and took it to its
                     highest level in his masterpiece <em>Plumb</em> (1978), which provides an image of life in New Zealand over three generations.
                     Local critical response has been enthusiastic and ongoing.
                   </p>
                   <p>
                     Clearly at the height of his powers, Gee combined work on <em>Plumb</em> with his first work of children's fiction.
                     <em>Under the Mountain</em> (1979) is an Auckland tale stimulated by the volcanoes that dot the cityscape.
                     Strange creatures are planning to make the world their own and only Rachel and Theo can save the local population.
                     The battle between good and evil, a beautiful natural world and a dreary one, is the common theme of the books he wrote at this time.
                   </p>
                   <p>
                     <em>Going West</em> (1993), which was met with critical acclaim, is significant because it explores how writers create their work.
                     In the novel, the main character, Rex Perley, writes poetry which has a creek as a repeating image. Gee has said that he will never write
                     his own autobiography, because he cannot betray the people who would appear in it, but he frequently includes his personal experience in his work,
                     such as his knowledge of Henderson Creek. Grounded in reality, but adding images from his imagination, Gee thus shapes and enriches his fictional world.
                   </p>
                   <p>
                     Each of Gee's novels tells us about New Zealand life, and human life in general. Each is full of characters with a variety of themes and unique
                     personalities together with rich images of the natural world. Yet there is always an awareness of danger: one false move and we lose everything.
                     The reviewer, Trevor James, points out the frequency of such words as "abyss," "hole," and "missing" in Gee's writing, which he believes reflects
                     the common desire in New Zealand society not to stand out from the crowd. Rachel Barrowman's biography <em>Maurice Gee: Life and Work</em> was released in 2015.
                     She delves into subjects surrounding Gee that were previously untouched by other biographers. Gee confesses that some of Barrowman's conclusions astonished him and
                     made him rethink what he thought he knew.
                   </p>
                 </div>
               ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               ...
               <div className="question-group">
                 <div className="question-group-title"><strong>Questions 27-33</strong></div>
                 <p>
                   Do the following statements agree with the claims of the writer in Reading Passage 3?
                   <br />
                   In boxes <strong>27–33</strong> on your answer sheet, write:
                   <br />
                 ...
                 <div className="question question--plain">
                   <div className="question-text">27. The town of Whakatane is frequently the setting for Gee's stories.</div>
                   {renderTfngRadio("q27")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">28. For Gee, the kitchen was as important as Henderson Creek.</div>
                   {renderTfngRadio("q28")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">29. Gee was correct to avoid basing any of his characters on his father.</div>
                   {renderTfngRadio("q29")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">30. Gee's mother had a major influence on his development as a storyteller.</div>
                   {renderTfngRadio("q30")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">31. Gee's <em>Nelson Central School</em> was less popular with readers than his imagined stories.</div>
                   {renderTfngRadio("q31")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">32. Gee enjoyed the time he spent working in education in Paeroa.</div>
                   {renderTfngRadio("q32")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">33. Louis Johnson thought that Gee had written a different type of New Zealand novel.</div>
                   {renderTfngRadio("q33")}
                 </div>
               </div>

               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 34-36</strong></div>
                 <p>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     34. The writer concludes that <em>The Big Season</em>
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> enables Gee to experiment with ideas he uses again later.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> develops literary ideas that were popular at the time.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> describes events that Gee himself experienced.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> stresses the importance of team loyalty in sport.</span>
                   </div>
                   {renderAbcdRadio("q34")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     35. The writer suggests that <em>In My Father's Den</em>
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> finishes with an inconclusive climax.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> provided useful practice for <em>A Glorious Morning, Comrade</em>.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> demonstrates a new confidence in Gee's writing.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> took less time to write than <em>A Glorious Morning, Comrade</em>.</span>
                   </div>
                   {renderAbcdRadio("q35")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     36. According to the writer, <em>Games of Choice</em>
                     <br />
                     <strong>A</strong>
                     <span style={{ fontWeight: 400 }}> dealt with different issues to <em>Plumb</em>.</span>
                     <br />
                     <strong>B</strong>
                     <span style={{ fontWeight: 400 }}> was an important influence on the creation of <em>Plumb</em>.</span>
                     <br />
                     <strong>C</strong>
                     <span style={{ fontWeight: 400 }}> describes a family of grandparents, parents, and children.</span>
                     <br />
                     <strong>D</strong>
                     <span style={{ fontWeight: 400 }}> was shocking in its presentation of aggression.</span>
                   </div>
                   {renderAbcdRadio("q36")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p style={{ marginBottom: 10 }}>
                   ...
                   <br />
                   Write the correct letter, <strong>A–H</strong>, in boxes <strong>37–40</strong> on your answer sheet.
                 </p>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">37. Gee's father encouraged him to take an interest in</div>
                   {renderLetterDropdown("q37")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">38. The novel <em>Plumb</em> continues to be praised by</div>
                   {renderLetterDropdown("q38")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">39. Gee once refused to write an autobiography to protect</div>
                   {renderLetterDropdown("q39")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">40. Trevor James refers to certain words to illustrate</div>
                   {renderLetterDropdown("q40")}
                 </div>
               </div>
             </div>
           </div>
