...
export default function Reading155896Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – Inside the Mind of a Fan</title>
         <link
           rel="stylesheet"
            ...
            >
              <div className="question-group">
                ...
                <div className="question question--plain">
                  <div className="question-text">27. An explanation of why watching sport may be emotionally satisfying</div>
                  {renderDropdown("q27", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">28. An explanation of why beginners find sporting tasks difficult</div>
                  {renderDropdown("q28", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">29. A factor that needs to combine with mirroring to attain sporting excellence</div>
                  {renderDropdown("q29", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">30. A comparison of human and animal mirror neurons</div>
                  {renderDropdown("q30", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">31. The first discovery of brain activity related to mirror neurons</div>
                  {renderDropdown("q31", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">32. A claim linking observation to improvement in performance</div>
                  {renderDropdown("q32", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 33-35</strong></div>
                <p>
                  Choose the correct letter, <strong>A</strong>, <strong>B</strong>, <strong>C</strong> or <strong>D</strong>.
                  <br />
                  Write your answers in boxes <strong>33-35</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">33. The writer uses the term ‘grammar of movement’ to mean</div>
                  {renderRadioGroup(
                    "q33",
                    [
                      { value: "A", text: "a level of sporting skill." },
                      { value: "B", text: "a system of words about movement." },
                      { value: "C", text: "a pattern of connected cells." },
                      { value: "D", text: "a type of golf swing." },
                    ],
                    true
                  )}
                </div>
                ...
                <div className="question question--plain">
                  <div className="question-text">34. The writer states that expert players perform their actions</div>
                  {renderRadioGroup(
                    "q34",
                    [
                      { value: "A", text: "without conscious thought." },
                      { value: "B", text: "by planning each phase of movement." },
                      { value: "C", text: "without regular practice." },
                      { value: "D", text: "by thinking about the actions of others." },
                    ],
                    true
                  )}
                </div>
                ...
                <div className="question question--plain">
                  <div className="question-text">35. The writer states that the most common motive for watching sport is to</div>
                  {renderRadioGroup(
                    "q35",
                    [
                      { value: "A", text: "improve personal performance." },
                      { value: "B", text: "feel linked with people of different nationalities." },
                      { value: "C", text: "experience strong positive emotions." },
                      { value: "D", text: "realize what skill consists of." },
                    ],
                    true
                  )}
                </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <div className="question question--plain">
                  <div className="question-text">36. Inexpert sports players are too aware of what they are doing.</div>
                  {renderRadioGroup("q36", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">37. Monkeys have a more complex mirror neuron system than humans.</div>
                  {renderRadioGroup("q37", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">38. Looking at a photograph can activate mirror neurons.</div>
                  {renderRadioGroup("q38", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">39. Gastaut and Bert were both researchers and sports players.</div>
                  {renderRadioGroup("q39", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">40. The mu system is at rest when we are engaged in an activity.</div>
