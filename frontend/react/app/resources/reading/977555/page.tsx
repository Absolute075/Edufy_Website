...
export default function Reading977555Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – A Survivor's Story</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <p>One native bird in New Zealand that has managed to survive the introduction of non-native species</p>
                   <p>
                   ...
                   <p>
                     Moreporks have proved to be ungracious hosts. Scientists trying to establish a population of plovers on Motuora island found that only four birds survived out of 75 placed there. The culprits turned out to be five pairs of moreporks that ate or chased away the new arrivals.
                   </p>
                   <p>
                     Although moreporks are still considered to be relatively common, it is likely that numbers are in gradual decline due to predation and loss of habitat. As the female is a hole-nester, she is vulnerable to predators such as stoats and possums during the breeding season, and eggs and chicks will also be at risk from rats. The use of pesticides is another possible threat to the owls, though not directly. As moreporks are at the top of the food chain, they could be affected by an accumulative poison by consuming prey that has ingested poison.
                   </p>
                   <p>
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">1. Early European settlers made detailed studies of the morepork.</div>
                   {renderTfngRadio("q1")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">2. The Polynesian rat had a negative effect on the number of laughing owls.</div>
                   {renderTfngRadio("q2")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">3. The laughing owl was larger than the morepork.</div>
                   {renderTfngRadio("q3")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">4. Rats pose a risk to young moreporks.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">5. The New Zealand Department of Conservation is hoping to limit the population of moreporks.</div>
                   {renderTfngRadio("q5")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">6. Other bird species are frightened away when they hear the morepork’s cry.</div>
                   {renderTfngRadio("q6")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">7. In Maori tradition, the low call of the morepork had negative associations.</div>
                   {renderTfngRadio("q7")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Choose <strong>ONE WORD ONLY OR/AND A NUMBER</strong> from the passage for each answer.
                   <br />
                   Write your answers in boxes <strong>8–13</strong> on your answer sheet.
                 </p>

                 <p><strong>The Morepork</strong></p>
                 <p><strong>Appearance</strong></p>
                 <p>● approximately {renderTextInput("q8")} in length</p>
                 <p>● large yellow eyes</p>
                 <p>● feathers with fringes to enable quiet flight</p>

                 <p><strong>Nesting</strong></p>
                 <p>● nests in trees, plants or spaces in roots and {renderTextInput("q9")}</p>
                 <p>● after about 35 days, baby moreporks are capable of leaving the nest</p>

                 <p><strong>Hunting</strong></p>
                 <p>● transports its prey using its {renderTextInput("q10")}</p>
                 <p>● can be chased away by other birds during the {renderTextInput("q11")}</p>
                 <p>● attacked {renderTextInput("q12")} that had been introduced to Motuora island</p>

                 <p><strong>Threats</strong></p>
                 <p>● may be exposed to {renderTextInput("q13")} in their prey</p>
               </div>
             </div>
           </div>
         </div>
