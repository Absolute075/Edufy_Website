 ...
 export default function Reading932569Page() {
   ...
   const summaryWordOptions = [
     { value: "A", label: "A - similar structures" },
     { value: "B", label: "B - evolving needs" },
     { value: "C", label: "C - complicated grammar" },
     { value: "D", label: "D - strong emotions" },
     { value: "E", label: "E - intellectual abilities" },
     { value: "F", label: "F - mathematical analysis" },
     { value: "G", label: "G - numerous communities" },
     { value: "H", label: "H - useful descriptions" },
   ];
   ...
   const q31Options = [
     { value: "A", text: "highlighting his own language abilities" },
     { value: "B", text: "outlining his personal fascination with language" },
     { value: "C", text: "proposing his own theory about language development" },
     { value: "D", text: "describing the best way to learn a new language" },
   ];

   const q32Options = [
     { value: "A", text: "compare older and more modern languages" },
     { value: "B", text: "highlight a misconception about language" },
     { value: "C", text: "contrast the study of language and science" },
     { value: "D", text: "illustrate the role of language over time" },
   ];

   const q33Options = [
     { value: "A", text: "It is oversimplified by some academics" },
     { value: "B", text: "It cannot be compared to language" },
     { value: "C", text: "It has been shaped by two factors" },
     { value: "D", text: "It gives humans two distinct skills" },
   ];

   const q34Options = [
     { value: "A", text: "Academics should not pay attention to criticism" },
     { value: "B", text: "Scientific knowledge is advanced by balanced debate" },
     { value: "C", text: "Researchers should not be influenced by public opinion" },
     { value: "D", text: "Controversy rarely leads to a scientific breakthrough" },
   ];
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q35" || key === "q36" || key === "q37" || key === "q38" || key === "q39" || key === "q40") {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – The ability to communicate using language</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     Daniel Everett has devoted his career to understanding a uniquely human attribute
                   </p>
                   <p>
                     A research question of continuing interest to modern academics concerns the origins of nouns,
                     verbs, adjectives and so on - in other words, all the separate components that make up human
                     language. Did they come about suddenly, or did they emerge gradually, adapted over time? Unlike
                     fire, the use of language did not exist before humans first created it, so we must look
                     elsewhere for any beneficial comparison. What is more, every culture in the history of the human
                     race places its own mark on language. It is an invention that embraces all humans and provides
                     us with our most intense source of happiness - focused and ordered thoughts. Homo sapiens has
                     become Homo loquax, as well-known author Tom Wolfe puts it, or in other words 'speaking man'. I
                     would argue that our minds are enabled by language to accomplish tasks that we could otherwise
                     never hope to complete, such as debating philosophy, following recipes and thinking about where
                     our children are going after school.
                   </p>
                   <p>
                     From each of the twenty or more languages I have studied in the Amazon, Mexico and United States
                     over the past decades, I have learned things about our species and our ability to communicate.
                     These are things I would never have learned by living a different life. I have learned about
                     humans' relation to nature, and about living and speaking among ancient cultures living in
                     remote forests. I have learned how words reach into my heart and change my life. Language gives
                     humans their humanity.
                   </p>
                   <p>
                     The human species has the extraordinary ability to express thoughts and feelings with visual
                     symbols and spoken sounds. So it is only natural that scholars should want to learn more about
                     this communicative technology, for nothing has more to tell us about what it means to be human
                     than the forms and uses to which we put language. Indeed, language is the foundation of every
                     human advance, from prehistoric cave paintings, to Thomas Edison's light bulb, to today's
                     digital revolution.
                   </p>
                   <p>
                     No linguist or anthropologist would disagree that language is useful. But there is enormous
                     division about where it came from. Some of these experts say that language was discovered by
                     chance. Others believe that one brilliant Homo sapiens might have invented it about 75,000 years
                     or so ago, as the Native American chief Sequoya invented writing for his people. Still others
                     claim that language is genetically encoded in the human mind. What does seem clear is that all
                     human abilities, including language, derive from identifiable sources - genes and environment.
                     The idea that language is exclusively a product of our environment is as simplistic and wrong as
                     the opposite idea that language grows like hair, shaped by our genes with no learning involved.
                     Language, like human reasoning, is surely the result of both of these sources working together,
                     although the relative proportions of each are more difficult to determine.
                   </p>
                   <p>
                     My own views about human language are sometimes disputed, but this does not make them less worthy
                     of consideration. One of my goals is to give alternatives a fair hearing, even if I ultimately
                     reject them. In the process, it is sometimes necessary to make an argument opposing one
                     particular view; this is standard scientific discourse and vital for progress. So long as we are
                     polite and our evidence is valid, it is a healthy practice.
                   </p>
                   <p>
                     I would define language as a 'cultural tool'. And in order to understand this cultural tool
                     properly, we need to understand something about its original birthplace on the African plains.
                     In addition, we must examine the relationship between language and culture in as many different
                     linguistic groups as possible over the course of history. Then there is the issue of genetic
                     influence on language. Those who support the influence of genes often ask, if language is not
                     genetic, why is it such a universal human characteristic? This is an area that many people feel
                     passionately about. Even among scientists it is sometimes supposed that all languages are 'equal
                     in some way, and any suggestion to the contrary is not popular. However, as I have gone further
                     into the issues, it has become clear that there is limited evidence that language is genetic.
                     This does not mean that language speakers are not equal, but some languages are remarkably
                     complex in terms of their form and framework - the tense systems, the parts of speech - and this
                     is not true of some other languages. It is just not necessary for all languages to have the same
                     form. Languages have developed over time to meet the requirements of their own cultural
                     situation. And the beauty of each one lies in the fact that it is so well suited to its own
                     purposes.
                   </p>
                   <p>
                     So what do researchers need now? Much of the heated opinion in the debate about relative language
                     complexity is actually irrelevant, for the simple reason that we do not have enough practical
                     information about the languages in use today. And in order to gather such details, it is
                     necessary for researchers to do fieldwork. Increasingly, the evidence points away from the idea
                     that languages can be understood by sitting at a desk studying formulas and equations. And while
                     it is beyond doubt that genetics are partly responsible for human languages, we will learn most
                     about those languages by studying how different cultures have adapted them.
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">27. It is useful to equate the discovery of fire with the invention of language.</div>
                   {renderRadioGroup("q27", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">28. The greatest pleasure people have is their ability to think clearly and rationally.</div>
                   {renderRadioGroup("q28", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">29. Tom Wolfe uses an expression that is copied by other authors.</div>
                   {renderRadioGroup("q29", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">30. Language allows human brains to do things that would be impossible without it.</div>
                   {renderRadioGroup("q30", ynOptions, false)}
                 </div>
               </div>

               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 31-34</strong></div>
                 <p>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">31. What is the writer doing in the second paragraph?</div>
                   {renderRadioGroup("q31", q31Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">32. The writer refers to Thomas Edison in order to</div>
                   {renderRadioGroup("q32", q32Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">33. What does the writer suggest about human reasoning in the fifth paragraph?</div>
                   {renderRadioGroup("q33", q33Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">34. What is the writer's main point in the sixth paragraph?</div>
                   {renderRadioGroup("q34", q34Options, true)}
                 </div>
               </div>

               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 35-40</strong></div>
                 <p>
                 ...
                 <p>
                   <strong>Language: the cultural tool</strong>
                 </p>

                 <p className="parncutt-summary">
                   <span className="summary-line">
                     To understand language, it is necessary to learn about its original birthplace in Africa and also to study its use in
                     <span className="question-text"> 35</span>
                     {renderDropdown("q35", summaryWordOptions, "summary-dropdown")}
                     since then.
                   </span>
                   <span className="summary-line">
                     The debate about genetic influence on language causes
                     <span className="question-text"> 36</span>
                     {renderDropdown("q36", summaryWordOptions, "summary-dropdown")}, because some academics believe that all languages are equal.
                   </span>
                   <span className="summary-line">
                     But this is wrong: language speakers are equal, but some languages have
                     <span className="question-text"> 37</span>
                     {renderDropdown("q37", summaryWordOptions, "summary-dropdown")} and others do not.
                   </span>
                   <span className="summary-line">
                     This is because each language has developed in order to meet the
                     <span className="question-text"> 38</span>
                     {renderDropdown("q38", summaryWordOptions, "summary-dropdown")} of the people who use it.
                   </span>
                   <span className="summary-line">
                     What researchers need now is
                     <span className="question-text"> 39</span>
                     {renderDropdown("q39", summaryWordOptions, "summary-dropdown")} of more languages.
                   </span>
                   <span className="summary-line">
                     This requires fieldwork, because we cannot learn about language by
                     <span className="question-text"> 40</span>
                     {renderDropdown("q40", summaryWordOptions, "summary-dropdown")}.
                   </span>
                 </p>

                 <p className="list-of-words">
                   <strong>List of Phrases:</strong>
                   <span className="word-row"><strong>A</strong>. similar structures</span>
                   <span className="word-row"><strong>B</strong>. evolving needs</span>
                   <span className="word-row"><strong>C</strong>. complicated grammar</span>
                   <span className="word-row"><strong>D</strong>. strong emotions</span>
                   <span className="word-row"><strong>E</strong>. intellectual abilities</span>
                   <span className="word-row"><strong>F</strong>. mathematical analysis</span>
                   <span className="word-row"><strong>G</strong>. numerous communities</span>
                   <span className="word-row"><strong>H</strong>. useful descriptions</span>
                 </p>
               </div>
            </div>
          </div>
