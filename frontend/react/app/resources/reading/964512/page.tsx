...
export default function Reading964512Page() {
  ...
  const isTextAnswerKey = (key: QuestionKey) => key === "q20" || key === "q21" || key === "q22" || key === "q23";
  ...
  useEffect(() => {
   ...
   const renderTextInput = (key: QuestionKey) => {
     ...
     const placeholder = key === "q20" || key === "q21" || key === "q22" || key === "q23" ? key.slice(1) : undefined;
     return (
       <input
         type="text"
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – The Scent of Bygone Days</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>The Scent of Bygone Days: Is Smell Uniquely Intertwined with Memory?</h3>
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <strong>A</strong>
                     <br />
                     There is a popular and widely circulated claim that odors are the strongest cues to memory. This adage has been promulgated in scientific as well as popular publications. Take Diane Ackerman’s 1990 declarations that 'Perfume is liquid memory' and 'Smells detonate softly in our memory like poignant land mines' as examples, and the role of the olfactory sense in emotion and memory comes vividly to life in literary allusion and allegory.
                   </p>
                   <p>
                     <strong>B</strong>
                     <br />
                   ...
                   <p>
                     <strong>C</strong>
                     <br />
                     The phenomenon of smell-induced recollection has been studied in experiments, with mixed results. David Rubin and his colleagues at Duke University sought to investigate the assumption that an actual scent, rather than the idea of a scent, had a special function in memory. In 1984, they recruited forty student participants and assigned them randomly to either be presented with an odor or written words representing the odor. They utilized what they thought would be familiar smells, particularly ones that might provoke an early memory; these included Johnson & Johnson’s baby powder, plasters, soap, peanut butter, etc.
                   </p>
                   <p>
                     <strong>D</strong>
                     <br />
                     Then participants were asked to describe any memories awakened by the scents or descriptions and respond to questions like 'How clear or vivid was the memory?' or 'How did you feel emotionally at the time of the memory?' In a second experiment, the researchers used a similar method but added photographs representative of an odor in addition to the actual scent and written words. The team made some surprising discoveries, such as that a memory triggered by an actual scent was likely to have never been thought of before, or thought of less often, and odor might often evoke a more pleasing or emotional memory than pictures or words.
                   </p>
                   <p>
                     <strong>E</strong>
                     <br />
                     Subsequent experiments have shed additional light on the issue. In 2000, British psychologist John Downes of the University of Liverpool discovered that the connection between an actual scent and a memory seems to be tied to age. He gathered subjects in their late 60s and early 70s, presented them with olfactory cues or verbal cues (smell-related words), and asked them to describe a related autobiographical experience that came to mind. Their analysis revealed that the actual odors triggered memories from a much younger age than the verbal cues. The former tended to revive recollections from age 6 to 10, whereas the latter generally evoked memories from between 11 and 25 years of age. This suggests both that smell is a crucial factor in providing a backdrop of contextual details for childhood experiences and that it is indeed closely tied to episodic memory because semantic abilities are still limited in late childhood and continue to form well into adolescence.
                   </p>
                   <p>
                     <strong>F</strong>
                     <br />
                     Another interesting experiment was described in a 1999 article in the British Journal of Psychology. The author, John Aggleton of Cardiff University, employed a double-cueing methodology in an ingenious manner: he sought to test the relationship between odor and memory outside the laboratory, so he visited the Jorvik Viking Centre, a museum in York, where an exhibition had piped 'Viking odors' into the exhibit area for a multisensory effect. Aggleton wanted to know if these odors would aid repeat visitors in remembering details of the exhibit years later. He gave three groups of returning museum goers questionnaires in various conditions—in the presence of the same original 'Viking odors', a control odor, and no odor. He then repeated the test but with changed conditions for each group. Only the group that took the second test in the presence of 'Viking odors' improved their performance on the questionnaire. Thus, Aggleton concluded that odors 'can provide strong contextual cues that aid in the recall of information originally presented in the presence of those odors'.
                   </p>
                   <p>
                     <strong>G</strong>
                     <br />
                     Still, the vast majority of experts agree that the notion of smell being the 'best' cue to memory is largely unfounded because there is no proof that an odor-evoked memory is more accurate than that of any of the other stimuli. However, there does seem to be a consensus that odor-related memories are more emotional in essence. According to Rachel Hertz’s article in The Oxford Handbook of Social Neuroscience, when an odor evokes a memory, this first creates emotional sensations, 'After which the event which initially brought about the emotion emerges. In other words, the experiential order of odor-evoked memory appears to follow the temporal sequence of the neurological pathways that are involved.' This order progresses from the sensory-perceptual, to the limbic-emotional and then on to higher cognitive structures. Hertz claims that the 'bottom-up versus top-down temporal unfolding of odor-evoked memory may distinguish it from other memory experiences'.
                   </p>
                   <p>
                     <strong>H</strong>
                     <br />
                     Thus, the strong association between olfaction and emotional recollection likely has an evolutionary basis as it has undoubtedly played a key role in human survival. Anatomically, olfactory centers are in close proximity to the most basic portions of the brain, which are directly responsible for emotional experience and memory. Only two synapses separate the olfactory nerve from the amygdala, a set of neurons responsible for emotion, emotional behavior, and motivation. In evolutionary terms, this integrative emotional center—indeed, the entire limbic system—arose from the olfactory area of the brain. Considering this, some researchers, such as Michael Jawer, have suggested that without a sense of smell, we may have never evolved to have emotions at all.
                   </p>
                 </div>
               ) : (
             ...
             >
               ...
               <div className="question-group">
                 ...
                 <p>
                   ...
                   <br />
                   Write the correct letter, <strong>A–H</strong>, in boxes <strong>14–19</strong> on your answer sheet.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">14. The use of photos to signify smells</div>
                   {renderLetterDropdown("q14")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">15. Examples of well-known scents</div>
                   {renderLetterDropdown("q15")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">16. A reference to the use of smell in metaphor</div>
                   {renderLetterDropdown("q16")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">17. A mention of how feelings arise from memories</div>
                   {renderLetterDropdown("q17")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">18. A description of a study conducted in a real-life setting</div>
                   {renderLetterDropdown("q18")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">19. How different cues evoke the memories of different age periods</div>
                   {renderLetterDropdown("q19")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Write your answers in boxes <strong>20–23</strong> on your answer sheet.
                 </p>

                 <p><strong>Smell and Memory</strong></p>
                 <p>– Smells may be the most powerful {renderTextInput("q20")} in bringing up memory</p>

                 <p><strong>Types of memory</strong></p>
                 <p>– Trygg Engen: smells can offer an entire {renderTextInput("q21")} of someone’s life in one memory</p>
                 <p>– Smell might be the most primitive of the senses</p>

                 <p><strong>Evoking childhood memories</strong></p>
                 <p>– John Downes: smells set off memories of childhood more than statements</p>
                 <p>– Smell gives background information for {renderTextInput("q22")} from youth</p>

                 <p><strong>Order of smell memory</strong></p>
                 <p>– Rachel Hertz: smell-related memories progress from sense/perception, limbic/emotional to advanced {renderTextInput("q23")} structures</p>
                 <p>– Smell has a strong basis in evolution</p>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">24. Photographs bring up more moving memories than smells.</div>
                   {renderTfngRadio("q24")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">25. Odor is more effective than taste for memory.</div>
                   {renderTfngRadio("q25")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">26. The better accuracy of smell for remembering is not proven.</div>
                   {renderTfngRadio("q26")}
                 </div>
               </div>
             </div>
