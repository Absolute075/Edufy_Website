...
export default function Reading966444Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – The Introduction of Gas and Electricity to the US</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <h3>The Introduction of Gas and Electricity to the US</h3>
                   <p>
                     Until the late 1700s, illumination in US households was limited to candles and whale oil lamps, but
                     both were inefficient – it would take a hundred candles to create as much light as a single modern
                     lightbulb – and so expensive as to be beyond the means of most households. For the middle classes,
                     illumination improved dramatically with the invention, in 1783, of the Argand lamp (named after its
                     Swiss creator), which had greater intensity and less flicker. The next step forward was the invention
                     of the oil-based fuel kerosene in 1858, and of petroleum a year later.
                   </p>
                   <p>
                     But the big transformation came with gas. Initially, gas was used to light streets – Baltimore had
                     gas lamps as early as 1816, before Paris or Berlin – but the dirt, odours and volatility of gas meant
                     it could not be relied on for domestic purposes until the late 1860s. Once some attempt to deal with
                     these problems had been made, gas swept the nation. Each gas outlet provided as much light as a dozen
                     candles. By 1895, the average middle-class home was twenty times better lit than it had been at
                     mid-century. But, even cleaned up and made more stable, gas remained dirty and dangerous. It emitted
                     unpleasant, potentially lethal fumes that required special vents to clear the air. Even then, the
                     carbonic acid and smoke that the lamps produced were harmful to books, curtains, wallpaper and soft
                     furniture, as well as the eyes, lungs and clothes of the inhabitants.
                   </p>
                   <p>
                     In 1882, domestic electricity at last became a possibility when Thomas Edison’s company started
                     providing electricity on a commercial basis. By mid-decade, 200 of New York City’s grandest
                     households were enjoying the illumination from lightbulbs manufactured by the company. Only the very
                     wealthiest could afford such an indulgence. It was unsurprising, therefore, that household
                     electricity was not an immediate hit with everyone.
                   </p>
                   <p>
                     Outdoors, however, it was another matter. Almost overnight, the US became the most illuminated
                     country in the world. By the 1890s, Broadway in New York was already being described as the Great
                     White Way because of its dazzling theatre lights and advertising signs. People came from all over
                     just to see the lights, which included the world’s first flashing sign, for Manhattan Beach and its
                     hotels. In 1910, Broadway got a sign that was a wonder of electrical engineering. Rising the
                     equivalent of seven storeys above the rooftop of the Hotel Normandie and incorporating 20,000
                     coloured lightbulbs, it offered in intricate detail the illusion of a 30-second chariot race,
                     complete with cracking whips and flying dust.
                   </p>
                   <p>
                     People were so amazed by it that police had to be assigned to the area to keep pedestrians and traffic
                     moving.
                   </p>
                   <p>
                     By 1896, electricity had become such an accepted part of life that people began referring to it as
                     juice. By 1930, 70 per cent of US households, some 20 million homes, were electrified – up from none
                     in 1910, and more than the rest of the world combined at that point in time. The proportion would have
                     been higher still except that rural electrification took so long to complete; even by 1946, as little
                     as half of US farms had electricity.
                   </p>
                   <p>
                     As electricity became more widely available, electrical products began to come onto the market,
                     starting with the electric sewing machine in 1889. The electric iron appeared in 1893, the electric
                     vacuum cleaner in 1901, the electric washing machine in 1909, and the electric dishwasher in 1918. By
                     1917, the US householder could choose between 50 types of electrical appliances – and eagerly did so.
                     In that year, people spent $175 million on them. Within a little over a decade, that figure would rise
                     to no less than $2.4 billion a year.
                   </p>
                   <p>
                     The new and fast-changing market for electrical appliances often gave small companies a chance to
                     thrive. After a major manufacturing rival turned down the rights to a washing machine which ran
                     automatically, a small outfit named Bendix, which had no experience of manufacturing household
                     appliances, took up the idea in 1937 and within a decade had become one of the US’s biggest
                     manufacturers of appliances. Much the same happened with a small company called Frigidaire, founded in
                     1918, which saw an opportunity for a refrigerator designed for the home and so successfully seized the
                     opportunity that the name almost became generic, although it took until 1927 for General Electric to
                     produce the first million-selling model. However, no product was more successful in this period than
                     the radio. In just three years, beginning in 1922, over four million were sold, at a typical cost of
                     $55. By 1926, there was a radio in five per cent of homes, and by the end of that decade, with almost
                     every household owning at least one, market saturation was practically complete.
                   </p>
                 </div>
               ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">4. By 1895, a number of different companies competed to provide domestic gas.</div>
                   {renderTfngRadio("q4")}
                 </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 10 }}>
                   <thead>
                     <tr>
                       <th style={{ border: "1px solid var(--border)", padding: 10, backgroundColor: "var(--subtle)" }}>
                         Year
                       </th>
                       <th style={{ border: "1px solid var(--border)", padding: 10, backgroundColor: "var(--subtle)" }}>
                         Some key events in US electrification
                       </th>
                     </tr>
                   </thead>
                   <tbody>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>{renderTextInput("q7")}</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>
                         Electricity was supplied to homeowners for the first time.
                       </td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>1889–1918</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>
                         The sewing machine was the first electrical appliance to appear in this period, while the {renderTextInput("q8")} was the last.
                       </td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>{renderTextInput("q9")}</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>10% of US households had an electricity supply.</td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>{renderTextInput("q10")}</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>Consumer spending on electrical appliances totalled $175m.</td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>1927</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>
                         General Electric produced a million-selling model of a domestic {renderTextInput("q11")}.
                       </td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>1930–1946</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>
                         Although 70% of all households had electricity by 1930, only 50% of {renderTextInput("q12")} were electrified by the end of this period.
                       </td>
                     </tr>
                     <tr>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>1930</td>
                       <td style={{ border: "1px solid var(--border)", padding: 10 }}>
                         There was a {renderTextInput("q13")} in nearly every home.
                       </td>
                     </tr>
                   </tbody>
                 </table>
