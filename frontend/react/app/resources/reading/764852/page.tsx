...
export default function Reading764852Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – History of the Globe Theatre</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <p>
                     <span className="label">A</span> The original Globe Theatre opened in autumn 1599 on the south bank of the
                     River Thames, in London. It was one of several major theatres in the area, the others being the
                     Swan, the Rose and the Hope. The Globe was the main playhouse of the Lord Chamberlain's Men,
                     later called the King's Men, a theatrical company to which the playwright William Shakespeare
                     belonged. Most of Shakespeare's post-1599 plays were staged at the Globe, including <em>Julius
                       Caesar</em>, <em>Macbeth</em>, <em>Othello</em>, <em>King Lear</em> and <em>Hamlet</em>.
                   </p>
                   <p>
                     <span className="label">B</span> The Globe was built in 1576, using timber from an earlier theatre in
                     Shoreditch, east London, by James Burbage, the father of one of the actors. Called simply The
                     Theatre, this structure was taken down after a 20-year lease on its land expired, and the timber
                     from it was then transported over the Thames to construct the Globe.
                   </p>
                   <p>
                     <span className="label">C</span> The Globe Theatre was highly successful. Since there was little artificial
                     light, performances were held in the afternoon, usually beginning in May. Flags waving in the
                     wind advertised plays by the King's Men, and all about the grounds of the theatre, playgoers
                     would be buying merchandise and refreshments from stalls. People from all walks of life could
                     enjoy the tragedies and comedies of Shakespeare. Both men and women would attend the plays, but
                     the well-off would frequently wear masks to conceal their identity.
                   </p>
                   <p>
                     <span className="label">D</span> After years of success, the Globe was destroyed by a fire on 29 June 1613,
                     during a performance of <em>Henry VIII</em>. A theatrical cannon, set off during the
                     performance, misfired, igniting the building's roof and wooden beams. According to one of the
                     few surviving contemporary accounts of the event, no one was hurt except a man who put out his
                     burning trousers with a bottle of ale. A new Globe was created by the theater company on the
                     foundations of its predecessor before Shakespeare's death in 1616.
                   </p>
                   <p>
                     <span className="label">E</span> However, after the Puritans gained control of Parliament, their campaign to
                     enforce a higher standard of morality meant the end of the Globe. Their strict views gave rise
                     to restrictions on many social activities, and like all the other theatres in London, the Globe
                     was closed down in 1642. In 1644, the Puritans destroyed the Globe altogether to make room for
                     housing. Its exact location was forgotten and remained unknown until remnants of its foundations
                     were discovered in 1989 near a row of eighteenth-century buildings. There may be further remains
                   ...
                   <p>
                     <span className="label">F</span> The Globe's shape and size have been the subject of scholarly inquiry over the
                     last two centuries. The evidence suggests that it was a three-storey, 100-foot-wide, open-air
                     ...
                     or sit on the ground to watch the performance. They paid one penny to see the play, and the box
                     into which they put their entrance fee gave rise to the term 'box office'.
                   </p>
                   <p>
                     <span className="label">G</span> A rectangular platform, also known as an "apron stage", thrust out into the
                     middle of the open-air yard. On this, there was a trap door for use by performers to enter from
                     the "cellarage" area beneath the stage. Large columns on either side of the stage supported a
                     roof over the rear portion of the stage. This would have been constructed using thatch. The
                     inner ceiling was called the "heavens", and was possibly painted with images of the sky. An
                     opening in the heavens enabled performers to descend, using some form of rope and harness. The
                     back wall of the stage had three doors on the first floor and a balcony on the second. The doors
                     led into the "tiring houses" where the actors dressed and awaited their cue. The balcony was
                     where the musicians performed and could also be used for scenes requiring an upper space, such
                     as the balcony scene in Shakespeare's <em>Romeo and Juliet</em>. In addition, it could be used
                     as the "Lord's Room", where higher-paying audience members could be seated.
                   </p>
                   <p>
                     <span className="label">H</span> When the foundations of Shakespeare's Globe were discovered in London's
                     Bankside district, public interest in building a modern version was reignited. Workers began
                     construction in 1993, close to the site of the original. Completed in 1996, the current Globe
                     Theatre was officially opened on 12 June 1997 with a production of <em>Henry V</em>. The
                     reconstruction was carefully researched, so that the new building would be as faithful a replica
                     as possible. It had the first thatched roof permitted in the city since the Great Fire of London
                     in 1666. Modernisations included the addition of sprinklers on the roof to protect against fire.
                     Due to modern health and safety regulations, only 1,300 people can attend a show, under half the
                     estimated 3,000 of Shakespeare's time.
                   </p>
                   <p>
                     <span className="label">I</span> Tickets to stand in the open — no sitting allowed in this section — are
                     available for every performance at £5 each. The only covered parts of the amphitheatre are the
                     stage and the more expensive seated areas. Plays are normally performed between May and October,
                     and in winter the theatre is used for educational purposes.
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">1. The Lord Chamberlain’s Men performed plays only in the Globe Theatre.</div>
                   {renderTfngRadio("q1")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">2. Recycled wood was used in the construction of the original Globe.</div>
                   {renderTfngRadio("q2")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">3. Performances at the Globe were so popular that advance booking was necessary.</div>
                   {renderTfngRadio("q3")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">4. Some people who watched the plays tried to avoid recognition.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">5. When the original Globe burned down, it was rebuilt on the same site.</div>
                   {renderTfngRadio("q5")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">6. The Globe was the first theatre to be closed down by the Puritans.</div>
                   {renderTfngRadio("q6")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p className="parncutt-summary">
                   ...
                   <span className="summary-line">
                     <strong>Parts of the original Globe</strong>
                   </span>
                   <span className="summary-line">
                     - The <span className="question-number">7</span>{renderTextInput("q7")} — for members of the audience (one penny per
                     person)
                   </span>
                   <span className="summary-line">
                   ...
                   <span className="summary-line">
                     - Roof made of <span className="question-number">8</span>{renderTextInput("q8")}
                   </span>
                   <span className="summary-line">
                     - The <span className="question-number">9</span>{renderTextInput("q9")} — for performers to change into costumes
                   </span>
                   <span className="summary-line">
                     - Balcony for the use of the <span className="question-number">10</span>{renderTextInput("q10")} or wealthy
                     spectators
                   </span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">
                     <strong>The modern Globe</strong>
                   </span>
                   <span className="summary-line">- 1993–1996 — the modern Globe was built</span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">
                     <strong>The building</strong>
                   </span>
                   <span className="summary-line">- It was designed to be a mainly accurate replica</span>
                   <span className="summary-line">
                     - <span className="question-number">11</span>{renderTextInput("q11")} were a new safety feature
                   </span>
                   <span className="summary-line">
                     - Audience capacity was reduced by more than <span className="question-number">12</span>{renderTextInput("q12")}
                   </span>
                   <span className="summary-line">&nbsp;</span>
                  <span className="summary-line">
                    <strong>The performances</strong>
                  </span>
                  <span className="summary-line">- The price of outdoor tickets is fixed</span>
                  <span className="summary-line">
                    - Tickets for seats in the <span className="question-number">13</span>
                    {renderTextInput("q13")} spaces cost more
                  </span>
                  <span className="summary-line">- There are no performances during winter</span>
                </p>
              </div>
            </div>
          </div>
