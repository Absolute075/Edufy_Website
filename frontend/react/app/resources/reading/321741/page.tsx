...
export default function Reading321741Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – The Slow Food Organization</title>
         <link
           rel="stylesheet"
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 ...
                 <p>
                   Choose <strong>TRUE</strong> if the statement agrees with the information given in the text, choose <strong>FALSE</strong> if the
                   statement contradicts the information, or choose <strong>NOT GIVEN</strong> if there is no information on this.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">1. The Ark of Taste lists food plant and animal species in danger of extinction.</div>
                   {renderTfngRadio("q1")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">2. Slow Food considers the term biodiversity should be restricted to wild species.</div>
                   {renderTfngRadio("q2")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">3. The genes of heritage plants may be of vital importance to modern plant breeders.</div>
                   {renderTfngRadio("q3")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">4. Countries can sell the genes of their heritage plant varieties internationally.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">5. Slow Food maintains that food and culture exist independently of each other.</div>
                   {renderTfngRadio("q5")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">6. Some Native Americans are now giving cookery classes featuring Iroquois white corn.</div>
                   {renderTfngRadio("q6")}
                 </div>
               </div>

               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 7-9</strong></div>
                 <p>Complete the table below. Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 10-13</strong></div>
                 <p>
                   Answer the questions below. Choose <strong>ONE WORD AND/OR A NUMBER</strong> from the passage for each answer.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">10. What were farmers in the USA given so that they could raise endangered turkeys?</div>
                   <div style={{ marginTop: 8 }}>{renderTextInput("q10")}</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">11. How many varieties of endangered turkey benefited from the project?</div>
                   <div style={{ marginTop: 8 }}>{renderTextInput("q11")}</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">12. Who was not happy with the size of the turkeys?</div>
                   <div style={{ marginTop: 8 }}>{renderTextInput("q12")}</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">13. Who liked the taste of the endangered turkeys?</div>
