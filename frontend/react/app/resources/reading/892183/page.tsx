...
export default function Reading892183Page() {
  ...
  const q27Options = [
    { value: "A", text: "The guilty feeling made him so." },
    { value: "B", text: "The writer expected it to be better than it was." },
    { value: "C", text: "Sacks failed to include his personal stories in the book." },
    { value: "D", text: "This is the only book written by Sacks." },
  ];

  const q28Options = [
    { value: "A", text: "the photo of Sacks listening to music" },
    { value: "B", text: "the tone of voice of the book" },
    { value: "C", text: "the autobiographical description in the book" },
    { value: "D", text: "the description of Sacks’s wealth" },
  ];

  const q29Options = [
    { value: "A", text: "make a herald introduction of the research work and technique applied" },
    { value: "B", text: "give detailed description of various musical disorders" },
    { value: "C", text: "explain why he needs to do away with simple observation" },
    { value: "D", text: "explain why he needs to do away with simple observation" },
  ];

  const q30Options = [
    { value: "A", text: "He refuses to have further tests." },
    { value: "B", text: "He can’t determine the cause of his sudden musicality." },
    { value: "C", text: "He nearly died because of the lightning." },
    { value: "D", text: "His brain waves were too normal to show anything." },
  ];
  ...
  const endingsOptions = [
    { value: "A", label: "A. show no music-brain disorders." },
    { value: "B", label: "B. indicates that medication can have varied results." },
    { value: "C", label: "C. is key for the neurological community to unravel the mysteries." },
    { value: "D", label: "D. should not be used in isolation." },
    { value: "E", label: "E. indicate that not everyone can receive good education." },
    { value: "F", label: "F. show a misconception that there is function centre localized in the brain." },
  ];
  ...
  const dropdownLabel = (key: QuestionKey, value: string) => {
    ...
    if (key === "q37" || key === "q38" || key === "q39" || key === "q40") {
      return endingsOptions.find((o) => o.value === value)?.label ?? value;
    }
    return value;
  };
  ...
  return (
    <div>
      <Head>
        ...
        <title>Reading Passage 3 – Book Review on Musicophilia</title>
      ...
      >
        ...
        >
          <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
            ...
            >
              <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>Book Review on Musicophilia</h3>

              {passageHtml === null ? (
                <div id="passage2" ref={passageRef}>
                  <p>
                    <span className="label">A</span> Music and the brain are both endlessly fascinating subjects, and as a
                  ...
                  <p>
                    <span className="label">B</span> Sacks himself is the best part of Musicophilia. He richly documents his own
                  ...
                  <p>
                    <span className="label">C</span> The preface gives a good idea of what the book will deliver. In it Sacks
                    ...
                    heart lies with the former.
                  </p>
                  <p>
                    <span className="label">D</span> The book consists mainly of detailed descriptions of cases, most of them
                  ...
                  <p>
                    <span className="label">E</span> Part II, “A Range of Musicality,” covers a wider variety of topics, but
                  ...
                  <p>
                    <span className="label">F</span> To Sacks’s credit, part III, “Memory, Movement and Music,” brings us into the
                  ...
                  <p>
                    <span className="label">G</span> To readers who are unfamiliar with neuroscience and music behavior,
                  ...
                  <p>
                    <span className="label">H</span> It’s true that the causes of music-brain oddities remain poorly understood.
                  ...
                  <p>
                    <span className="label">I</span> Another conclusion one could draw is that there seem to be no “cures” for
                  ...
                  <p>
                    <span className="label">J</span> Finally, in many of the cases described here the patient with music-brain
            ...
            >
              ...
              <div className="question-group">
                ...
                <div className="question question--plain">
                  <div className="question-text">27. Why does the writer have a mixed feeling about the book?</div>
                  {renderRadioGroup("q27", q27Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. What is the best part of the book?</div>
                  {renderRadioGroup("q28", q28Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. In the preface, what did Sacks try to achieve?</div>
                  {renderRadioGroup("q29", q29Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. What is disappointing about Tony Cicoria’s case?</div>
                  {renderRadioGroup("q30", q30Options, true)}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title">Questions 31-36</div>
                <p>
                  Do the following statements agree with the views of the writer in Reading Passage 3?
                  <br />
                  In boxes 31–36 on your answer sheet, write:
                  <br />
                  <strong>TRUE</strong> – if the statement agrees with the views of the writer
                  <br />
                  <strong>FALSE</strong> – if the statement contradicts the views of the writer
                  <br />
                  <strong>NOT GIVEN</strong> – if it is impossible to say what the writer thinks about this
                </p>

                <div className="question question--plain">
                  <div className="question-text">31. It is difficult to give a well-reputable writer a less than totally favorable review.</div>
                  {renderRadioGroup("q31", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">32. Beethoven’s Pathetique Sonata is a good treatment for musical disorders.</div>
                  {renderRadioGroup("q32", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">33. Sacks believes technological methods is of little importance compared with traditional observation when studying his patients.</div>
                  {renderRadioGroup("q33", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">34. It is difficult to understand why music therapy is undervalued.</div>
                  {renderRadioGroup("q34", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">35. Sacks held little skepticism when borrowing other theories and findings in describing reasons and notion for phenomena he depicts in the book.</div>
                  {renderRadioGroup("q35", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">36. Sacks is in a rush to use new testing methods to do treatment for patients.</div>
                  {renderRadioGroup("q36", tfngOptions, false)}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title">Questions 37-40</div>
                <p>
                  Complete each sentence with the correct ending, <strong>A-F</strong>, below.
                  <br />
                  Write the correct letter, <strong>A-F</strong>, in boxes <strong>37–40</strong> on your answer sheet.
                </p>

                <p className="parncutt-summary">
                  <span className="summary-line">
                    37. The content covered dissociations in understanding between harmony and melody
                    {renderDropdown("q37", endingsOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    38. The study of treating musical disorders
                    {renderDropdown("q38", endingsOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    39. The EEG scans of Sacks’s patients
                    {renderDropdown("q39", endingsOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    40. Sacks believes testing based on new technologies
                    {renderDropdown("q40", endingsOptions, "summary-dropdown")}.
                  </span>
                </p>
              </div>
            </div>
