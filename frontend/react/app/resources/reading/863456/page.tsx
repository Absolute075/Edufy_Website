...
export default function Reading863456Page() {
  ...
  const userPrefix = hasNumericUserPrefix ? `/${firstSegment}` : "";
   ...
   const isTextAnswerKey = (key: QuestionKey) => key === "q32" || key === "q33" || key === "q34";
   ...
   const peopleOptions = [
     { value: "A", label: "A. Alfred North Whitehead" },
     { value: "B", label: "B. Ap Dijksterhuis" },
     { value: "C", label: "C. Timothy Wilson" },
     { value: "D", label: "D. Matthew Walker" },
     { value: "E", label: "E. Daniel Goleman" },
     { value: "F", label: "F. Howard Gardner" },
   ];
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q28" || key === "q29" || key === "q30" || key === "q31") {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – Conscious and Unconscious Thought</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>Conscious and Unconscious Thought</h3>

               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <strong>A</strong> Great scientists and artists have long known about the unconscious mind. The
                     founder of psychoanalysis, Sigmund Freud, argued that most of our real motivation lies below
                     conscious awareness and that we require the services of a psychoanalyst to explain ourselves to
                     ourselves. Even those celebrated scientists who believe that Freud exaggerated the importance of
                     the unconscious argue that it is a part of our minds which we should learn to control and take
                     advantage of.
                   </p>
                   <p>
                     <strong>B</strong> The great mathematician Alfred North Whitehead seemed to be a supporter of
                     unconscious mental processing when he said: 'It is a profoundly erroneous truism, repeated by
                     all copybooks and by eminent people making speeches, that we should cultivate the habit of
                     thinking about what we are doing. The precise opposite is the case.' What Whitehead meant by
                     this is that some of the greatest breakthroughs in creativity occur when a problem is
                   ...
                   <p>
                     <strong>C</strong> Now the latest psychological research confirms that we can all incubate a
                     problem to our own advantage. Ap Dijksterhuis, a psychologist at the University of Amsterdam,
                     has recently published a series of experiments in which students were presented with complex
                     everyday problems to solve. In one experiment they were given the opportunity to think carefully
                     about a decision; in another experiment they were distracted by an irrelevant task whilst making
                     a decision. The surprising result, published in the Journal of Personality and Social
                     Psychology, was that 'unconscious' thinkers made the better decisions.
                   </p>
                   <p>
                     <strong>D</strong> Timothy Wilson and colleagues from the University of Virginia's psychology
                     department conducted another experiment. Participants were presented with five posters and asked
                     to choose one to take home. A little later, they were telephoned and asked how satisfied they
                     were with their choice - a measure of whether they had made the right decision from a subjective
                     point of view. Some participants had picked their poster straight away, whereas others were
                     asked to analyse carefully the pros and cons of each poster. It turned out that people who had
                     analysed were less satisfied with their choice than people who had not applied logic.
                     Paradoxically, it seems that those who had consciously weighed up the various attributes had
                     made relatively poor decisions.
                   </p>
                   <p>
                     <strong>E</strong> The conclusion that has to be drawn from current research suggests the
                     somewhat counter-intuitive idea that the more complex a problem is, the less likely it becomes
                     that conscious thought can contribute much. If a dilemma is particularly difficult, a lot of
                     information has to be taken into account and it appears that conscious thought is not good at
                     this. The message is that when it comes to intricate problems with many variables, you should
                     let the unconscious deal with it.
                   </p>
                   <p>
                     <strong>F</strong> Using dreaming is one way of doing this. Dreams are the part of sleep most
                     strongly correlated with rapid eye movement (REM) and have been associated with enhanced
                     ...
                     dreaming. In a recent experiment, psychiatrist Matthew Walker and colleagues from the Laboratory
                     of Neurophysiology at Harvard Medical School woke up half of their experimental subjects
                     immediately after REM sleep, and the other half just after sleep with no dreams, and then asked
                     them to solve crossword puzzles. REM awakenings provided a 32 per cent advantage in the number
                     of puzzles solved, compared with non-REM awakenings.
                   </p>
                   <p>
                     <strong>G</strong> But you don't have to be asleep to use the unconscious mind when you are not
                     thinking of anything in particular, which is why daydreams are so useful in the quest for
                     creativity. Daniel Goleman, the famous psychologist who proposed the theory of 'emotional
                     ...
                     boundaries of what is deemed acceptable. Howard Gardner, a professor of cognition and education
                     at Harvard University, suggests that we free ourselves from the straitjacket of always doing
                     things the same way. In seeking to go beyond the routine and conventional, you will gain
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 ...
                 <p>
                   Look at the following statements (Questions 28-31) and the list of people below.
                   <br />
                   Match each statement with the correct person, <strong>A-F</strong>.
                   <br />
                   Write the correct letter, <strong>A-F</strong>, in boxes <strong>28–31</strong> on your answer sheet.
                 </p>
                 <p>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">28. People find it easier to solve problems at a particular point in the sleep cycle.</div>
                   {renderDropdown("q28", peopleOptions, "summary-dropdown")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">29. People should change their general behaviour patterns in order to benefit more from the unconscious.</div>
                   {renderDropdown("q29", peopleOptions, "summary-dropdown")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">30. People should try to ignore negative thoughts when solving problems.</div>
                   {renderDropdown("q30", peopleOptions, "summary-dropdown")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">31. People can come up with ideas which are more innovative if they temporarily put a problem aside.</div>
                   {renderDropdown("q31", peopleOptions, "summary-dropdown")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Write your answers in boxes <strong>32–34</strong> on your answer sheet.
                 </p>

                 <p className="summary-inline">
                   Many scientists argue that people should make better use of their unconscious mind. Alfred North Whitehead,
                   for example, gave support for the idea of {renderTextInput("q32", "32")}; a term for people deliberately
                   ignoring a problem over a period of time. Experiments in Amsterdam that required students to consider a tricky
                   situation found them making good decisions while carrying out an unconnected {renderTextInput("q33", "33")} .
                   Similarly, an experiment in Virginia which required subjects to make a selection from a number of different {renderTextInput("q34", "34")} found people feeling happier with their decisions if they had made them quickly.
                 </p>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   In boxes <strong>35–40</strong> on your answer sheet, write:
                   <br />
                 ...
                 <div className="question question--plain">
                   <div className="question-text">35. Our unconscious mind helps us more than our conscious mind with complex problems.</div>
                   {renderRadioGroup("q35", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">36. Resting before going to sleep can result in improved solutions to problems.</div>
                   {renderRadioGroup("q36", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">37. Problems are more likely to be solved after dreamless sleep.</div>
                   {renderRadioGroup("q37", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">38. Matthew Walker's team assessed their subjects using a memory test.</div>
                   {renderRadioGroup("q38", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">39. Daydreams are more helpful to the unconscious than dreams which occur during sleep.</div>
                   {renderRadioGroup("q39", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">40. People often create their own barriers to problem-solving.</div>
                   {renderRadioGroup("q40", tfngOptions, false)}
                 </div>
               </div>
            </div>
          </div>
