...
export default function Reading977845Page() {
  ...
  const isMultiChoicePairKey = (key: QuestionKey) => key === "q37" || key === "q38";
  ...
  const isMultiChoicePairCorrect = (aRaw: string, bRaw: string) => {
    ...
    const correct = [correctAnswers.q37, correctAnswers.q38].sort().join(",");
    return user === correct;
  };
  ...
  const handleSubmit = () => {
    ...
    (Object.keys(correctAnswers) as QuestionKey[]).forEach((key) => {
      if (isMultiChoicePairKey(key)) {
        ...
        if (isMultiChoicePairCorrect(selections.q37, selections.q38)) s += 2;
        return;
      }
     ...
     return progressNumbers.map((num) => {
       ...
       const isCorrect =
         ...
         (isMultiChoicePairKey(key)
           ? isMultiChoicePairCorrect(selections.q37, selections.q38)
           : isTextAnswerKey(key)
  ...
  const renderChoiceRadio = (key: QuestionKey, options: Array<{ value: string; label: string }>) => {
    const current = (selections[key] ?? "").trim();
    return (
  ...
  const toggleMultiChoicePairOption = (opt: string) => {
    ...
    setSelections((s) => {
      ...
      if (b === opt) return { ...s, q38: "" };
      if (!a) return { ...s, q37: opt };
      if (!b) return { ...s, q38: opt };
      return { ...s, q38: opt };
    });
  };
  ...
  <div>
    <Head>
      ...
      <title>Reading Passage 2 – Fossil Files: The Paleobiology</title>
      <link
        rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
              <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>Fossil Files: The Paleobiology</h3>
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
            ...
            >   
              ...
              <div className="question-group">
                ...
                <div className="question-group" style={{ marginTop: 18 }}>
                  <p>
                    The reading passage has six paragraphs, <strong>A–F</strong>. Choose the correct heading for paragraphs <strong>A–F</strong> from the list below.
                    <br />
                    Write the correct number, <strong>i–vii</strong>, in boxes <strong>28–33</strong> on your answer sheet.
                  </p>

                  <p style={{ marginTop: 12 }}>
                    <strong>List of Headings</strong>
                    <br />
                    <strong>i.</strong> Potential error exists in the database
                    <br />
                    <strong>ii.</strong> Supporter of database declared its value
                    <br />
                    <strong>iii.</strong> The purpose of this paleobiology data
                    <br />
                    <strong>iv.</strong> Reason why some certain species were not included in it
                    <br />
                    <strong>v.</strong> Duplication of breed but with different names
                    <br />
                    <strong>vi.</strong> Achievement of Paleobiology Database
                    <br />
                    <strong>vii.</strong> Criticism on the project which is waste of fund
                  </p>

                  <div className="question question--plain" data-question="28">
                    <div className="question-text">28. Paragraph A</div>
                    {renderLetterDropdown("q28", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>

                  <div className="question question--plain" data-question="29">
                    <div className="question-text">29. Paragraph B</div>
                    {renderLetterDropdown("q29", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>

                  <div className="question question--plain" data-question="30">
                    <div className="question-text">30. Paragraph C</div>
                    {renderLetterDropdown("q30", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>

                  <div className="question question--plain" data-question="31">
                    <div className="question-text">31. Paragraph D</div>
                    {renderLetterDropdown("q31", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>

                  <div className="question question--plain" data-question="32">
                    <div className="question-text">32. Paragraph E</div>
                    {renderLetterDropdown("q32", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>

                  <div className="question question--plain" data-question="33">
                    <div className="question-text">33. Paragraph F</div>
                    {renderLetterDropdown("q33", ["i", "ii", "iii", "iv", "v", "vi", "vii"])}
                  </div>
                </div>
                ...
                <div style={{ marginTop: 28 }}>
                  ...
                  <p>
                    Use the information in the passage to match the people (listed <strong>A–D</strong>) with opinions or deeds below.
                    <br />
                    Write the appropriate letters <strong>A–D</strong> in boxes <strong>34–36</strong> on your answer sheet.
                  </p>

                  <div className="question question--plain" data-question="34">
                    <div className="question-text">34. Creating the Database would help scientists to identify connections of all species.</div>
                    {renderChoiceRadio("q34", [
                      { value: "A", label: "Jonathan Adrain" },
                      { value: "B", label: "John Alroy" },
                      { value: "C", label: "David Jablonsky" },
                      { value: "D", label: "Edward O. Wilson" },
                    ])}
                  </div>

                  <div className="question question--plain" data-question="35">
                    <div className="question-text">35. Believed in contribution of detailed statistics should cover beyond the known species.</div>
                    {renderChoiceRadio("q35", [
                      { value: "A", label: "Jonathan Adrain" },
                      { value: "B", label: "John Alroy" },
                      { value: "C", label: "David Jablonsky" },
                      { value: "D", label: "Edward O. Wilson" },
                  ...
                  <div className="question question--plain" data-question="36">
                    <div className="question-text">36. Reached a contradictory finding to the tremendous species die-out.</div>
                    {renderChoiceRadio("q36", [
                      { value: "A", label: "Jonathan Adrain" },
                      { value: "B", label: "John Alroy" },
                      { value: "C", label: "David Jablonsky" },
                      { value: "D", label: "Edward O. Wilson" },
                ...
                <div className="question-group" style={{ marginTop: 28 }}>
                  <div className="question-group-title"><strong>Questions 37-38</strong></div>
                  <p>
                    Choose <strong>TWO</strong> letters, <strong>A–E</strong>.
                    <br />
                    Write your answers in boxes <strong>37–38</strong> on your answer sheet.
                    <br />
                    Please choose <strong>TWO CORRECT</strong> descriptions about The Paleobiology Database in this passage:
                  </p>

                  <div className="question question--plain" data-question="37" style={{ marginTop: 12 }}>
                    <div className="radio-group">
                      {(
                        [
                          { value: "A", label: "Almost all the experts welcome this project" },
                          { value: "B", label: "Intrigues both positive and negative opinions from various experts" },
                          { value: "C", label: "All different creatures in the database have unique names" },
                          { value: "D", label: "Aims to embrace all fossil information globally" },
                          { value: "E", label: "Get more information from record rather than the field" },
                        ] as Array<{ value: string; label: string }>
                      ).map((opt) => {
                        const a = (selections.q37 ?? "").trim();
                        const b = (selections.q38 ?? "").trim();
                ...
                <div style={{ marginTop: 28 }}>
                  <div className="question-group-title"><strong>Questions 39-40</strong></div>
                  <p>
                    Choose the correct letter, <strong>A</strong>, <strong>B</strong>, <strong>C</strong> or <strong>D</strong>.
                    <br />
                    Write your answers in boxes <strong>39–40</strong> on your answer sheet.
                  </p>

                  <div className="question question--plain" data-question="39">
                    <div className="question-text">39. According to the passage, jellyfish belongs to which category of The Paleobiology Database?</div>
                    {renderChoiceRadio("q39", [
                      { value: "A", label: "Repetition breed" },
                      { value: "B", label: "Untraceable species" },
                      { value: "C", label: "Specifically detailed species" },
                      { value: "D", label: "Currently living creature" },
                    ])}
                  </div>

                  <div className="question question--plain" data-question="40">
                    <div className="question-text">40. What is the author’s suggestion according to the end of passage?</div>
                    {renderChoiceRadio("q40", [
                      { value: "A", label: "Continue to complete counting the number of species in the Paleobiology Database" },
                      { value: "B", label: "Stop contributing to The Paleobiology Database" },
                      { value: "C", label: "Try to create a database of living creatures" },
                      { value: "D", label: "Study more in the field rather than in the book" },
                    ])}
                  </div>
                </div>
              </div>
