...
export default function Reading978552Page() {
  ...
  handleSubmitRef.current = handleSubmit;
   ...
   const summaryDropdownOptions = [
     { value: "A", label: "A. gestures" },
     { value: "B", label: "B. clients" },
     { value: "C", label: "C. transaction" },
     { value: "D", label: "D. assumption" },
     { value: "E", label: "E. accurate" },
     { value: "F", label: "F. documents" },
     { value: "G", label: "G. managers" },
     { value: "H", label: "H. body language" },
     { value: "I", label: "I. long-term" },
     { value: "J", label: "J. effective" },
     { value: "K", label: "K. rivals" },
     { value: "L", label: "L. costly" },
   ];

   const q14Options = [
     { value: "A", text: "to reveal all kinds of language problems that companies may encounter" },
     { value: "B", text: "to exhibit some well-known cases in dealing with language difficulties" },
     { value: "C", text: "to evaluate various approaches for language barrier in multinational companies" },
     { value: "D", text: "to testify that training is only feasible approach to solve language problem" },
   ];
  ...
  return (
    ...
    <Head>
      ...
      <title>Reading Passage 1 – Language Strategy in Multinational Company</title>
      <link
        rel="stylesheet"
    ...
    <style jsx global>{`
      .page-root {
        ...
        --shadow-menu: 0 10px 25px rgba(0, 0, 0, 0.12);
         ...
         .rounded-dropdown.summary-dropdown .rounded-dropdown-menu {
           display: flex;
         ...
         .rounded-dropdown.summary-dropdown .rounded-dropdown-item {
           padding: 5px 6px;
           font-size: 13px;
           line-height: 1.25;
           border-radius: 8px;
         ...
         .question--plain .inline-text-input {
           min-width: 90px;
           padding: 6px 8px;
           font-size: 13px;
           border-radius: 10px;
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 ...
                 <p>
                   Complete the following summary of the Whole Paragraphs of Reading Passage, choosing words from the following options.
                   <br />
                   Write your answers in boxes <strong>1–6</strong> on your answer sheet.
                 </p>

                 <p className="summary-inline">
                   MNCs often encounter language barrier in their daily strategy, then they seek several approaches to solve such problems. First, native language gives them a realistic base in a different language speaking country, but problem turned up when they deal with oversea {renderDropdown("q1", summaryDropdownOptions, "summary-dropdown")}. For example, operation on translation of some key {renderDropdown("q2", summaryDropdownOptions, "summary-dropdown")}, it is inevitable to generate differences by rules from different countries. Another way is to rely on a combination of spoken language and {renderDropdown("q3", summaryDropdownOptions, "summary-dropdown")}, yet a report written that over one-tenth business {renderDropdown("q4", summaryDropdownOptions, "summary-dropdown")} processed in a party language setting. Third way: hire translators. However, firstly it is {renderDropdown("q5", summaryDropdownOptions, "summary-dropdown")}, besides if they are not well-prepared, they have to take {renderDropdown("q6", summaryDropdownOptions, "summary-dropdown")} work.
                 </p>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">7. What understandable reaction does Training pay attention to according to the author?</div>
                   {renderTextInput("q7")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">8. In what term does the writer describe training during economy depression?</div>
                   {renderTextInput("q8")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">9. What contribution does Volkswagen Group do for multinational companies?</div>
                   {renderTextInput("q9")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">10. What does Volkswagen Group consider language training as in their company?</div>
                   {renderTextInput("q10")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">11. How many stages are needed from basic course to advanced in training?</div>
                   {renderTextInput("q11")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">12. How long does a refresher course need normally?</div>
                   {renderTextInput("q12")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">13. At least how long is needed for a specific professional to acquire a foreign language?</div>
                   {renderTextInput("q13")}
                 </div>
               </div>

               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Question 14</strong></div>
                 <p>
                   What is the main function of this passage?
                   <br />
                   Write your answer in box <strong>14</strong> on your answer sheet.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">14. What is the main function of this passage?</div>
                   {renderRadioGroup("q14", q14Options, true)}
                 </div>
               </div>
             </div>
           </div>
