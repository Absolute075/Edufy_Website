 ...
 export default function Reading976485Page() {
   ...
   const summaryWordOptions = [
     { value: "A", label: "A. natural evolution" },
     { value: "B", label: "B. creative thought" },
     { value: "C", label: "C. indigenous plants" },
     { value: "D", label: "D. trout" },
     { value: "E", label: "E. pollution" },
     { value: "F", label: "F. restoration" },
     { value: "G", label: "G. native fish" },
     { value: "H", label: "H. extinction" },
   ];
   ...
   const q27Options = [
     { value: "A", text: "They thought there was only one large island." },
     { value: "B", text: "They had not come to study natural history." },
     { value: "C", text: "They had no interest in the tuatara." },
     { value: "D", text: "They sent a tuatara to the British Museum." },
   ];
   const q28Options = [
     { value: "A", text: "He believed the tuatara could fetch a high price." },
     { value: "B", text: "He was typical of his generation of scientists." },
     { value: "C", text: "He disagreed with Charles Darwin’s theory." },
     { value: "D", text: "He wanted to stop the tuatara becoming extinct." },
   ];
   const q29Options = [
     { value: "A", text: "They did not eat the tuatara." },
     { value: "B", text: "There was one species of rat." },
     { value: "C", text: "There had always been rats in New Zealand." },
     { value: "D", text: "They were killed by Polynesians." },
   ];
   const q30Options = [
     { value: "A", text: "Tuatara are safe on small islands." },
     { value: "B", text: "Ship’s rats kill more tuatara than kiore." },
     { value: "C", text: "Kiore cannot swim to offshore islands." },
     { value: "D", text: "Rats and tuatara cannot live together." },
   ];
   const q31Options = [
     { value: "A", text: "Maori settled more recently than previously thought." },
     { value: "B", text: "The first Polynesian explorers formed permanent settlements." },
     { value: "C", text: "Ship’s rats are the oldest rat species in the country." },
     { value: "D", text: "Rats caused extinctions before any humans settled." },
   ];
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q36" || key === "q37" || key === "q38" || key === "q39" || key === "q40") {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – The tuatara – past and future</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <span className="label">A</span> The New Zealand species of lizard, the tuatara, is firmly embedded in the
                     national psyche: an icon for today which dates from the age of dinosaurs; an ancient reptile
                     commemorated on the back of the five cent coin. New Zealanders feel an affinity with the
                     tuatara, and accept that active conservation management is required to ensure it will be among
                     the legacies left to future generations.
                   </p>
                   <p>
                     <span className="label">B</span> When European explorers reached New Zealand in 1769 they found two large
                     islands, which together they called the ‘mainland’, and many tiny offshore islands around the
                     coast. The naturalists who came with the explorers disregarded the tuatara, though it is
                     improbable none were seen. Only several decades later did a tuatara specimen reach the British
                     Museum, where it was eventually classified as just another type of lizard. One of the first
                     scientists who realized that aspects of tuatara anatomy were odd – unchanged for tens of
                     thousands of years – was Albert Gunther in 1876. Gunther believed the tuatara was one of the
                     most valuable objects in zoological anatomical collections, and also noted, in passing, the
                     reptile was likely to become extinct. From today’s perspective, it is striking that Gunther
                     expressed no concern about the probable demise of the tuatara. He and his contemporaries were
                     products of their age, strongly influenced by Charles Darwin’s theory, which had only recently
                     been published. Their views were something like this: ‘Extinction is a natural process. It is
                     sad that species disappear, but that is part of nature.’
                   </p>
                   <p>
                     <span className="label">C</span> There is a second important aspect of Gunther’s work. He recorded, correctly,
                     that some of the mammals introduced by Europeans were predators of the tuatara – particularly
                     rats. But what he did not realise was that New Zealand has two species of rat, both introduced,
                     both with an appetite for tuatara: the ship’s rat came with European explorers and settlers; but
                     the kiore rat had already been in the country for hundreds of years, brought by Polynesians from
                     the Pacific Islands. Gunther failed to recognise the distinction, believing all rats to be a
                     relatively recent introduction.
                   </p>
                   <p>
                     <span className="label">D</span> Little further research was conducted until Ian Crook of the NZ Wildlife
                     Service published his findings in 1793, which can be summarized as follows. Tuatara thrive on
                     offshore islands with no rats. Tuatara never survived on islands with ship’s rats. On a few
                     islands, small and declining populations of tuatara occur with the kiore. This should not be
                     seen, however, as evidence that tuatara and kiore can coexist. Rather, Crook proposed, kiore
                     probably only arrived recently on such islands, and thus the small populations represent
                     extinctions in progress.
                   </p>
                   <p>
                     <span className="label">E</span> Throughout the 1990s, Richard Holdaway and his colleagues at Victoria
                     University in Wellington documented the surprising discovery that kiore probably arrived about
                     1800 years ago, although the human population of New Zealand is thought to be no older than 800
                     years. How is this possible? Presumably, Holdaway argued, the kiore were brought by Polynesian
                     explorers who visited the country but did not settle. Thereafter, the rats were agents of
                     ecological warfare, exterminating perhaps 1000-3000 species. Thus, tuatara and many other
                     species were already rare or extinct when permanent human inhabitants – the Maori – arrived
                     around 1300. This hypothesis is still being debated, but the evidence continues to accumulate in
                     its favour.
                   </p>
                   <p>
                     <span className="label">F</span> Conservation practice has changed dramatically since Crook’s findings were
                     published in 1973. Eradication of rats from any given environment was believed to be virtually
                     impossible until about 1980, but since then has become routine. Enormous conservation benefits
                     are accruing as newly rat-free offshore islands are providing sanctuaries for the country’s
                     rarest species. In 1995, for example, Nicola Nelson of the Department of Conservation
                     established 68 tuatara on Titi Island. Since then, four more populations of tuatara have been
                     established elsewhere under similar conditions. Today, numbers of tuatara are still a fraction
                     of what they once were, but for the first time in 1800 years the decline has been reversed.
                   </p>
                   <p>
                     <span className="label">G</span> While the recovery of rare species is itself a good thing, the truly
                     significant outcome of this research is that it liberates the imagination. If we can remove
                     predatory introduced mammals from islands, why not from the mainland too? Perhaps the questions
                     we ask should demonstrate even more visionary ambition. Can non-mammalian pests also be removed
                     from the mainland? Our rivers, for example, are full of surrogate rats, in the form of
                     introduced species of fish called trout. Some day more people will understand that trout have
                     replaced a whole native fauna in our waterways, just as rats replaced tuatara on the mainland.
                     Will such knowledge lead to the creation of mainland ‘aquatic islands’ where we can once again
                     establish those species of indigenous fish that used to live in our rivers? Similarly, can
                     bellbirds and tuis replace birds like starlings and mynahs?
                   </p>
                   <p>
                     <span className="label">H</span> The answers to such questions are uncertain, and opposing sides will doubtless
                     be fiercely debated. But the role of scientific knowledge in illuminating the past will be
                     crucial. Just as we now no longer tolerate extinction, in the future we may no longer accept a
                     mainland devoid of the biological wonders of our past such as tuatara. Conservation is thus not
                     primarily about the past but about imagining and then creating the future we wish for our
                     children and ourselves. For 80 million years until humans arrived, tuatara occurred throughout
                     New Zealand – might they do so again?
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">27. What are we told about the Europeans who arrived in 1769?</div>
                   {renderRadioGroup("q27", q27Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">28. What does the author say about Albert Gunther in paragraph 3?</div>
                   {renderRadioGroup("q28", q28Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">29. What did Albert Gunther think about the rats in New Zealand?</div>
                   {renderRadioGroup("q29", q29Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">30. What did Ian Crook conclude from his research?</div>
                   {renderRadioGroup("q30", q30Options, true)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">31. What were the findings of Richard Holdaway’s research?</div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">32. The available research supports Holdaway’s theory but it has not been proved.</div>
                   {renderRadioGroup("q32", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">33. Nowadays, it is possible to totally destroy a population of rats on a small island.</div>
                   {renderRadioGroup("q33", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">34. Crook was the first person to recognize the potential of offshore islands as sanctuaries.</div>
                   {renderRadioGroup("q34", ynOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">35. Tuatara numbers are continuing to fall.</div>
                   {renderRadioGroup("q35", ynOptions, false)}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   <strong>What conclusions can we draw?</strong>
                 </p>

                <p className="parncutt-summary">
                  <span className="summary-line">
                    The most important result of the tuatara research is that it frees our <span className="question-text">36</span>
                    {renderDropdown("q36", summaryWordOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    For example, there are many similarities between rats and <span className="question-text">37</span>
                    {renderDropdown("q37", summaryWordOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    Should we now go further and consider reintroducing <span className="question-text">38</span>
                    {renderDropdown("q38", summaryWordOptions, "summary-dropdown")} to our mainland rivers?
                  </span>
                  <span className="summary-line">
                    Perhaps our children will come to believe in the <span className="question-text">39</span>
                    {renderDropdown("q39", summaryWordOptions, "summary-dropdown")} of species, in the same way that our generation refuses to accept <span className="question-text">40</span>
                    {renderDropdown("q40", summaryWordOptions, "summary-dropdown")}?
                  </span>
                </p>

                 <p className="list-of-words">
                  <strong>List of Words:</strong>
                  <span className="word-row"><strong>A</strong>. natural evolution</span>
                  <span className="word-row"><strong>B</strong>. creative thought</span>
                  <span className="word-row"><strong>C</strong>. indigenous plants</span>
                  <span className="word-row"><strong>D</strong>. trout</span>
                  <span className="word-row"><strong>E</strong>. pollution</span>
                  <span className="word-row"><strong>F</strong>. restoration</span>
                  <span className="word-row"><strong>G</strong>. native fish</span>
                  <span className="word-row"><strong>H</strong>. extinction</span>
                </p>
              </div>
            </div>
          </div>
