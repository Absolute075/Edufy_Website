...
export default function Reading125778Page() {
  ...
  const summaryDropdownOptions = [
    { value: "A", label: "A. measurement" },
    { value: "B", label: "B. security" },
    { value: "C", label: "C. implementation" },
    { value: "D", label: "D. profits" },
    { value: "E", label: "E. observation" },
    { value: "F", label: "F. communication" },
    { value: "G", label: "G. preservation" },
  ];
  ...
  return (
    <div>
      <Head>
        ...
        <title>Reading Passage 3 – The Happiness Industry</title>
        <link
          rel="stylesheet"
      ...
      <style jsx global>{`
        ...
        .rounded-dropdown.rounded-dropdown--inline .rounded-dropdown-menu {
          border-radius: 12px;
        }
        ...
        .rounded-dropdown.rounded-dropdown--inline .rounded-dropdown-item {
          padding: 7px 10px;
          font-size: 12px;
        }
            ...
            >
             ...
             {passageHtml === null ? (
                <div id="passage3" ref={passageRef}>
                  ...
                  <p>
                    <em>* ‘behaviourism’: a branch of psychology which is concerned with observable behaviour</em>
                  </p>
                </div>
              ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
              ...
              <div className="question-group">
                <div className="question-group-title"><strong>Questions 27-29</strong></div>
                <p>
                  Choose the correct letter, <strong>A, B, C or D</strong>.
                  <br />
                  Write the correct letter in boxes <strong>27-29</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">27. What is the reviewer’s attitude to advocates of positive psychology?</div>
                  {renderAbcdRadio("q27", [
                    { value: "A", label: "A. They are wrong to reject the ideas of Bentham." },
                    { value: "B", label: "B. They are over-influenced by their study of Bentham’s theories." },
                    { value: "C", label: "C. They have a fresh new approach to ideas on human happiness." },
                    { value: "D", label: "D. They are ignorant about the ideas they should be considering." },
                  ])}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. The reviewer refers to the Greek philosopher Aristotle in order to suggest that happiness</div>
                  {renderAbcdRadio("q28", [
                    { value: "A", label: "A. may not be just pleasure and the absence of pain." },
                    { value: "B", label: "B. should not be the main goal of humans." },
                    { value: "C", label: "C. is not something that should be fought for." },
                    { value: "D", label: "D. is not just an abstract concept." },
                  ])}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. According to Davies, Bentham’s suggestion for linking the price of goods to happiness was significant because</div>
                  {renderAbcdRadio("q29", [
                    { value: "A", label: "A. it was the first successful way of assessing happiness." },
                    { value: "B", label: "B. it established a connection between work and psychology." },
                    { value: "C", label: "C. it was the first successful example of psychological research." },
                    { value: "D", label: "D. it involved consideration of the rights of consumers." },
                  ])}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 30-34</strong></div>
                <p>
                  Complete the summary using the list of words <strong>A-G</strong> below.
                  <br />
                  Write the correct letter, <strong>A-G</strong>, in boxes <strong>30-34</strong> on your answer sheet.
                </p>
                <p style={{ marginBottom: 10 }}><strong>Jeremy Bentham</strong></p>
                <p style={{ lineHeight: 2.3 }}>
                  Jeremy Bentham was active in other areas besides philosophy. In the 1790s he suggested a type of technology to improve{" "}
                  {renderLetterDropdown("q30", summaryDropdownOptions, true)}{" "}
                  for different government departments. He developed a new way of printing banknotes to increase{" "}
                  {renderLetterDropdown("q31", summaryDropdownOptions, true)}{" "}
                  and also designed a method for the{" "}
                  {renderLetterDropdown("q32", summaryDropdownOptions, true)}{" "}
                  of food. He also drew up plans for a prison which allowed the{" "}
                  {renderLetterDropdown("q33", summaryDropdownOptions, true)}{" "}
                  of prisoners at all times, and believed the same design could be used for other institutions as well. When researching happiness, he investigated possibilities for its{" "}
                  {renderLetterDropdown("q34", summaryDropdownOptions, true)}
                  , and suggested some methods of doing this.
                </p>
                <p style={{ marginTop: 12 }}>
                  <strong>List of Words:</strong>
                  <span className="word-row"><strong>A</strong>. measurement</span>
                  <span className="word-row"><strong>B</strong>. security</span>
                  <span className="word-row"><strong>C</strong>. implementation</span>
                  <span className="word-row"><strong>D</strong>. profits</span>
                  <span className="word-row"><strong>E</strong>. observation</span>
                  <span className="word-row"><strong>F</strong>. communication</span>
                  <span className="word-row"><strong>G</strong>. preservation</span>
                </p>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <div className="question question--plain">
                  <div className="question-text">35. One strength of <em>The Happiness Industry</em> is its discussion of the relationship between psychology and economics.</div>
                  {renderTfngRadio("q35")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">36. It is more difficult to measure some emotions than others.</div>
                  {renderTfngRadio("q36")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">37. Watson’s ideas on behaviourism were supported by research on humans he carried out before 1915.</div>
                  {renderTfngRadio("q37")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">38. Watson’s ideas have been most influential on governments outside America.</div>
                  {renderTfngRadio("q38")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">39. The need for happiness is linked to industrialisation.</div>
                  {renderTfngRadio("q39")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">40. A main aim of government should be to increase the happiness of the population.</div>
                  {renderTfngRadio("q40")}
                </div>
              </div>
            </div>
