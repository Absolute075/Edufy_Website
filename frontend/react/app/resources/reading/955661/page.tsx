...
export default function Reading955661Page() {
  ...
  const isTextAnswerKey = (key: QuestionKey) =>
    key === "q19" || key === "q20" || key === "q21" || key === "q22";
  ...
  <div>
    <Head>
      ...
      <title>Reading Passage 2 – The Women Scientists of Bologna</title>
      <link
        rel="stylesheet"
             ...
             >
              ...
              {passageHtml === null ? (
                <div id="passage2" ref={passageRef}>
                  ...
                  <p>
                    The 18th century was a time of logic and experimentation, and many of the sciences had their
                    beginnings at that time. But throughout most of Europe, these studies were reserved exclusively
                    for men. Few options were available to European women with an inclination to study. A university
                    education was off-limits to women almost everywhere in Europe, with one possible exception:
                    Italy. In Italian universities, women competed equally with men, and among those liberal Italian
                    universities, one in particular stands apart.
                  </p>
                  <h4><strong>B</strong></h4>
                  <p>
                    The University of Bologna was founded in 1088 as a law school and is the oldest university in
                    Europe. During the 18th century, intellectually gifted women from the upper classes, and
                    sometimes even from the less economically advantaged classes, had access to a level of education
                    not available in most Western nations until the 20th century. Most of these women, as the
                    following short biographies demonstrate, flourished in various areas of science.
                  </p>
                  <h4><strong>C</strong></h4>
                  <p>
                    Among the women professors of the University of Bologna, Laura Bassi (1711–1778) was the pioneer.
                    She was the first woman to earn a PhD, and the university’s first female professor. At the age
                    of 21, Bassi became Professor of Physics. However, the university was not so liberal as to allow
                    her to give lectures there; this remained a right reserved solely for men. Bassi was therefore
                    obliged to conduct her lectures and her experiments in her home. She conducted physics tutorials
                    and experiments for her students throughout her academic career, and for over thirty years
                    offered an annual public lecture on experimental physics. She also continued her own studies in
                    literature as well as science, but considered only science as truly valuable, focusing on
                    mechanics, hydraulics, and anatomy. But perhaps her most enduring achievement is the legacy she
                    left to the women who followed her. Bassi’s scholarship and life-long achievement in both
                    research and teaching made it easier for other women to obtain university appointments. Most
                    importantly, her successors were accorded full professional privileges without restrictions
                    based on gender.
                  </p>
                  <h4><strong>D</strong></h4>
                  <p>
                    In the 18th century, anatomy stood at the vanguard of medical research, and in 1742 French Lelli,
                    a painter and sculptor, became the first person to make a detailed reconstruction of the human
                    skeleton and muscles in wax. These models were used to familiarize students with the human body.
                    Lelli was assisted in his work by Giovanni Manzolini, who later became a professor at the
                    University of Bologna. In turn, Manzolini was assisted by his wife, Anna Morandi (1716–1774),
                    who came to be considered the finest practitioner of artistic anatomy.
                  </p>
                  <h4><strong>E</strong></h4>
                  <p>
                    Morandi did not set out to become an anatomist. Her early education focused on drawing and
                    sculpting, but she later combined her keen observations and her artistic talent to produce very
                    faithful reproductions of anatomical systems. When her husband fell ill and could no longer
                    teach, Morandi was officially charged with delivering his lectures. After he died in 1760,
                    Morandi was elected a professorship at the university and, nine years later, was also named the
                    anatomy department’s chief model maker.
                  </p>
                  <h4><strong>F</strong></h4>
                  <p>
                    Maria Gaetana Agnesi (1718–1799), the daughter of Pietro Agnesi, a professor of mathematics at
                    the University of Bologna, was born with a brilliant and talented mind. She mastered French by
                    the time she was five years old, and a number of ancient languages by the age of nine. Later,
                    Agnesi focused her attention on mathematics. She devoted herself to algebra and geometry in her
                    studies, and compiled the book that made her famous, Institutional Analitiche (Analytical
                    Institutions), which for the first time provided a synthesis of many different branches of
                    mathematics. The work became well known because its terminology constituted a basis for
                    subsequent scientific works, dictionaries, and encyclopedias. The French Academy of Sciences
                    offered the highest praise to the author, though its regulations prevented her from being
                    admitted as a member. Agnesi may have been denied admission to the French Academy, but she was
                    admitted into the Academy of Sciences in Bologna. Upon her father’s death in 1752, Agnesi
                    abandoned mathematics and the academy to care for the elderly, the poor, and the sick until her
                    death in 1799.
                  </p>
                  <h4><strong>G</strong></h4>
                  <p>
                    Maria Dalle Donne (1778–1842) was born into an average family in the small village of Roncastaldo
                    on the outskirts of Bologna. A peasant girl from such a modest background would not normally
                    have been encouraged to study, but Dalle Donne was born with a physical deformity; this may have
                    led her family to think she would never marry. Under these circumstances, the family might have
                    felt more inclined to educate the girl. In any event, Dalle Donne’s cousin recognized her
                    talents and took charge of her education. He enlisted the help of Luigi Rodati, a physician, who
                    taught her himself and later recruited professors of physics, surgery, and epilepsy to instruct
                    her. In 1799, Dalle Donne passed her examinations with the highest honors and became the first
                    female doctor of medicine.
                  </p>
                  <h4><strong>H</strong></h4>
                  <p>
                    Several years later, Dalle Donne became the Director of one of the Departments of Medicine at the
                    University of Bologna, where she gained a reputation as a stimulating lecturer. She was emphatic
                    about the need to educate young women in areas of medicine and accepted girls into her program
                    without regard for their ability to pay. Perhaps because of her own modest origins, she assisted
                    talented but financially deprived girls, bringing some measure of democracy to the education of
                    women.
                  </p>
                </div>
              ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
            ...
            >   
              ...
              <div className="question-group">
                ...
                <div className="question question--plain" data-question="14">
                  <div className="question-text">14. A description of a teaching aid used in the 18th century</div>
                  {renderLetterDropdown("q14", ["A", "B", "C", "D", "E", "F", "G", "H"])}
                </div>

                <div className="question question--plain" data-question="15">
                  <div className="question-text">15. Reference to a promotion arising from the misfortune of a close family member</div>
                  {renderLetterDropdown("q15", ["A", "B", "C", "D", "E", "F", "G", "H"])}
                </div>

                <div className="question question--plain" data-question="16">
                  <div className="question-text">16. How a handicap may have resulted in a girl being given the opportunity to study</div>
                  {renderLetterDropdown("q16", ["A", "B", "C", "D", "E", "F", "G", "H"])}
                </div>

                <div className="question question--plain" data-question="17">
                  <div className="question-text">17. Mention of a restriction placed on where a woman could teach</div>
                  {renderLetterDropdown("q17", ["A", "B", "C", "D", "E", "F", "G", "H"])}
                </div>

                <div className="question question--plain" data-question="18">
                  <div className="question-text">18. Reference to an important academic text</div>
                  {renderLetterDropdown("q18", ["A", "B", "C", "D", "E", "F", "G", "H"])}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 28 }}>
                <div className="question-group-title"><strong>Questions 19-22</strong></div>
                <p>
                  Complete the summary below.
                  <br />
                  Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.
                  <br />
                  Write your answers in boxes <strong>19–22</strong> on your answer sheet.
                </p>
                <p>
                  <strong>Women’s Education in 18th-Century Europe</strong>
                  <br />
                  During the 18th century, Italy was the only country in Europe to give women the chance to study
                  at university. The most notable of the institutions which opened their doors to women was the
                  University of Bologna. Although it was originally intended to teach the subject of {renderTextInput("q19")} many of its most famous women
                  students worked in the field of {renderTextInput("q20")}.
                  <br />
                  Laura Bassi was the first woman teacher at the University of Bologna, and as well as teaching
                  her students she also at times addressed people outside the university on the subject of {renderTextInput("q21")}.
                  Of all her studies, Bassi gave least importance to the subject of {renderTextInput("q22")}.
                </p>
              </div>

              <div className="question-group" style={{ marginTop: 28 }}>
                <div className="question-group-title"><strong>Questions 23-26</strong></div>
                <p>
                  Look at the following statements (Questions 23–26) and the list of women scholars below.
                  <br />
                  Match each statement with the correct woman scholar, <strong>A, B, C, or D</strong>.
                  <br />
                  Write the correct letter, <strong>A, B, C, or D</strong>, in boxes <strong>23–26</strong> on your answer sheet.
                </p>

                <div className="question question--plain" data-question="23">
                  <div className="question-text">23. She offered tuition to those who could not afford the normal fee.</div>
                  {renderLetterDropdown("q23", ["A", "B", "C", "D"])}
                </div>

                <div className="question question--plain" data-question="24">
                  <div className="question-text">24. Her example helped others to obtain a right she did not have herself.</div>
                  {renderLetterDropdown("q24", ["A", "B", "C", "D"])}
                </div>

                <div className="question question--plain" data-question="25">
                  <div className="question-text">25. She devoted a long period of her life to charitable work.</div>
                  {renderLetterDropdown("q25", ["A", "B", "C", "D"])}
                </div>

                <div className="question question--plain" data-question="26">
                  <div className="question-text">26. She was put in charge of creating teaching materials.</div>
                  {renderLetterDropdown("q26", ["A", "B", "C", "D"])}
                </div>

                <p style={{ marginTop: 18 }}>
                  <strong>List of Women Scholars</strong>
                  <br />
                  A. Laura Bassi
                  <br />
                  B. Anna Morandi
