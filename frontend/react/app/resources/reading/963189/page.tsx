...
export default function Reading963189Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – Archaeologists</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <h3>Archaeologists discover evidence of prehistoric island settlers</h3>
                   <p>
                     In early April 2019, Dr Ceri Shipton and his colleagues from Australian National University became
                     the first archaeologists to explore Obi, one of many tropical islands in Indonesia’s Maluku Utara
                     province. The research team’s discoveries suggest that the prehistoric people who lived on Obi were
                     adept on both land and sea, hunting in the dense rainforest, foraging on the seashore, and possibly
                     even voyaging between islands.
                   </p>
                   <p>
                     The excavations were part of a project to learn more about how people first dispersed from mainland
                     Asia, through the Indonesian archipelago and into the prehistoric continent that once connected
                     Australia and New Guinea. The team’s earlier research suggested that the northernmost islands in the
                     group, known as the Wallacean Islands, including Obi, would have offered the easiest migration
                     route. It also seemed likely that these islands were crucial ‘stepping stones’ on humans’
                     island-hopping voyages through this region millennia ago. But to support this idea, they needed
                     archaeological evidence for humans living in this remote area in the ancient past. So, they travelled
                     to Obi to look for sites that might reveal evidence of early occupation.
                   </p>
                   <p>
                     Just inland from the village of Kelo on Obi’s northern coast, Shipton and his colleagues found two
                     caves containing prehistoric rock shelters that were suitable for excavation. With the permission and
                     help of the local people of Kelo, they dug a small test excavation in each shelter. There they found
                     numerous artefacts, including fragments of axes, some dating to about 14,000 years ago. The earliest
                     axes at Kelo were made using clam shells. Axes made from clam shells from roughly the same time had
                     also previously been found elsewhere in this region, including on the nearby island of Gobe to the
                     northeast. As on Gobe, it is highly likely that Obi’s axes were used in the construction of canoes,
                     thus allowing these early peoples to maintain connections between communities on neighbouring
                     islands.
                   </p>
                   <p>
                     The oldest cultural layers from the Kelo site provided the team with the earliest record for human
                     occupation on Obi, dating back around 18,000 years. At this time the climate was drier and colder
                     than today, and the island’s dense rainforests would likely have been much less impenetrable than
                     they are now. Sea levels were about 120 metres lower, meaning Obi was a much larger island,
                     encompassing what is today the separate island of Bisa, as well as several other small islands
                     nearby.
                   </p>
                   <p>
                     Roughly 11,700 years ago, as the most recent ice age ended, the climate became significantly warmer
                     and wetter, no doubt making Obi’s jungle much thicker. According to the researchers, it is no
                     coincidence that around this time the first axes crafted from stone rather than sea shells appear,
                     likely in response to their increased, heavy-duty use for clearing and modification of the
                     increasingly dense rainforest. While stone takes about twice as long to grind into an axe compared to
                     shell, the harder material keeps its sharp edge for longer.
                   </p>
                   <p>
                     Judging by the bones which the researchers unearthed in the Kelo caves, people living there mainly
                     hunted the Rothschild’s cuscus, a possum-like creature that still lives on Obi today. As the forest
                     grew more dense, people probably used axes to clear patches of forest and make hunting easier.
                   </p>
                   <p>
                     Shipton’s team’s excavation of the shelters at the Kelo site unearthed a volcanic glass substance
                     called obsidian, which must have been brought over from another island, as there is no known source
                     on Obi. It also revealed particular types of fossils, similar to those previously found on islands in
                     southern Wallacea. These finds again support the idea that Obi islanders routinely travelled to other
                     islands.
                   </p>
                   <p>
                     The excavations suggest people successfully lived in the two Kelo shelters for about 10,000 years.
                     But then, about 8,000 years ago, both were abandoned. Did the residents leave Obi completely, or
                     move elsewhere on the island? Perhaps the jungle had grown so thick that axes were no longer a match
                     for the dense undergrowth. Perhaps people simply moved to the coast and turned to fishing rather than
                     hunting as a means of survival.
                   </p>
                   <p>
                     Whatever the reason for the departure, there is no evidence for use of the Kelo shelters after this
                     time, until about 1,000 years ago, when they were re-occupied by people who owned items made out of
                     gold, silver and pottery. It seems likely, in view of Obi’s location, that this final phase of
                     occupation also saw the Kelo shelters used by people involved in the historic trade in spices between
                     the Maluku islands and the rest of the world.
                   </p>
                 </div>
               ) : (
               ...
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     1. Archaeological research had taken place on the island of Obi before the arrival of Ceri Shipton
                     and his colleagues.
                   </div>
                   {renderTfngRadio("q1")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     2. The research team went to the Wallacean islands to try to prove a theory about the migration of
                     prehistoric people.
                   </div>
                   {renderTfngRadio("q2")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     3. At the Kelo sites, the researchers found the first clam shell axes ever to be discovered in the
                     region.
                   </div>
                   {renderTfngRadio("q3")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">4. The size of Obi today is less than it was 18,000 years ago.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">
                     5. A change in the climate around 11,700 years ago had a greater impact on Obi than on the
                     surrounding islands.
                   </div>
                   {renderTfngRadio("q5")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     6. The researchers believe there is a connection between warmer, wetter weather and a change in the
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>Archaeological findings on Obi</strong>
                   </span>
                   <span className="summary-line">
                     Excavations of rock shelters inside {renderTextInput("q7")} near the village of Kelo revealed:
                   </span>
                   <span className="summary-line">
                     - Axes from around 14,000 years ago, probably used to make {renderTextInput("q8")} .
                   </span>
                   <span className="summary-line">
                     - Axes made out of {renderTextInput("q9")} dating from around 11,700 years ago.
                   </span>
                   <span className="summary-line">
                     - {renderTextInput("q10")} of an animal; evidence of what ancient islanders ate.
                   </span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">Evidence of travel between islands:</span>
                   <span className="summary-line">
                     - {renderTextInput("q11")}: a material that is not found naturally on Obi.
                   </span>
                   <span className="summary-line">
                     - {renderTextInput("q12")}: which resembled ones found on other islands.
                   </span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">
                     Evidence from around 8,000 to 1,000 years ago suggests that Obi islanders:
                   </span>
                   <span className="summary-line">- May have switched from hunting to fishing.</span>
                   <span className="summary-line">
                     - Used objects made of various materials, including metal and pottery.
                   </span>
                   <span className="summary-line">
                     - Probably took part in the production and sale of {renderTextInput("q13")} .
                   </span>
                 </p>
               </div>
             </div>
