...
const correctAnswers = {
  q28: "wood",
  q29: "status and wealth",
  q30: "expensive commodity",
  q31: "classical",
  q32: "furniture and textiles",
  q33: "Edwin Lutyens",
...
export default function Reading998755Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – British Architecture</title>
         <link
           rel="stylesheet"
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
              ...
              <div className="question-group">
               <div className="question-group-title"><strong>Questions 28-34</strong></div>
                <p>
                  Complete the sentences below.
                  <br />
                  Choose <strong>NO MORE THAN THREE WORDS</strong> from the passage for each answer.
                  <br />
                  Write your answers in boxes <strong>28–34</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">28. The Anglo-Saxon architecture failed to last because the buildings were constructed in {renderTextInput("q28")}.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. Different from the medieval architecture, the buildings of the 16th century represents {renderTextInput("q29")}.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. The costly glass was applied widely as an {renderTextInput("q30")} in that years.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">31. Inigo Jones was skilled at handling {renderTextInput("q31")} style.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">32. William Morris favored the production of {renderTextInput("q32")} made in pre-industrial manufacturing techniques.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">33. The architects such as {renderTextInput("q33")} provided the landlord with conservative houses.</div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">34. After World War Two, the architect commission shifted from individual to {renderTextInput("q34")}.</div>
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter in boxes <strong>35–40</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">35. The feature of medieval architecture was</div>
                  {renderAbcdRadio("q35", [
                    { value: "A", label: "A. immense" },
                    { value: "B", label: "B. useful" },
                    { value: "C", label: "C. decorative" },
                    { value: "D", label: "D. bizarre" },
                  ])}

                </div>

                <div className="question question--plain">
                  <div className="question-text">36. What contributes to the outward-looking buildings in the 16th century?</div>
                  {renderAbcdRadio("q36", [
                    { value: "A", label: "A. safety" },
                    { value: "B", label: "B. beauty" },
                    { value: "C", label: "C. quality" },
                    { value: "D", label: "D. technology" },
                  ])}

                </div>

                <div className="question question--plain">
                  <div className="question-text">37. Why were the buildings in the 1660s influenced by the latest European trends?</div>
                  {renderAbcdRadio("q37", [
                    { value: "A", label: "A. Because the war was lost." },
                    { value: "B", label: "B. Because the craftsman came from all over the Europe." },
                    { value: "C", label: "C. Because the property belongs to the gentlemen and nobles." },
                    { value: "D", label: "D. Because the monarch came back from the continent." },
                  ])}

                </div>

                <div className="question question--plain">
                  <div className="question-text">38. What kind of sense did the British Baroque imply?</div>
                  {renderAbcdRadio("q38", [
                    { value: "A", label: "A. tough" },
                    { value: "B", label: "B. steady" },
                    { value: "C", label: "C. mild" },
                    { value: "D", label: "D. conservative" },
                  ])}

                </div>

                <div className="question question--plain">
                  <div className="question-text">39. The individual craftsman was no more the key to creation for the appearance of</div>
                  {renderAbcdRadio("q39", [
                    { value: "A", label: "A. Crystal Palace" },
                    { value: "B", label: "B. preindustrial manufacturing return" },
                    { value: "C", label: "C. industrial process in scale" },
                    { value: "D", label: "D. ornament" },
                  ])}

                </div>

                <div className="question question--plain">
                  <div className="question-text">40. The building style changed after World War Two as a result of</div>
                  {renderAbcdRadio("q40", [
                    { value: "A", label: "A. abundant materials" },
                    { value: "B", label: "B. local authority" },
                    { value: "C", label: "C. shortage of cheap housing" },
                    { value: "D", label: "D. conservative view" },
                  ])}
