...
export default function Reading111444Page() {
  ...
  const dropdownOptions = ["A", "B", "C", "D"] as const;
  ...
  return (
    <div>
      <Head>
        ...
        <title>Reading Passage 2 – STRESS LESS</title>
        <link
          rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>STRESS LESS</h3>
             ...
             >
              ...
              <div className="question-group">
                ...
                <p>
                  ...
                  <br />
                  Match each statement with the correct person, <strong>A-D</strong>.
                  <br />
                  Write the correct letter, <strong>A-D</strong>, in boxes <strong>14-18</strong> on your answer sheet.
                  <br />
                ...
                <div className="question question--plain">
                  <div className="question-text">14. High-level workers tend to react positively to stress</div>
                  {renderLetterDropdown("q14", [
                    { value: "A", label: "A. Neil Plumridge" },
                    { value: "B", label: "B. Gal Zauberman and John Lynch" },
                    { value: "C", label: "C. Jan Elsner" },
                    { value: "D", label: "D. Tony LaMontagne" },
                  ])}
                </div>

                <div className="question question--plain">
                  <div className="question-text">15. Stress levels are increased by trying to please customers</div>
                ...
                <div className="question question--plain">
                  <div className="question-text">16. Support from other workers may relieve stress</div>
                ...
                <div className="question question--plain">
                  <div className="question-text">17. Lack of independence at work is often responsible for stress</div>
                ...
                <div className="question question--plain">
                  <div className="question-text">18. Workers commonly expect their workloads to lessen over time</div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 19-21</strong></div>
                <p>
                  For questions 19-21, choose the correct letter <strong>A, B, C or D</strong>.
                  <br />
                  Write the correct letter <strong>A-D</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">19. Which of the following is NOT mentioned by Neil Plumridge as an indication that his workload is too heavy?</div>
                  {renderAbcdRadio("q19", [
                    { value: "A", label: "A. an inability to keep to his schedule" },
                    { value: "B", label: "B. inattention to family celebrations" },
                    { value: "C", label: "C. a lack of concentration on a task" },
                    { value: "D", label: "D. a period of insufficient sleep" },
                  ])}
                </div>

                <div className="question question--plain">
                  <div className="question-text">20. Which method of lessening work stress is NOT suggested by Neil Plumridge?</div>
                  {renderAbcdRadio("q20", [
                    { value: "A", label: "A. rethinking ideas of what can be achieved" },
                    { value: "B", label: "B. extending the deadline for completing the task" },
                    { value: "C", label: "C. using more workers on a project" },
                    { value: "D", label: "D. taking more time off for sport or other recreation" },
                  ])}
                </div>

                <div className="question question--plain">
                  <div className="question-text">21. According to Jan Elsner, meditation offers a method of</div>
                  {renderAbcdRadio("q21", [
                    { value: "A", label: "A. taking a worker’s mind off his troubles" },
                    { value: "B", label: "B. changing physical response to stress" },
                    { value: "C", label: "C. resting more effectively" },
                    { value: "D", label: "D. encouraging executives to take breaks" },
                  ])}
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write your answers in boxes <strong>22–26</strong> on your answer sheet.
                </p>
                <p><strong>Stress: its effects and how to reduce it</strong></p>

                <div className="question question--plain">
                  <div className="question-text">
                    Statistics on workers’ compensation show that people take more time off work due to stress than for any other
                    {" "}
                    {renderTextInput("q22", "22")}
                    {" "}
                    at work.
                  </div>
                </div>
                ...
                <div className="question question--plain">
                  <div className="question-text">
                    On average, workers who take time off because of stress stay away for
                    {" "}
                    {renderTextInput("q23", "23")}
                    .
                  </div>
                </div>
                ...
                <div className="question question--plain">
                  <div className="question-text">
                    This absence comes at a high price – while the number of insurance claims due to stress amount to only
                    {" "}
                    {renderTextInput("q24", "24")}
                    {" "}
                    of the total, they account for a much higher proportion of the cost of claims payments.
                  </div>
                </div>

                <div className="question question--plain">
                  <div className="question-text">
                    Experts believe that seeking to relieve stress through physical therapies such as sport or
                    {" "}
                    {renderTextInput("q25", "25")}
                    {" "}
                    may be less effective than simply reviewing your
                    {" "}
                    {renderTextInput("q26", "26")}
                    .
                  </div>
                </div>
              </div>
