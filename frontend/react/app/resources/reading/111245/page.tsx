...
export default function Reading111245Page() {
  ...
  key === "q24";
   ...
   const q25_26Options: Array<{ value: string; label: string }> = [
     { value: "A", label: "A  It was the first educational establishment designed with biophilic principles" },
     { value: "B", label: "B  It is beneficial for both students and the environment" },
     { value: "C", label: "C  It has established new concepts for classroom design" },
     { value: "D", label: "D  It aims to inspire new ways of thinking about the environment" },
     { value: "E", label: "E  It provides solar power to other buildings in the surrounding area" },
   ];

   const selectedQ25_26 = useMemo(() => {
     const raw = [(selections.q25 ?? "").trim(), (selections.q26 ?? "").trim()].filter(Boolean);
     return Array.from(new Set(raw));
   }, [selections.q25, selections.q26]);

   const setSelectedQ25_26 = (values: string[]) => {
     const next = Array.from(new Set(values.map((v) => v.trim()).filter(Boolean))).slice(0, 2);
     next.sort();
     setSelections((s) => ({
       ...s,
       q25: next[0] ?? "",
   ...
   const toggleQ25_26 = (value: string) => {
     if (submitted) return;
     const v = value.trim();
     if (!v) return;

     if (selectedQ25_26.includes(v)) {
       setSelectedQ25_26(selectedQ25_26.filter((x) => x !== v));
       return;
     }

     if (selectedQ25_26.length >= 2) return;
     setSelectedQ25_26([...selectedQ25_26, v]);
   };
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – Biophilic Design</title>
         <link
           rel="stylesheet"
       ...
       <style jsx global>{`
         ...
         .two-choice-option input:checked + .two-choice-circle {
           border-color: #3182ce;
         }

         .two-choice-option input:checked + .two-choice-circle::after {
           transform: scale(1);
         }
            ...
            >
              <div className="question-group">
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter, A-H, in boxes <strong>14-19</strong> on your answer sheet.
                  <br />
                  <strong>NB</strong> You may use any letter more than once.
                </p>

                <div className="question question--plain">
                  <div className="question-text">14. a description of how rapid change has a negative effect on people</div>
                  {renderDropdown("q14", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">15. a reference to an architect whose designs were uncharacteristic of biophilia</div>
                  {renderDropdown("q15", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">16. a definition of the two main aims of biophilia</div>
                  {renderDropdown("q16", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">17. a positive claim about early forms of architecture</div>
                  {renderDropdown("q17", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">18. a reference to the fact that many architects are too focused on innovation</div>
                  {renderDropdown("q18", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">19. a description of features which conserve energy in a biophilic design</div>
                  {renderDropdown("q19", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 20-24</strong></div>
                <p>
                  Complete the sentences below.
                  <br />
                  Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.
                  <br />
                  Write your answers in boxes <strong>20-24</strong> on your answer sheet.
                </p>

                <div style={{ lineHeight: 2.0 }}>
                  <p className="summary-inline">
                    20. In the modern world, {renderTextInput("q20", "20")} advancements are happening so quickly that humans are unable to adjust to them.
                  </p>
                  <p className="summary-inline">
                    21. Biophilia can help us deal with the {renderTextInput("q21", "21")} caused by the difficulties of our current lifestyles.
                  </p>
                  <p className="summary-inline">
                    22. People instinctively feel more comfortable in places which have plenty of {renderTextInput("q22", "22")} something which is necessary for health and well-being.
                  </p>
                  <p className="summary-inline">
                    23. An experiment designed to test the effect of nature on patient recovery times found that those who could see a {renderTextInput("q23", "23")} made a faster recovery.
                  </p>
                  <p className="summary-inline">
                    24. There is a biophilic design feature in the University of Guelph-Humber building which improves the quality of the {renderTextInput("q24", "24")}.
                  </p>
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 25-26</strong></div>
                <p>
                  Choose TWO letters, A-E.
                  <br />
                  Write the correct letters in boxes <strong>25</strong> and <strong>26</strong> on your answer sheet.
                  <br />
                  Which TWO of the following statements does the writer make about the Adam Joseph Lewis Center at Oberlin College?
                </p>

                <div className="question question--plain">
                  <div className="two-choice-group" role="group" aria-label="q25-q26">
                    {q25_26Options.map((o) => {
                      const checked = selectedQ25_26.includes(o.value);
                      return (
                        <label
                          key={o.value}
                          className="two-choice-option"
                          onMouseDown={(e) => {
                            e.preventDefault();
                          }}
                          onClick={(e) => {
                            e.preventDefault();
                            toggleQ25_26(o.value);
                          }}
                        >
                          <input
                            type="checkbox"
                          ...
                          />
                          <span className="two-choice-circle" aria-hidden="true" />
                          <span>{o.label}</span>
                        </label>
                      );
                    })}
