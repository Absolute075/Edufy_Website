...
export default function Reading168963Page() {
  ...
  const isTextAnswerKey = (key: QuestionKey) => key === "q24" || key === "q25" || key === "q26";
  ...
  useEffect(() => {
   ...
   const peopleOptions = [
     { value: "A", label: "A - Lars Hallwicken" },
     { value: "B", label: "B - Ted Michals" },
     { value: "C", label: "C - Joergen Fenham" },
     { value: "D", label: "D - Joan Marc Simon" },
     { value: "E", label: "E - Tim Burns" },
     { value: "F", label: "F - Richard Fisher" },
     { value: "G", label: "G - World Bank" },
   ];
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q14" || key === "q15" || key === "q16" || key === "q17" || key === "q18" || key === "q19") {
       return headingOptions.find((o) => o.value === value)?.label ?? value;
     }
     if (key === "q20" || key === "q21" || key === "q22" || key === "q23") {
       return peopleOptions.find((o) => o.value === value)?.label ?? value;
     }
     return value;
   };
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – Solving the Problem of Waste Disposal</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <span className="label">A</span> For many years, burning rubbish has been portrayed as the lazy option when it
                     comes to dealing with the problem of waste disposal, since it sends toxic fumes into the air and
                     appears to support a consumerist, throwaway society. Norway, however, appears to be burning its
                     way through a sizeable chunk of Europe's municipal waste, using the heat created by this process
                     to warm and power homes in many of its cities. Norway isn't alone: Germany, Sweden, Belgium and
                     the Netherlands all burn significant quantities of rubbish, and across Europe there are 420
                     plants burning municipal waste. With Europe dumping 150 million tonnes of rubbish into landfill
                     every year, there would seem to be limitless supply.
                   </p>
                   <p>
                     <span className="label">B</span> Those who support burning waste say that a new generation of incinerators have
                     made it a more attractive option. Filters and scrubbing mechanisms now capture harmful
                     substances such as mercury, hydrochloric acid and heavy metals. According to Ted Michals,
                     president of the US-based Energy Recovery Center, "There has been constant evolution in
                     combustion engineering and emissions-control technology, and the output from these facilities is
                     now minuscule." Above all, however, supporters say that incineration is the costly way of
                     preventing the long-term impacts on landfill. In ten years' time, says the World Bank, humans
                     will be generating 2.2 billion tonnes of solid waste per year. Advocates see incineration as a
                     practical way to deal swiftly with an immediate problem.
                   </p>
                   <p>
                     <span className="label">C</span> Levels of waste generation vary hugely around the world. "It's a problem for
                     the developed nations," says Joergen Fenham, a senior scientist working with the UN Environment
                     Programme in Denmark. "The more you consume, the more you produce, buy and throw away." But the
                     growth of incineration hasn't been universally welcomed. Lars Hallwicken, chairman of Friends of
                     the Earth in Norway, is concerned that incineration plants appear to generate demand for their
                     services. "The problem in Norway," he explains, "is that we have built too many waste-burning
                     factories. So we've ended up importing waste from other countries. If you look at this in a very
                     small perspective, it is, of course, better for the climate to burn rubbish from the UK rather
                   ...
                   <p>
                     <span className="label">D</span> Incineration is also at odds with EU policy, which promotes a "recycling
                     hierarchy": ideally, we simply produce less waste in the first place; failing that, we reuse
                     objects more, the next best option is recycling; only then should we consider incineration,
                     while dumping in landfill is the last resort. Dealing with the problem of waste disposal
                     involves tracing the whole process that took the material from its inception to landfill. "We
                     used to call this the 'cradle to grave' life cycle; now, the talk is of 'cradle to cradle' and
                     an even more comprehensive concept known as 'zero waste'." The philosophy of cradle to cradle is
                     about designing products that are actually good for the environment at the end of their life,"
                     says Joan Marc Simon, European spokesman for the environmental movement GAIA. "You design a
                     bottle that contains no toxins, is fully recyclable and requires the minimum amount of energy to
                     be produced." As Simon points out, however, without the right mechanisms in place, "nothing
                     guarantees that this bottle will end up being properly collected and treated in the appropriate
                     recycling facility."
                   </p>
                   <p>
                     <span className="label">E</span> Tim Burns, policy manager at Keep Britain Tidy, says, "In the UK alone, people
                     waste £10 billion of food every year. You can argue about composting that, or not buying it in
                     the first place—if you do that then that's money the retailers don't get, so it's not always
                     clear cut." The implications of zero waste are that we're going to have to take a good hard look
                     at those well-stocked supermarket shelves, too. "Supermarkets keep their shelves stocked even
                     when demand isn't there, which means they have to pay to dispose of a lot of food," says Burns.
                     "But that cost is less to them than the cost in brand damage of having empty shelves."
                   </p>
                   <p>
                     <span className="label">F</span> Recent history and changes in trends in recycling suggest that we should be
                     prepared for unexpected developments. "If someone back in the 1980s had suggested what waste
                     would be like now, they would be completely wrong," says Richard Fisher, a PhD researcher at
                     Cranfield University. "Consumerism has developed at a pace we never expected. Nobody would have
                     said there would be so much electronic waste. But recycling has grown, too—ten years ago nobody
                     would have predicted today's levels of recycling." But he points out that the need to reduce
                     waste is still a difficult message to sell to consumers. He suggests that what people are really
                     concerned about is their loved ones and the future they face. "Perhaps we can align the
                     environmental message to these deep-seated values," he says. "We need to look at whether it's
                     business that drives consumers or the other way around. You need government to play a leadership
                     role, whereas countries such as the UK seem to be stepping away from the environment in pursuit
                     of short-term economic goals."
                   </p>
                 </div>
               ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 <div className="question-group-title"><strong>Questions 14-19</strong></div>
                 <p>
                 ...
                 <p className="list-of-words">
                   ...
                   <span className="word-row"><strong>i</strong> New terminology reflecting changing attitudes to waste disposal</span>
                   <span className="word-row"><strong>ii</strong> Fundamental changes in behaviour in the past and future</span>
                   <span className="word-row"><strong>iii</strong> Ways of rewarding the public for recycling</span>
                   <span className="word-row"><strong>iv</strong> A surprising approach to waste disposal by several countries</span>
                   <span className="word-row"><strong>v</strong> Difficult choices for individuals and businesses</span>
                   <span className="word-row"><strong>vi</strong> Arguments against incineration from a country that uses it</span>
                   <span className="word-row"><strong>vii</strong> Justifications for the use of incineration</span>
                   <span className="word-row"><strong>viii</strong> The benefits of landfill over incineration</span>
                   <span className="word-row"><strong>ix</strong> The impact of waste disposal on climate change</span>
                   <span className="word-row"><strong>x</strong> Reasons for the growth of incineration plants</span>
                 </p>
               ...
               <div className="question-group" style={{ marginTop: 28 }}>
                 <div className="question-group-title"><strong>Questions 20-23</strong></div>
                 <p>
                 ...
                 <p className="list-of-words">
                   ...
                   <span className="word-row"><strong>A</strong> - Lars Hallwicken</span>
                   <span className="word-row"><strong>B</strong> - Ted Michals</span>
                   <span className="word-row"><strong>C</strong> - Joergen Fenham</span>
                   <span className="word-row"><strong>D</strong> - Joan Marc Simon</span>
                   <span className="word-row"><strong>E</strong> - Tim Burns</span>
                   <span className="word-row"><strong>F</strong> - Richard Fisher</span>
                   <span className="word-row"><strong>G</strong> - World Bank</span>
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">20. Incineration of waste is now relatively harmless to the environment.</div>
                   {renderDropdown("q20", peopleOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">21. Greater consumerism leads to higher levels of waste.</div>
                   {renderDropdown("q21", peopleOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">22. Proper systems are needed for the recycling of environmentally friendly products.</div>
                   {renderDropdown("q22", peopleOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">23. Efforts to reduce waste may affect profits for some types of companies.</div>
                   {renderDropdown("q23", peopleOptions)}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 28 }}>
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>What recent history tells us about recycling</strong>
                   </span>
                   <span className="summary-line">
                     Richard Fisher, a researcher from Cranfield University, points out that the pace of consumerism
                     has increased more quickly than was predicted in the 1980s. There has, for example, been
                     unexpected growth in waste from <span className="question-text">24</span>
                     {renderTextInput("q24")} products.
                   </span>
                   <span className="summary-line">
                     He suggests that the need to protect the environment should be linked to basic values, and adds
                     that it might be better if consumers had more influence over <span className="question-text">25</span>
                     {renderTextInput("q25")} and more direction was provided by <span className="question-text">26</span>
                     {renderTextInput("q26")}.
                   </span>
                 </p>
               </div>
