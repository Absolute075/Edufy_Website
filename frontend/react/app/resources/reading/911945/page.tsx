...
export default function Reading911945Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – Amber</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <p>
                     Amber is a yellowish semi-precious substance, formed in prehistoric times from the hardened and
                     fossilised resin of coniferous pine trees. It has been used for thousands of years to make
                     jewellery and other decorative objects, being relatively soft and easy to work. Amber can also
                     be polished to produce an attractive gleam. One disadvantage is that it is susceptible to
                     degradation, becoming cloudy as the colours gradually fade following exposure to air. For this
                     reason, many amber artefacts do not look as impressive as they did when they were first made.
                   </p>
                   <p>
                     For the ancient world, the main source of amber was the Baltic region in northern Europe, on the
                     eastern coast of the Baltic Sea, where pieces washed onto beaches and could be easily collected.
                     Amber was sought after not only for its decorative appeal, but also because many thought that it
                     offered protection against evil. For this reason, people in ancient Egypt and Greece wore or
                     carried small ornaments known as ‘amulets’, and those made with amber were said to be among the
                     most powerful. There was a belief that it could even soothe mouth and throat complaints, and it
                     was also ground and mixed with rose oil and honey to treat eye and ear infections. As amber
                     naturally contains succinic acid, which was used in treatments prior to the use of antibiotics,
                     this belief in its medicinal qualities was quite reasonable. The ancients also noticed that when
                     rubbed, amber produced an electrical charge that drew other objects towards it. This ability to
                     attract objects such as dried grasses led to the Persians calling amber kahroba or
                     ‘straw-robber’.
                   </p>
                   <p>
                     The ancient world also had popular myths about amber’s origins, such as the story that it was the
                     crystallised tears of a Greek goddess whose son was killed by a bolt of lightning. Colourful
                     though such stories were, even people of the time may not have taken them too seriously, as
                     writers such as the Greek philosopher Aristotle (384–322 BCE) had already correctly identified
                     amber as a hardened resin. In addition, a number of myths about amber involved insects,
                     indicating an awareness of its true origins.
                   </p>
                   <p>
                     ...
                     assertions that amber originated from pine trees, writing that if amber was burnt, it smelled of
                     pine. He also knew it originally existed in a liquid state because of the trapped insects
                   ...
                   <p>
                     The earliest evidence of people working with amber in the Baltic dates to the Neolithic period
                     (approx. 6000–2200 BCE). But it was contact between the peoples of the Bronze Age (approx.
                     2200–800 BCE) that ensured amber spread across Europe, with various tribes trading pieces of
                     amber and receiving metals in return. Amber was taken south from the Baltic via rivers to the
                     Adriatic Sea, from where it was shipped to western Asia. Perhaps because of its rarity so far
                     from its source, amber was particularly prized in this region, where it signified power and
                     social standing for kings and queens. Priests were another group that wore amber as a mark of
                     distinction. Some amber beaded jewellery has been discovered in tombs in ancient Egypt, although
                     finds here are uncommon.
                   </p>
                   <p>
                     During the Iron Age, the east coast of modern-day Italy became something of a specialist in
                     amber. By the 9th century BCE, the coastal region of Verucchio had become an important
                     manufacturing centre. Here, significant quantities of artefacts have been found, including amber
                     discs for earrings and necklaces, and amber that would have been an embellishment for clothes
                     that have disintegrated over time. The Etruscans, who flourished in central Italy between the
                     8th and 3rd centuries BCE, continued working with amber, creating fine jewellery and small
                     figurines of animals and humans.
                   </p>
                   <p>
                     Although amber seems to have gone out of fashion during the Greek Classical period (500–300 BCE),
                     it saw a resurgence in popularity during the Roman Empire (31 BCE–476 CE). Aquileia, in central
                     Italy, became a noted centre of production between the 1st and 2nd centuries CE. Amber workshops
                     in this region produced many objects such as drinking goblets, which were sold for high prices
                     to rich Romans for use in their homes. Its reputation as a protective talisman continued, and it
                     was widely used by Romans, in particular gladiators (men trained to fight in arenas for sport),
                     who attached pieces of amber to their fighting equipment to ward off danger. The Romans’ use of
                     amber declined from the 3rd century CE, but it remained popular in the Baltic regions. In the
                     medieval period, the Armenians became the new champions of amber, and ensured its trade and
                     manufacture into fine decorative pieces continued into modern times.
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">1. The appearance of amber changes over time.</div>
                   {renderTfngRadio("q1")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">2. In ancient times, the amber found on Baltic beaches came from trees growing nearby.</div>
                   {renderTfngRadio("q2")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">3. All protective amulets in ancient Egypt and Greece contained amber.</div>
                   {renderTfngRadio("q3")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">4. It is clear why people assumed that amber had healing properties.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">5. One name for amber comes from its effect on other objects.</div>
                   {renderTfngRadio("q5")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">6. Aristotle’s definition of amber supported its link to a goddess.</div>
                   {renderTfngRadio("q6")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>Amber in the Ancient World</strong>
                   </span>
                   <span className="summary-line">
                     <strong>Bronze Age</strong>
                   </span>
                   <span className="summary-line">
                     Amber was:
                   </span>
                   <span className="summary-line">
                     - traded in exchange for various {renderTextInput("q7")}.
                   </span>
                   <span className="summary-line">
                     - transported through Europe along {renderTextInput("q8")}.
                   </span>
                   <span className="summary-line">
                     - used as a symbol of status by royalty and {renderTextInput("q9")} in western Asia.
                   </span>
                   <span className="summary-line">
                     <strong>Iron Age</strong>
                   </span>
                   <span className="summary-line">
                   ...
                   <span className="summary-line">
                     - {renderTextInput("q10")} made of amber used in jewellery.
                   </span>
                   <span className="summary-line">
                     - decorative pieces of amber, used on {renderTextInput("q11")} which have not survived.
                   </span>
                   <span className="summary-line">
                     - amber ornaments made by the Etruscans in the shape of people and {renderTextInput("q12")}.
                   </span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">
                     <strong>Roman Empire</strong>
                   </span>
                   <span className="summary-line">
                     - amber goods, e.g., {renderTextInput("q13")} were made for wealthy households.
                   </span>
                 </p>
               </div>
             </div>
