...
export default function Reading541222Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – Conformity</title>
         <link
           rel="stylesheet"
       ...
       >
        ...
        >
          <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
            ...
            >
              <h3 style={{ marginTop: 0, marginBottom: 6, fontSize: 20, fontWeight: 700 }}>Conformity</h3>
              ...
              {passageHtml === null ? (
                <div id="passage1" ref={passageRef}>
                  ...
                  <p>
                    Probably the most famous study on conformity was undertaken by Asch (1951) when he created a situation where many of his subjects gave answers which were blatantly untrue, rather than contradict the people they were with. He did this by getting his subject to sit round a table with six stooges (colleagues of the experimenter) so that the subject was second to last. He showed them all a large card which had three lines of different lengths drawn on it, labelled A, B and C. He then gave them a card with a single line and asked them to match this in terms of length to one of the lines A, B or C. The stooges gave untrue responses in a number of the trials and the subjects were left in the situation where they either reported what they saw with their own eyes or conformed to the norm of the group. When the results were assessed, Asch found that in one out of every three trials where the wrong answer was given, the subject gave the same wrong answer as the stooges. This led to an average level of conformity of 32 per cent. Asch interviewed his subjects after the trials to try to find out why they conformed to an answer which was so obviously wrong. Most of them said that they did not want to cause problems within the group, although they felt anxious that when they did give wrong answers it made them anxious. (Asch found that when there was just one other person present who did not go along with the majority, no matter how many others there were, it was sufficient to make the subject give the right answer.)
                  </p>
                  <p>
            ...
            >
              <div className="question-group">
                ...
                <div className="question question--plain">
                  <div className="question-text">27. Childhood crazes can center on items of any value.</div>
                  {renderRadioGroup("q27", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. Children are more vulnerable to crazes now than they used to be.</div>
                  {renderRadioGroup("q28", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. Consumers make too many quick decisions in shops.</div>
                  {renderRadioGroup("q29", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. Crutchfield’s definition of conformity is the most reliable.</div>
                  {renderRadioGroup("q30", tfngOptions, false)}
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write your answers in boxes <strong>31–35</strong> on your answer sheet.
                </p>

                <p className="parncutt-summary" style={{ lineHeight: 1.9 }}>
                  <span className="summary-line"><strong>Studies on conformity</strong></span>
                  <span className="summary-line">
                    In the Jennes study, people had to guess how many {renderTextInput("q31", "31")} were in a container.
                  </span>
                  <span className="summary-line">
                    Jennes found that, in most cases, people opted for an estimate given by a {renderTextInput("q32", "32")}.
                  </span>
                  <span className="summary-line">
                    Asch asked his subjects to {renderTextInput("q33", "33")} line lengths.
                  </span>
                  <span className="summary-line">
                    To test the extent to which people would conform, he placed his subjects with colleagues who gave {renderTextInput("q34", "34")} responses.
                  </span>
                  <span className="summary-line">
                    He found that his subjects agreed with his colleagues 32% of the time, although they admitted to feeling {renderTextInput("q35", "35")} about giving their answer.
                  </span>
                </p>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p className="parncutt-summary" style={{ lineHeight: 1.9 }}>
                  <span className="summary-line"><strong>Kelman’s processes of social conformity</strong></span>
                  <span className="summary-line">
                    Compliance - people support the majority view despite their own ideas
                  </span>
                  <span className="summary-line">- social harmony is maintained</span>
                  <span className="summary-line">
                    - illustrated by the results of the research conducted by {renderTextInput("q36", "36")}
                  </span>
                  <span className="summary-line">
                    {renderTextInput("q37", "37")} - majority view is considered most {renderTextInput("q38", "38")} view
                  </span>
                  <span className="summary-line">- people persuade themselves despite their own ideas</span>
                  <span className="summary-line">
                    {renderTextInput("q39", "39")} - people change their ideas to those of the majority
                  </span>
                  <span className="summary-line">
                    - typical of {renderTextInput("q40", "40")}
                  </span>
                </p>
              </div>
            </div>
