...
export default function Reading168723Page() {
  ...
  useEffect(() => {
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q21" || key === "q22" || key === "q23") {
       return ideaOptions.find((o) => o.value === value)?.label ?? value;
     }
     return value;
   };
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – A New Look for Talbot Park</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <span className="label">A</span> Talbot Park, a housing project in Auckland, New Zealand, was once described as
                     a ghetto, troubled by high rates of crime and vandalism. However, it has just been rebuilt at a
                     cost of $48m and the project reflects some new thinking about urban design.
                   </p>
                   <p>
                     <span className="label">A</span> The new Talbot Park is immediately eye-catching because the buildings look
                   ...
                   <p>
                     <span className="label">B</span> Talbot Park is a triangle of government-owned land, which in the early 1960s
                     ...
                     Mrs so-and-so,' recalls Georgie Thompson, who grew up there in the 1960s.
                   </p>
                   <p>
                     <span className="label">C</span> Exactly what went wrong with Talbot Park is unclear. The community began to
                   ...
                   <p>
                     <span className="label">D</span> One controversial aspect of the upgrade is that the new development has
                     ...
                     a community contained but without walls.
                   </p>
                   <p>
                     <span className="label">E</span> The population today is cosmopolitan: 50% Pacific Islanders, 20% Maori, 15%
                   ...
                   <p>
                     <span className="label">F</span> Despite the quality of the buildings, however, there should be no doubt that
                     ...
                     affluent suburbs in Auckland.
                   </p>
                   <p>
                     <span className="label">G</span> Another important part of the new development is what Housing New Zealand
                   ...
                   <p>
                     <strong>state housing:</strong> government subsidised accommodation for people who cannot pay market rents
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <p className="list-of-words">
                   ...
                   <span className="word-row"><strong>i</strong> Some of the problems that developed at Talbot Park</span>
                   <span className="word-row"><strong>ii</strong> Where the residents lived while the work was being completed</span>
                   <span className="word-row"><strong>iii</strong> The ethnic makeup of the new Talbot Park</span>
                   <span className="word-row"><strong>iv</strong> The unexpectedly high standard of the housing</span>
                   <span className="word-row"><strong>v</strong> Financial hardship in Talbot Park and a neighbouring community</span>
                   <span className="word-row"><strong>vi</strong> The experiences of one family living at Talbot Park today</span>
                   <span className="word-row"><strong>vii</strong> How to co-ordinate and assist the people who live at Talbot Park</span>
                   <span className="word-row"><strong>viii</strong> Raising the money to pay for the makeover</span>
                   <span className="word-row"><strong>ix</strong> A close community in the original Talbot Park development</span>
                   <span className="word-row"><strong>x</strong> Details of the style of buildings used in the makeover</span>
                 </p>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 <div className="question-group-title"><strong>Questions 21-23</strong></div>
                 <p>
                 ...
                 <p className="list-of-words">
                   ...
                   <span className="word-row">A Good tenant management involves supervision and regulation.</span>
                   <span className="word-row">B State housing must be built at minimum expense to the public.</span>
                   <span className="word-row">C Organising social events helps tenants to live close together.</span>
                   <span className="word-row">D Mixed-race communities require adaptable and responsive designs.</span>
                   <span className="word-row">E Complaints were expected about the high standard of the development.</span>
                   <span className="word-row">F Too many rules and regulations will cause resentment from tenants.</span>
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">21. James Lundy</div>
                   {renderDropdown("q21", ideaOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">22. Graham Bodman</div>
                   {renderDropdown("q22", ideaOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">23. Stuart Bracey</div>
                   {renderDropdown("q23", ideaOptions)}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>The 'mix and match' strategy</strong>
                   </span>
                   <span className="summary-line">
                     ...
                     {renderTextInput("q24")} of accommodation would lead to the old social problems returning.
                   </span>
                   <span className="summary-line">
                     To prevent this, a team of various <span className="question-text">25</span>
                     {renderTextInput("q25")} worked on the project to ensure the buildings were not uniform.
                   </span>
                   <span className="summary-line">
                     Further, they created pleasant, functional interiors that could still be built within their{" "}
                     <span className="question-text">26</span>
                     {renderTextInput("q26")}.
                   </span>
                   <span className="summary-line">
                     Finally, the absence of walls means Talbot Park is characterised by openness, making it easier to regulate
