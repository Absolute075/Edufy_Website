...
export default function Reading999841Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – What’s Happening to Our Food?</title>
         <link
           rel="stylesheet"
            ...
            >
              <div className="question-group">
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter, A-E, in boxes <strong>14-18</strong> on your answer sheet.
                  <br />
                  <strong>NB</strong> You may use any letter more than once.
                </p>

                <div className="question question--plain">
                  <div className="question-text">14. An admission that if one type of food is harvested too soon, its taste may be affected</div>
                  {renderDropdown("q14", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">15. The view that there is not a great difference between the quantity of nutrients in our food now and in the past</div>
                  {renderDropdown("q15", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">16. A comparison which illustrates why developments in agriculture may reduce the amounts of nutrients in foods</div>
                  {renderDropdown("q16", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">17. A warning that customers could be deceived by the attractive appearance of a fruit or vegetable</div>
                  {renderDropdown("q17", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">18. Evidence of the popularity of a new development in food processing which aims to save customers trouble.</div>
                  {renderDropdown("q18", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }], "summary-dropdown")}
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter, A-F, in boxes <strong>19-22</strong> on your answer sheet.
                </p>
                ...
                <div className="question question--plain">
                  <div className="question-text">19. People are more likely to become ill if they have low levels of some nutrients.</div>
                  {renderDropdown("q19", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">20. Making healthy foods easy to cook may be more important than their vitamin content.</div>
                  {renderDropdown("q20", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">21. An improved diet has made people nowadays live longer and be healthier than in the past.</div>
                  {renderDropdown("q21", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }], "summary-dropdown")}
                </div>

                <div className="question question--plain">
                  <div className="question-text">22. People’s diets are more varied now than they were in the past.</div>
                  {renderDropdown("q22", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }], "summary-dropdown")}
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write your answers in boxes <strong>23-26</strong> on your answer sheet.
                </p>
                ...
                <p className="parncutt-summary">
                  ...
                  <span className="summary-line">
                    In order to prevent loss of nutrients when transporting fruit and vegetables, chilling is used to slow down the effect that {renderTextInput("q23", "23")} have on them.
                  </span>
                  <span className="summary-line">
                    Some foods, such as tomatoes, must be picked before they are ripe to avoid problems such as {renderTextInput("q24", "24")} during transportation.
                  </span>
                  <span className="summary-line">
                    Other foods, such as cabbage, lose nutrients when kept in the {renderTextInput("q25", "25")}.
                  </span>
                  <span className="summary-line">
                    Vegetables such as {renderTextInput("q26", "26")}, which are picked fresh and transported to the supermarket, may be less nutritious than those which are frozen.
                  </span>
                </p>
              </div>
            </div>
