...
export default function Reading665445Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – Pollution! In the Bay</title>
         <link
           rel="stylesheet"
          ...
          <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
            ...
            >
              <div className="question-group">
                <div className="question-group-title"><strong>Questions 14-17</strong></div>
                <p>
                  The reading Passage has ten paragraphs A-J.
                  <br />
                  Which paragraph contains the following information?
                  <br />
                  Write the correct letter A-J, in boxes <strong>14-17</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">14. Seagrass turned to be more resistant to the saline water level in the Bay.</div>
                  {renderDropdown("q14", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">15. Significance of finding a specific reason in controversy.</div>
                  {renderDropdown("q15", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">16. Expensive proposals raised to solve the nitrogen dilemma.</div>
                  {renderDropdown("q16", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">17. A statistic of ecological changes in both the coral area and species.</div>
                  {renderDropdown("q17", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 18-21</strong></div>
                <p>
                  Use the information in the passage to match the people (listed A-C) with opinions or deeds below.
                  <br />
                  Write the appropriate letters A-C in boxes <strong>18-21</strong> on your answer sheet.
                </p>
                ...
                <div className="question question--plain">
                  <div className="question-text">18. Drainage system in Everglades actually results in high salty water in the bay.</div>
                  {renderDropdown("q18", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">19. Restoring water high in nitrogen level will make more ecological side effect.</div>
                  {renderDropdown("q19", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">20. High nitrogen levels may be caused by the nearby farmland.</div>
                  {renderDropdown("q20", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
                ...
                <div className="question question--plain">
                  <div className="question-text">21. Released sewage rather than nutrients from agricultural area increase the level of Nitrogen.</div>
                  {renderDropdown("q21", [
                    { value: "A", label: "A" },
                    { value: "B", label: "B" },
                    { value: "C", label: "C" },
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 22-26</strong></div>
                <p>
                  Do the following statements agree with the information given in Reading Passage?
                  <br />
                  In boxes <strong>22-26</strong> on your answer sheet, write
                  <br />
                  <strong>TRUE</strong> if the statement is true
                  <br />
                  <strong>FALSE</strong> if the statement is false
                  <br />
                  <strong>NOT GIVEN</strong> if the information is not given in the passage
                </p>

                <div className="question question--plain">
                  <div className="question-text">22. Everyone agrees with “pouring water into the sea is harmless enough” even in the Florida Bay area.</div>
                  {renderRadioGroup("q22", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">23. Nitrogen was poured in from different types of crops as water flows through.</div>
                  {renderRadioGroup("q23", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">24. Everglade restoration project can be effective regardless of the cause of the pollution.</div>
                  {renderRadioGroup("q24", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">25. Human has changed Florida Bay where old image before 1950s is unrecalled.</div>
                  {renderRadioGroup("q25", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">26. Tourism contributes fundamentally to the Florida Bay area.</div>
                  {renderRadioGroup("q26", tfngOptions, false)}
                </div>
              </div>
            </div>
          </div>
