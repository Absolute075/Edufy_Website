...
export default function Reading465798Page() {
  ...
  const closeToolbarRafRef = useRef<number | null>(null);
  ...
  const summaryWordOptions = [
    { value: "A", label: "A. disruptive and unpredictable" },
    { value: "B", label: "B. everyday" },
    { value: "C", label: "C. loveable" },
    { value: "D", label: "D. controversial" },
    { value: "E", label: "E. exotic and ordinary" },
    { value: "F", label: "F. unsatisfying but surprising" },
    { value: "G", label: "G. unconfident" },
    { value: "H", label: "H. unsurprising but satisfying" },
    { value: "I", label: "I. magical" },
  ];
  ...
  useEffect(() => {
    ...
    const onKeyDown = (e: KeyboardEvent) => {
      if (e.key === "Escape") setSelectionToolbar((s) => (s.open ? { ...s, open: false } : s));
    };
  ...
  useEffect(() => {
    selectionToolbarOpenRef.current = selectionToolbar.open;
  }, [selectionToolbar.open]);

  useEffect(() => {
    return () => {
      if (closeToolbarRafRef.current !== null) {
        window.cancelAnimationFrame(closeToolbarRafRef.current);
        closeToolbarRafRef.current = null;
      }
    };
  }, []);
  ...
  const handlePassageScroll = () => {
    if (!selectionToolbarOpenRef.current) return;
    if (closeToolbarRafRef.current !== null) return;
    closeToolbarRafRef.current = window.requestAnimationFrame(() => {
      closeToolbarRafRef.current = null;
      setSelectionToolbar((s) => (s.open ? { ...s, open: false } : s));
    });
  };
  ...
  const q36Options = [
    { value: "A", text: "It is partly based on true history." },
    { value: "B", text: "It was restructured in the writing process." },
    { value: "C", text: "It is quite different from conventional stories." },
    { value: "D", text: "It does not reflect the usual themes of Mahy’s work." },
  ];
  const q37Options = [
    { value: "A", text: "was first illustrated in 1991." },
    { value: "B", text: "is written in plain language." },
    { value: "C", text: "is an old favourite for many families." },
    { value: "D", text: "has not been read aloud by Mahy before." },
  ];
  const q38Options = [
    { value: "A", text: "show how Mahy’s style has changed through generations." },
    { value: "B", text: "criticise Mahy’s children’s stories for being repetitive." },
    { value: "C", text: "describe how new media have changed entertainment." },
    { value: "D", text: "illustrate Mahy’s popularity with generations of children." },
  ];
  const q39Options = [
    { value: "A", text: "Readers sometimes do not finish Mahy’s books." },
    { value: "B", text: "Mahy actively encourages feedback from readers." },
    { value: "C", text: "Readers are necessary in order to complete a book." },
    { value: "D", text: "Mahy does not realise how important she is to some readers." },
  ];
  const q40Options = [
    { value: "A", text: "illustrating Mahy’s view of the world" },
    { value: "B", text: "comparing Mahy with another writer" },
    { value: "C", text: "correcting a misconception about Mahy" },
    { value: "D", text: "suggesting reasons for Mahy’s approach" },
  ];

  const dropdownLabel = (key: QuestionKey, value: string) => {
    if (!value) return "Select an option";
    if (key === "q32" || key === "q33" || key === "q34" || key === "q35") {
      return summaryWordOptions.find((o) => o.value === value)?.label ?? value;
    }
    return value;
  };
  ...
  const renderDropdown = (key: QuestionKey, options: Array<{ value: string; label: string }>, className?: string) => {
  ...
  return (
    <div>
      <Head>
        ...
        <title>Reading Passage 3 – The New Zealand writer Margaret Mahy</title>
      ...
      >
            ...
            >
              ...
              {passageHtml === null ? (
                <div id="passage2" ref={passageRef}>
                  <p>
                    <span className="label">A</span> In a career spanning some fifty years, Margaret Mahy has come to occupy a
                    unique place in New Zealand writing with innovative fiction and original characterisation. In our solidly
                    realist tradition, the linguistic fireworks of Mahy&apos;s children&apos;s fiction and the explorations of human
                    behaviour at the heart of her supernatural teenage fiction stand gloriously alone. Mahy&apos;s clearest heir, I
                    have always thought, is Elizabeth Knox – and maybe the true inheritance there is sheer singularity. Just as
                    there is no one else like Knox in New Zealand writing, Mahy, too, has ventured into imaginative territory
                    unknown to other local writers. So it was with great pleasure that I visited Mahy recently at her
                    Governor&apos;s Bay home to talk about her new book. As with all journalists, she is generous to a fault with her
                    time and attention; and, as always – despite her careful consideration of questions and thoughtful answers –
                    I&apos;m reminded she isn&apos;t truly comfortable making herself or her life the heart of any conversation.
                  </p>
                  <p>
                    <span className="label">B</span> Certainly, any consideration of the style of Mahy&apos;s novels and picture books
                    throws up some irresistible theories. As a writer committed to supporting herself through her art, she has
                    seldom had the time for formal research. Rather, it has been a matter of going out and finding inspiration
                    from her immediate environment: the writing on the side of a bus; a spelling mistake in a note to herself;
                    the similarity between a cat and a fur hat. But despite these sometimes mundane origins, the settings for
                    her stories are delightfully varied, as these books celebrate the dramatic plot twists and unpredictability
                    of adventures on the high seas or in Antarctica, and also in quite unassuming places like the library or
                    even down the back of a chair at home. Mahy has a lifelong affection for characters who are agents of
                    upheaval and disturbance. Her junior and picture books are peppered with pirates, robbers and lions, though
                    they appear alongside librarians, mothers and children, working against comfortable stereotype. Her fictions
                    often have at their heart a young adult burdened with special powers, such as the ability to cast spells in
                    order to transform their world in supernatural and fantastical ways. Another common feature is that, while
                    the conclusions of her tales are usually predictable, they leave the reader feeling absolutely complete, the
                    moral questions resulting from our hero&apos;s powers having been resolved.
                  </p>
                  <p>
                    <span className="label">C</span> Many of these themes can be found in her new novel, <em>The Magician of Hoad</em>.
                    The book was begun more than 15 years ago and envisioned as an &apos;entire&apos; fantasy – one set in a fully imagined
                    world with detailed history and complex tribal inter-relationships, a classical hero quest at its heart. The
                    story ballooned at one point to 800 pages and has been through at least two substantial rewrites. Now half its
                    original size, it is a fascinating read – an adventure, a romance, and a gold mine of Mahy literary
                    preoccupations.
                  </p>
                  <p>
                    <span className="label">D</span> The other splendid Mahy publication this year is a re-issue of <em>Bubble Trouble</em>
                    in a now beautifully illustrated edition. This tongue-twister tale first appeared in 1991, was included in
                    <em>100 New Zealand Poems</em> (1993) and has been recited by Mahy at countless private and public functions.
                    Perhaps more than any other work, <em>Bubble Trouble</em> is the Mahy that New Zealand children and their parents
                    know so well, the rollicking story of a clown who serves up a joyous torrent of word play and unexpected rhyme.
                  </p>
                  <p>
                    <span className="label">E</span> Those connections are four or five deep now. I read <em>The Lion in the Meadow</em>
                    in the School Journal in the late 1960s; my stepdaughter listened to <em>The Boy Who Was Followed Home</em> over
                    and over in the 1970s; my own children sat very still mouthing <em>The Great White Man-Eating Shark</em> in the
                    80s and 90s; now in the 21st century, my grandchildren have heard <em>Down the Dragon&apos;s Tongue</em>,
                    <em>A Summery Saturday Morning</em> and <em>Dashing D</em> many times.
                  </p>
                  <p>
                    <span className="label">F</span> Of course, readers are important to any working writer, but Mahy&apos;s espousal of
                    the act of reading goes beyond that: a book is not properly finished, she has often said, until it has been
                    read, because a reader brings something important to the book. So, doubtless out of need to build a market –
                    she&apos;s not ignorant of her popularity – but also out of genuine care for that other dynamic part of the
                    author-reader relationship, Mahy has, until recently, kept up a punishing schedule of public appearances.
                  </p>
                  <p>
                    <span className="label">G</span> Private conversation with Mahy has always been a wild ride – marvellous, in the
                    true sense of the word, the product of a hungry head and an infinite capacity to be astonished. She races away
                    at one stage to consult an encyclopaedia for L M Montgomery&apos;s date of death, and speculates about the &apos;real&apos;
                    Montgomery, creator of the ever-popular <em>Anne of Green Gables</em>. Although I&apos;d come to talk about her new
                    book, I couldn&apos;t help but be captivated by her infectious curiosity.
                  </p>
                  <p>
                    <span className="label">H</span> A few years ago, the writer David Hill told a funny story. Though his writing
                    was, he conceded, very different from Mahy&apos;s, he had been affected by her peculiarly alert way of looking at
                    the world, particularly the mad, slippery life of language. Once, Hill said, in a motel room, a sign on a door
                    caught his eye: &apos;This door is alarmed.&apos; Mahy would like that, thought Hill. She would enjoy the comedy just
                    below the surface of the formal warning; she would leap immediately to the possibilities for story and
                    language play: &apos;Yes, and this window is concerned, this light fitting is irritated.&apos; His story was a
                    wonderful comment on Mahy&apos;s vision.
                  </p>
                </div>
              ) : (
          ...
          <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
            ...
            >
              <div className="question-group">
                <div className="question-group-title">Questions 27–31</div>
                <p>
                ...
                <div className="question question--plain">
                  <div className="question-text">27. Mahy and Knox have sometimes criticised each other&apos;s work.</div>
                  {renderRadioGroup("q27", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. Mahy explores the traditional themes of New Zealand literature.</div>
                  {renderRadioGroup("q28", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. Mahy&apos;s children&apos;s books have been more popular than her teenage books.</div>
                  {renderRadioGroup("q29", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. Mahy is welcoming to interviewers.</div>
                  {renderRadioGroup("q30", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">31. Mahy is at ease speaking about her experiences.</div>
                  {renderRadioGroup("q31", ynOptions, false)}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title"><strong>Questions 32–35</strong></div>
                <p>
                ...
                <p>
                  <strong>Theories about Mahy&apos;s style</strong>
                </p>

                <p className="parncutt-summary">
                  <span className="summary-line">
                    Mahy&apos;s determination to earn a living from writing has encouraged her to find the ideas for her work in{" "}
                    <span className="question-text">32</span>
                    {renderDropdown("q32", summaryWordOptions, "summary-dropdown")} places.
                  </span>
                  <span className="summary-line">
                    The stories themselves are set in locations that are <span className="question-text">33</span>
                    {renderDropdown("q33", summaryWordOptions, "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    In terms of characterisation, almost all of her books feature unruly people, and very often an adolescent
                    who possesses <span className="question-text">34</span>
                    {renderDropdown("q34", summaryWordOptions, "summary-dropdown")} abilities.
                  </span>
                  <span className="summary-line">
                    Finally, the endings of the stories tend to be <span className="question-text">35</span>
                    {renderDropdown("q35", summaryWordOptions, "summary-dropdown")}.
                  </span>
                </p>
                ...
                <p className="list-of-words">
                  ...
                  <span className="word-row">
                    <strong>A</strong>. disruptive and unpredictable
                  </span>
                  <span className="word-row">
                    <strong>B</strong>. everyday
                  </span>
                  <span className="word-row">
                    <strong>C</strong>. loveable
                  </span>
                  <span className="word-row">
                    <strong>D</strong>. controversial
                  </span>
                  <span className="word-row">
                    <strong>E</strong>. exotic and ordinary
                  </span>
                  <span className="word-row">
                    <strong>F</strong>. unsatisfying but surprising
                  </span>
                  <span className="word-row">
                    <strong>G</strong>. unconfident
                  </span>
                  <span className="word-row">
                    <strong>H</strong>. unsurprising but satisfying
                  </span>
                  <span className="word-row">
                    <strong>I</strong>. magical
                  </span>
                </p>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <div className="question question--plain">
                  <div className="question-text">36. What does the writer say about <em>The Magician of Hoad</em>?</div>
                  {renderRadioGroup("q36", q36Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">37. According to the writer, <em>Bubble Trouble</em></div>
                  {renderRadioGroup("q37", q37Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">38. The writer&apos;s purpose in the fifth paragraph is to</div>
                  {renderRadioGroup("q38", q38Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">39. According to the sixth paragraph, which of the following is true?</div>
                  {renderRadioGroup("q39", q39Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">40. What is the writer doing in the final paragraph?</div>
                  {renderRadioGroup("q40", q40Options, true)}
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={{ height: 2, backgroundColor: "var(--border)", marginLeft: -20, marginRight: -20, marginTop: 1, marginBottom: 2 }} />
              ...
              <div className="support-card">
                ...
                <div className="support-card-name">
                  ...
                  <div className="support-card-actions">
                    ...
                    <button type="button" className="support-copy-btn" onClick={() => copySupportCard("visa", "4023 0601 0538 4175")}>
              ...
              <div className="support-card">
                ...
                <div className="support-card-name">
                  ...
                  <div className="support-card-actions">
                    ...
                    <button type="button" className="support-copy-btn" onClick={() => copySupportCard("uzcard", "8600 1402 8071 0535")}>
