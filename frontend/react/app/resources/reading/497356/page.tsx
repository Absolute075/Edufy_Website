...
export default function Reading497356Page() {
  ...
  const q27Options = [
    { value: "A", text: "The air condition in New Zealand will maintain a high quality because of the ocean" },
    { value: "B", text: "The Southern Ocean will remain at a constant strength" },
    { value: "C", text: "The continents will warm more than the point" },
    { value: "D", text: "New Zealand will not warm as much as other countries in the next century because it is surrounded by sea." },
  ];

  const q28Options = [
    { value: "A", text: "Temperature changes of 1°C will not be seem important in future" },
    { value: "B", text: "Variable weather will continue, unchanged by global warming" },
    { value: "C", text: "There was an unusually small amount of variation in 2006-2007" },
    { value: "D", text: "Summer temperatures will vary but winter ones will be consistent" },
  ];

  const q29Options = [
    { value: "A", text: "New Zealand will be more affected by floods and droughts" },
    { value: "B", text: "Antarctica will not be adversely affected by warming." },
    { value: "C", text: "The band of west winds will move further to the south." },
    { value: "D", text: "The usual west wind will no longer be reliable" },
  ];

  const q30Options = [
    { value: "A", text: "The droughts will be shorter but more severe" },
    { value: "B", text: "How the growing season will become longer." },
    { value: "C", text: "How growing conditions will deteriorate" },
    { value: "D", text: "That farmers should alter the make-up of soils" },
  ];

  const q31Options = [
    { value: "A", text: "Skiing may move to lower the altitude in future." },
    { value: "B", text: "The ski season will be later in the year than at present." },
    { value: "C", text: "The northern ski field will have to move to the south" },
    { value: "D", text: "Warming may provide more snow for some ski locations" },
  ];

  const q32Options = [
    { value: "A", text: "how a particular place could be affected by warming" },
    { value: "B", text: "that the warming trend has been intensifying since 1978" },
    { value: "C", text: "that freezing levels will rise throughout the century" },
    { value: "D", text: "how the growth of glaciers is likely to cause damage" },
  ];
  ...
  const summaryWordOptions = [
    { value: "A", label: "A. agriculture production" },
    { value: "B", label: "B. tropical waters" },
    { value: "C", label: "C. tidal waves" },
    { value: "D", label: "D. polar regions" },
    { value: "E", label: "E. global warming" },
    { value: "F", label: "F. coastal land" },
    { value: "G", label: "G. high tides" },
  ];
  ...
  return (
    <div>
      <Head>
        ...
        <title>Reading Passage 3 – Global Warming in New Zealand</title>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .rounded-dropdown.summary-dropdown .rounded-dropdown-trigger {
          padding: 7px 10px;
          border-radius: 12px;
          font-size: 12px;
          line-height: 1.2;
        ...
        .parncutt-summary .summary-line {
          margin-bottom: 8px;
        }

        .parncutt-summary .summary-line:last-child {
          margin-bottom: 0;
        }
      ...
      >
        ...
        >
          <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
            ...
            >
              <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>Global Warming in New Zealand</h3>

              {passageHtml === null ? (
                <div id="passage2" ref={passageRef}>
                  <p>
                    <span className="label">A</span> New Zealand is expected to warm by about 3°C over the next century. The
                    northern polar regions will be more than 6°C warmer, while the large continents – also the
                    largest centres of population – will be 4°C or warmer. In contrast, the Southern Ocean, which
                    surrounds New Zealand, may warm by only 2°C. The sea will act as an air conditioner and in this
                    aspect, New Zealand’s location is comparatively fortunate.
                  </p>
                  <p>
                    <span className="label">B</span> Any predictions are complicated by the variability of New Zealand’s climate.
                    The annual temperature can fluctuate as much as 1°C above or below the long-term average. The
                    early summer of 2006-7, for instance, was notably cool, thanks in part to the iceberg that
                    drifted up the east coast. A few months later, warm water from the Tasman Sea helped make May
                  ...
                  <p>
                    <span className="label">C</span> The ocean to the south of New Zealand will have one important effect. As the
                    world warms, the great bank of west winds that circle Antarctica will become stronger. This has
                    already been observed, and its impact on New Zealand is likely to be profound: stronger, more
                    frequent west winds will bring increased, sometimes catastrophic rainfall to the west coast of
                    the country and create drier conditions in some eastern regions that are already drought-prone.
                    At the same time, the general warming will spread south.
                  </p>
                  <p>
                    <span className="label">D</span> Furthermore, in the drier regions, the average moisture deficit – that is, the
                    difference between the amount of water in soils available to plants and the amount plants need
                    for optimum growth – will increase. Soils could go into moisture deficit earlier in the growing
                    season and the deficits could last longer into autumn than at present. What we think of today as
                    a medium-severity drought could be an almost annual occurrence by the end of the century. One
                    direct consequence of warmer – and shorter – winters will be a reduction in snow cover. The
                    permanent snow line in the mountains will rise, while snow cover below this will be
                    shorter-lived. The amount of snow that falls may actually increase, however, even in some
                    northern centres, owing to the intensification of precipitation. Ski-field base stations may
                  ...
                  <p>
                    <span className="label">E</span> There will also be a marked impact on New Zealand’s glaciers. Over the last
                    100 years, the glaciers have been reduced by 35%, although since 1978 increased snowfall has
                    offset the effect of warming. The latest studies conducted by the National Institute for Water
                    and Atmospheric Research (NIWA), however, suggest that by the end of the century, warming over
                    the Southern Alps could be significantly greater than over the rest of the country.
                  </p>
                  <p>
                    <span className="label">F</span> Sea levels around New Zealand have risen by 25cm since the middle of the 19th
                    century and by 7cm since 1990. Predictions for the coming years cover a wide range, however,
                    partly because of unknown rises resulting from the melting of the ice in the Arctic, Greenland
                    and Antarctica. In addition, sea level at any given time is affected by many different factors,
                    one of which is called storm surge. When a storm coincides with a high tide along low-lying
                    coastal areas, this bulge raises the tide higher than normal, creating a surge not unlike a
                    slow-motion tsunami. Not only does a rise in sea level increase the potential for this sort of
                    damage, but it also has less immediate impacts. One potentially grave outcome is that
                  ...
                  <p>
                    <span className="label">G</span> The impacts these changes will have on New Zealand are difficult to
                    generalize. Human systems are better able to adapt to change than natural ecosystems because
                    humans can see a problem coming and plan a response. Farmers and horticulturalists have made
                  ...
                  <p>
                    <span className="label">H</span> For natural ecosystems the rate of change is crucial. If it is low, the plants
                    and animals and fish will be able to ‘keep up’; if it is high, only the most adaptable species –
                    those that can survive in the widest range of ecological niches – are likely to survive. Species
                    adapted to only a narrow range of conditions or food sources will find adaptation much more
                    difficult. Take tuatara, for instance. Their sex is determined by the temperature at which the
                    eggs are incubated: in warm conditions (currently above 22°C), they become predominately male –
                    and now males already outnumber females by nearly two to one in some island refuges. In the
                    mountains, as the permanent snow line moves upwards, the tolerance zones of some alpine plants
                    and animals may simply disappear. It should also be remembered that global warming is just that
                    – a global phenomenon. New Zealand’s own greenhouse emissions are tiny – around 0.5% of the
                    global total. Even if New Zealanders were to achieve the government’s target of carbon
                    neutrality, this would have no discernible impact on global climate change.
                  </p>
                  <p>
                    <span className="label">I</span> The changes that global warming is going to bring to New Zealand during the
                    21st century are going to be significant, but where the country is likely to be most vulnerable
                    is with respect to climate change elsewhere. New Zealand may warm more slowly than most places,
                    but if its major export markets undergo damaging change, the economic impact will be severe.
                  </p>
                </div>
              ) : (
          ...
          <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "baseline" }}>
                <div style={{ fontWeight: 900, fontSize: 16 }}>Questions 27-40</div>
              ...
              <div className="question-group">
                <div className="question-group-title">Questions 27-32</div>
                <p>
                ...
                <div className="question question--plain">
                  <div className="question-text">27. What is the main idea of the first paragraph?</div>
                  {renderRadioGroup("q27", q27Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. What does the writer say about New Zealand’s variable weather?</div>
                  {renderRadioGroup("q28", q28Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. What is the predicted impact of conditions in the ocean to the south of New Zealand?</div>
                  {renderRadioGroup("q29", q29Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. The writer mentions ‘moisture deficit’ to show?</div>
                  {renderRadioGroup("q30", q30Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">31. What are the implications of global warming for New Zealand’s ski fields?</div>
                  {renderRadioGroup("q31", q31Options, true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">32. The writer refers to NIWA’s latest studies in the third paragraph to show</div>
                  {renderRadioGroup("q32", q32Options, true)}
                </div>
              </div>

              <div className="question-group" style={{ marginTop: 16 }}>
                <div className="question-group-title">Questions 33-35</div>
                <p>
                  Complete the summary below.
                  <br />
                  Choose a letter from the box below for each answer.
                  <br />
                ...
                <p className="parncutt-summary">
                  <span className="summary-line">
                    ...
                    <span className="question-text">33</span>{" "}
                  ...
                  <span className="summary-line">
                    ...
                    <span className="question-text">34</span>{" "}
                    {renderDropdown("q34", summaryWordOptions, "summary-dropdown")} and result in changes to the shape of{" "}
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  <strong>NO</strong> if the statement is false
                  <br />
                  <strong>NOT GIVEN</strong> if the information is not given in the passage
                </p>

                <div className="question question--plain">
                  <div className="question-text">36. The natural world is less responsive to challenges than humans.</div>
                  {renderRadioGroup("q36", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">37. The agricultural sector is being too conservative and resistant to innovation.</div>
                  {renderRadioGroup("q37", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">38. The global warming is slow; it will affect different regions in different ways.</div>
                  {renderRadioGroup("q38", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">39. The tuatara is vulnerable to changes in climate conditions.</div>
                  {renderRadioGroup("q39", ynOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">40. New Zealand must reduce carbon emission if global warming is to be slowed.</div>
