...
export default function Reading146963Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – Native Species That Become Pests</title>
         <link
           rel="stylesheet"
             ...
             >
               <div className="question-group">
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>Native species on the move</strong>
                   </span>
                   <span className="summary-line">
                     <strong>Mud snails in Western Australia</strong>
                   </span>
                   <span className="summary-line">
                     Mud snails: an Australian native species originally from the {renderTextInput("q1", "1")} part of the country
                   </span>
                   <span className="summary-line">Snails contribute to the problem of seaweed replacing healthy vegetation</span>
                   <span className="summary-line">
                     Seaweed comes out of the {renderTextInput("q2", "2")} of snails
                   </span>
                   <span className="summary-line">
                     Snail waste acts as a {renderTextInput("q3", "3")} and this makes the seaweed problem worse
                   </span>
                   <span className="summary-line">
                     <strong>Examples of unintentional movement of species</strong>
                   </span>
                   <span className="summary-line">
                     Queensland frogs are transported south along with {renderTextInput("q4", "4")}
                   </span>
                   <span className="summary-line">
                     Spiders are often carried in materials for {renderTextInput("q5", "5")}
                   </span>
                   <span className="summary-line">
                     {renderTextInput("q6", "6")} are carried when transporting livestock to the coast
                   </span>
                   <span className="summary-line">
                     <strong>Examples of species moving when the landscape changes</strong>
                   </span>
                   <span className="summary-line">
                     When {renderTextInput("q7", "7")} are built, waterbirds move to the area
                   </span>
                 </p>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">8. Redback spiders avoid places where there are people.</div>
                   {renderRadioGroup("q8", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">9. According to current theories, redback spiders originally came to Australia from another country.</div>
                   {renderRadioGroup("q9", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">10. In Perth, the ancestors of the rainbow lorikeets were originally domesticated animals.</div>
                   {renderRadioGroup("q10", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">11. Bats are a threat to some native Australian bird species.</div>
                   {renderRadioGroup("q11", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">12. White terns moved to Lord Howe Island to raise their young.</div>
                   {renderRadioGroup("q12", tfngOptions, false)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">13. There were more fruit flies in Western Australia than in Queensland in 1989.</div>
