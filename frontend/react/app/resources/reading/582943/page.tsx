...
export default function Reading582943Page() {
  ...
  const expertOptions = [
    { value: "A", label: "A. Rob Wood" },
    { value: "B", label: "B. Nigel Rodgers" },
    { value: "C", label: "C. Adrian North" },
    { value: "D", label: "D. Rhonda Hadi" },
    { value: "E", label: "E. Richard Hampson" },
  ];
  ...
  const copySupportCard = async (key: "visa" | "uzcard", rawNumber: string) => {
   ...
   const dropdownLabel = (key: QuestionKey, value: string) => {
     ...
     if (key === "q14" || key === "q15" || key === "q16" || key === "q17" || key === "q18") {
       return headingOptions.find((o) => o.value === value)?.label ?? value;
     }
     if (key === "q19" || key === "q20" || key === "q21" || key === "q22" || key === "q23") {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – The Growing Industry of Background Music</title>
         <link
           rel="stylesheet"
             ...
             >
               ...
               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <span className="label">A</span> Music can be surprisingly powerful, even when it is played in the background
                     and is barely noticeable. Over recent decades, creating background music has become a booming
                     industry. Researchers have found that music played in commercial settings can have an impact on
                     how much time we think has passed while waiting in a queue, how engaged customers are with sales
                     staff, and even how sweet or bitter food tastes.
                   </p>
                   <p>
                     <span className="label">B</span> Rob Wood is the founder of Music Concierge in the UK, a company that chooses
                     background music for businesses. Some clients hire Wood because they want to influence behavior,
                     others seek to create a certain atmosphere, culture or confidence. The core of a music
                     consultant's work is creating distinct, coherent musical features for brands. In 2018, Wood
                     worked on music for a new hotel. His brief was to produce distinct playlists for separate areas:
                     the lobby, the restaurant and the gym. The hotel manager explained every detail: the build
                     materials, the history, and a prediction of the average restaurant bill. Much of Wood's job
                     involves taking abstract suggestions and turning them into music. A large amount of intuition is
                     also required. It is a complex process and part of his job is comprehending what businesses
                     really want, which can be very demanding.
                   </p>
                   <p>
                     <span className="label">C</span> In the 1920s, George Owen Squier, a former US army officer, developed a new
                     way to transmit audio through wires. His idea led to the creation of Wired Music (renamed
                     Muzak), which enabled businesses to play music throughout offices and commercial premises. In
                     its early days, Muzak sold itself on the basis that its music would enhance job performance. Its
                     program for offices and factories played classical recordings in 15-minute sequences, alternated
                     with silence. Each time the music sequence resumed, it rose in intensity. Muzak set the template
                     for background music that would persist for decades.
                   </p>
                   <p>
                     <span className="label">D</span> Despite technological advances, it's the influence that background music has
                     on customer behavior which is driving its growth. Psychologists believe that music influences
                     consumers in two main ways. The first is physical; numerous studies have confirmed that we often
                     subconsciously match what we are doing to what we hear. For instance, one study found that
                     diners ate faster when higher-tempo music was played. The second approach focuses on the
                     associations that music can trigger. Another study revealed that diners in a cafeteria were
                     willing to pay more money when classical music was played in the background than when there was
                     none at all.
                   </p>
                   <p>
                     <span className="label">E</span> However, it is the inoffensive nature of this kind of background music that
                     creates some of the industry's fiercest critics. A UK group, Pipedown, founded by Nigel Rodgers,
                     campaigns 'for freedom from unwanted music in public places'. The group claims that such music
                     is impossible to escape and adds to the overall levels of noise pollution in public. "You're not
                     going for a special sort of atmosphere, you're just going to do your shopping," Rodgers said.
                     One example of their boldest claims is that there is no genuine evidence that background music
                     increases sales.
                   </p>
                   <p>
                     <span className="label">F</span> Companies have capitalized on the sweeping changes to the world of retail in
                     recent years. Many businesses are no longer just functional places to buy things, they are
                     presented as an experience. Since 2008, streaming music via the internet has become the way most
                     people listen to music. For background music companies, streaming is both a threat and an
                     opportunity. On one hand, companies can select and tailor the music they deliver to businesses
                     with greater speed, flexibility and precision than ever before. On the other hand, access to
                     vast music libraries has made everyone a music specialist. However, Richard Hampson at
                     Imagesound believes a real-life curator is indispensable.
                   </p>
                 </div>
               ) : (
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               <div className="question-group">
                 ...
                 <p>
                   Which paragraph (<strong>A-F</strong>) contains the following information?
                   <br />
                   Write the correct letter, <strong>A-F</strong>, in boxes <strong>14–18</strong> on your answer sheet.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">14. Details of how modern developments have created positive and negative consequences for the industry</div>
                   {renderDropdown("q14", headingOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">15. An account of opposition to the use of background music</div>
                   {renderDropdown("q15", headingOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">16. A comparison of customer spending patterns with and without background music</div>
                   {renderDropdown("q16", headingOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">17. A mention of how background music can make shoppers more responsive to shop assistants</div>
                   {renderDropdown("q17", headingOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">18. Details of a project which required different music in various parts of a building</div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Match each statement with the correct expert, <strong>A-E</strong>.
                   <br />
                   Write the correct letter, <strong>A-E</strong>, in boxes <strong>19–23</strong> on your answer sheet.
                 </p>

                 <p className="list-of-words">
                   <strong>List of Experts</strong>
                   <span className="word-row">A. Rob Wood</span>
                   <span className="word-row">B. Nigel Rodgers</span>
                   <span className="word-row">C. Adrian North</span>
                   <span className="word-row">D. Rhonda Hadi</span>
                   <span className="word-row">E. Richard Hampson</span>
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">19. It is difficult to understand a client's specific wish.</div>
                   {renderDropdown("q19", expertOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">20. Background music is especially beneficial to the tourism industry.</div>
                   {renderDropdown("q20", expertOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">21. Background music has more effect on people who are spending less.</div>
                   {renderDropdown("q21", expertOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">22. A creative music expert is crucial for businesses choosing background music.</div>
                   {renderDropdown("q22", expertOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">23. Buying goods does not require a particular environment.</div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Write your answers in boxes <strong>24–26</strong> on your answer sheet.
                 </p>

                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>The history of background music</strong>
                   </span>
                   <span className="summary-line">
                     In 1920, George Squier developed a way of transmitting music using a system of wires. His company claimed that
                     {renderTextInput("q24", "24")} at work could be improved with the use of its audio programs.
                   </span>
                   <span className="summary-line">
                     However, in this audio format there was silence between each short musical section. Gradually, the
                     {renderTextInput("q25", "25")} of the music increased.
                   </span>
                   <span className="summary-line">
                     Muzak became the template for music in businesses for years to come. Different ways existed however; some companies delivered
                     pre-recorded music in the form of a cartridge. Later, in the 1970s, tapes were used, but the real change came with the move to CDs.
                     With these, background music specialists were able to arrange music selections into
                     {renderTextInput("q26", "26")} on a computer.
                   </span>
                 </p>
               </div>
             </div>
