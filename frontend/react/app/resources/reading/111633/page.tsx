...
export default function Reading111633Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – Insect-inspired robots</title>
         <link
           rel="stylesheet"
       ...
       <style jsx global>{`
         ...
         .rounded-dropdown.dropup .rounded-dropdown-menu {
           top: auto;
           bottom: calc(100% + 6px);
           transform: translateY(6px);
         }
         ...
         .rounded-dropdown.dropup .rounded-dropdown-menu.is-open {
           transform: translateY(0);
         }
            ...
            >
              <div className="question-group">
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter, A-F, in boxes <strong>27-32</strong> on your answer sheet.
                </p>

                {([
                  { q: "q27", text: "27. positive and negative possibilities for the use of insect-inspired robots" },
                  { q: "q28", text: "28. how perceived size is used as an aid to navigation" },
                  { q: "q29", text: "29. an example of decision-making taking place in the limbs" },
                  { q: "q30", text: "30. a description of a potential aid in space exploration" },
                  { q: "q31", text: "31. the range of skills that have inspired biorobotics" },
                  { q: "q32", text: "32. how a variety of navigational methods operate at the same time" },
                ] as Array<{ q: QuestionKey; text: string }>).map((item) => (
                  <div key={item.q} className="question question--plain">
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write your answers in boxes <strong>33-36</strong> on your answer sheet.
                </p>

                <div style={{ lineHeight: 2.0 }}>
                  <p className="summary-inline">
                    33. Which creature sees particularly well under water? {renderTextInput("q33", "33")}
                  </p>
                  <p className="summary-inline">
                    34. In addition to a computer, what technical equipment is fitted in Dr Zelinsky's robot? {renderTextInput("q34", "34")}
                  </p>
                  <p className="summary-inline">
                    35. Where is the Cataglyphis ant found? {renderTextInput("q35", "35")}
                  </p>
                  <p className="summary-inline">
                    36. What atmospheric effect helps the Cataglyphis ant to know its direction? {renderTextInput("q36", "36")}
                  </p>
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write the correct letter, A-G, in boxes <strong>37-40</strong> on your answer sheet.
                </p>

                <p style={{ marginTop: 10 }}>
                  <strong>List of robots</strong>
                  <br />
                  A. a robot that can be used to investigate the surface of Mars
                  <br />
                  B. a robot that is able to learn from experience
                  <br />
                  C. a robot that can move across difficult terrain
                  <br />
                  D. a robot that is programmed to react to its surroundings
                  <br />
                  E. a robot that is controlled by a separate computer
                  <br />
                ...
                {([
                  { q: "q37", text: "37. Dr Alex Zelinsky" },
                  { q: "q38", text: "38. Professor Ruediger Wehner" },
                  { q: "q39", text: "39. Professor Robert Michelson" },
                  { q: "q40", text: "40. Roger Quinn and Professor Roy Ritzmann" },
                ] as Array<{ q: QuestionKey; text: string }>).map((item) => (
                  <div key={item.q} className="question question--plain">
                    <div className="question-text">{item.text}</div>
                    {renderDropdown(
