...
export default function Reading999888Page() {
  ...
  const isTextAnswerKey = (key: QuestionKey) => key === "q19" || key === "q20" || key === "q21" || key === "q22";
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 2 – Wetlands</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>The global importance of wetlands</h3>

               {passageHtml === null ? (
                 <div id="passage2" ref={passageRef}>
                   <p>
                     <strong>A</strong> Wetlands are areas where water covers the soil, or is present either at or near the surface of the soil, for all or part of the year. These are complex ecosystems, rich in unique plant and animal life. But according to the World Wide Fund for Nature (WWF), half of the world’s wetlands have disappeared since 1900 – converted or destroyed by commercial development, drainage schemes, and the extraction of minerals and peat. Many of those that remain have been damaged by agricultural pesticides and fertilisers, industrial pollutants, and construction works.
                   </p>
                   <p>
                     <strong>B</strong> Throughout history, humans have gathered around wetlands, and their fertile ecosystems have played an important part in human development. Consequently, they are of considerable religious, historical, and archaeological value to many communities around the world. Wetlands directly support the livelihoods and well-being of millions of people, says Dr Matthew McCartney, principal researcher and hydrologist at the International Water Management Institute (IWMI). In many developing countries, large numbers of people are dependent on wetland agriculture for their livelihoods.
                   </p>
                   <p>
                     <strong>C</strong> They also serve a crucial environmental purpose. Wetlands are one of the key tools in mitigating climate change across the planet, says Pieter van Eijk, head of Climate Adaptation at Wetlands International (WI), pointing to their use as buffers that protect coastal areas from sea-level rise and extreme weather events such as hurricanes and flooding. Wetland coastal forests provide food and water, as well as shelter from storms, and WI and other agencies are working to restore these forests which have been lost. It can be as simple as planting a few trees per acre to create shade and substantially change a microclimate, he says. Implementing climate change projects isn’t so much about money.
                   </p>
                   <p>
                     <strong>D</strong> The world’s wetlands are, unfortunately, rich sources for in-demand commodities, such as palm oil and pulpwood. Peatlands – wetlands with a waterlogged organic soil layer – are particularly targeted. When wetlands are drained for cultivation, they become red carbon centers instead of active carbon stores, and, according to Marcel Silvius, head of Climate-smart Land-use at WI, this practice causes six percent of all global carbon emissions. The clearance of peatlands for planting also increases the risk of forest fires, which release huge amounts of CO2. We’re seeing huge peatland forests with extremely high biodiversity value being lost for a few decades of oil palm revenues, says Silvius.
                   </p>
                   <p>
                     <strong>E</strong> The damage starts when logging companies arrive to clear the trees. They dig ditches to enter the peat swamps by boat and then float the logs out the same way. These ditches are then used to drain water out of the peatlands to allow for the planting of crops like cotton, oil palms, or pulpwood trees. Once the water has drained away, bacteria and fungi break down the carbon in the peat and turn it into CO2 and methane.
                   </p>
                   <p>
                     <strong>F</strong> Meanwhile, the remainder of the solid matter in the peat starts to move downwards, in a process known as subsidence. Peat comprises 90 per cent water, so this is one of the most alarming consequences of peatland clearances. In the tropics, peat subsides at about four centimeters a year, so within half a century, very large landscapes on Sumatra and Borneo will become flooded as the peat drops below water level, says Silvius. It’s a huge catastrophe that’s in preparation. Some provinces will lose 40 per cent of their landmass.
                   </p>
                   <p>
                     <strong>G</strong> And while these industries affect wetlands in ways that can easily be documented, Dr Dave Tickner of the WWF believes that more subtle impacts can be even more devastating. Sediment run-off and fertiliser can be pretty invisible, says Tickner. Over-extraction of water is equally invisible. You do get shock stories about rivers running red, or even catching fire, but there’s enough chronic impact that really hurts a wetland. He does not blame anyone for deliberate damage, however. I’ve worked on wetland issues for 20 years and have never met anybody who wanted to damage wetlands, he says. It isn’t something that people generally set out to do. Quite often, the effects simply come from people trying to make a living.
                   </p>
                   <p>
                     <strong>H</strong> Silvius also acknowledges the importance of income generation. It’s not that we just want to restore the biodiversity of wetlands – which we do – but we recognise there’s a need to provide an income for local people. This approach is supported by IWMI. The idea is that people in a developing country will only protect wetlands if they value and profit from them, says McCartney. For sustainability, it’s essential that local people are involved in wetland planning and decision making and have clear rights to use wetlands.
                   </p>
                 </div>
               ) : (
             ...
             >
               ...
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">14. The role of wetlands in preventing natural disasters</div>
                   {renderLetterDropdown("q14")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">15. Reference to the need to ensure that inhabitants of wetland regions continue to benefit from them</div>
                   {renderLetterDropdown("q15")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">16. The proportion of wetlands which have already been lost</div>
                   {renderLetterDropdown("q16")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">17. Reference to the idea that people are beginning to appreciate the value of wetlands</div>
                   {renderLetterDropdown("q17")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">18. Mention of the cultural significance of wetlands</div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">19. Peatlands which have been drained begin to release {renderTextInput("q19")} instead of storing it.</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">20. Once peatland areas have been cleared, {renderTextInput("q20")} are more likely to occur.</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">21. Clearing peatland forests to make way for oil palm plantations destroys the {renderTextInput("q21")} of the local environment.</div>
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">22. Water is drained out of peatlands through the {renderTextInput("q22")} which are created by logging companies.</div>
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   ...
                   <br />
                   Write the correct letter, <strong>A–D</strong>, in boxes <strong>23–26</strong> on your answer sheet.
                 </p>

                 <div className="question question--plain">
                   <div className="question-text">23. Communities living in wetland regions must be included in discussions about the future of these areas.</div>
                   {renderLetterDropdown("q23", abcdOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">24. Official policies towards wetlands vary from one nation to the next.</div>
                   {renderLetterDropdown("q24", abcdOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">25. In a few decades’ time, substantial areas of land will have disappeared into the sea.</div>
                   {renderLetterDropdown("q25", abcdOptions)}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">26. Many of the practices which damage wetlands are almost impossible to see.</div>
                   {renderLetterDropdown("q26", abcdOptions)}
                 </div>
