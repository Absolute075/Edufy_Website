...
export default function Reading369258Page() {
  ...
  useEffect(() => {
   ...
   const dropdownOptions = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"] as const;
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – The Peopling of Patagonia</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>The Peopling of Patagonia</h3>
           ...
           <div className="questions-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }} id="questions">
             ...
             >
               ...
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     ...
                     <br />
                     <strong>A</strong> <span style={{ fontWeight: 400 }}>It started earlier than previously thought.</span>
                     <br />
                     <strong>B</strong> <span style={{ fontWeight: 400 }}>Historians have overlooked its importance.</span>
                     <br />
                     <strong>C</strong> <span style={{ fontWeight: 400 }}>It impacts on research into the wider region.</span>
                     <br />
                     <strong>D</strong> <span style={{ fontWeight: 400 }}>Researchers have calculated its effects on the environment.</span>
                   </div>
                   {renderAbcdRadio("q27")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     ...
                     <br />
                     <strong>A</strong> <span style={{ fontWeight: 400 }}>to challenge previous research</span>
                     <br />
                     <strong>B</strong> <span style={{ fontWeight: 400 }}>to propose new areas to investigate</span>
                     <br />
                     <strong>C</strong> <span style={{ fontWeight: 400 }}>to summarise a scholarly debate</span>
                     <br />
                     <strong>D</strong> <span style={{ fontWeight: 400 }}>to suggest reasons for human migration</span>
                   </div>
                   {renderAbcdRadio("q28")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     29. The writer refers to the Tate’s model in order to …
                     <br />
                     <strong>A</strong> <span style={{ fontWeight: 400 }}>compare it with another theory of migration.</span>
                     <br />
                     <strong>B</strong> <span style={{ fontWeight: 400 }}>evaluate the success of American migration.</span>
                     <br />
                     <strong>C</strong> <span style={{ fontWeight: 400 }}>criticize the speed of research into migration</span>
                     <br />
                     <strong>D</strong> <span style={{ fontWeight: 400 }}>compare migration in different parts of the world.</span>
                   </div>
                   {renderAbcdRadio("q29")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     30. What does the writer suggest about the Monte Verde site?
                     <br />
                     <strong>A</strong> <span style={{ fontWeight: 400 }}>It is much younger than researchers once estimated</span>
                     <br />
                     <strong>B</strong> <span style={{ fontWeight: 400 }}>It provides supporting evidence for relatively early settlement</span>
                     <br />
                     <strong>C</strong> <span style={{ fontWeight: 400 }}>Archaeologists believe the site is of questionable value</span>
                     <br />
                     <strong>D</strong> <span style={{ fontWeight: 400 }}>Streams exposed the site, making new research possible.</span>
                   </div>
                   {renderAbcdRadio("q30")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">
                     31. What does the writer suggest about the streams near the Monte Verde site?
                     <br />
                     <strong>A</strong> <span style={{ fontWeight: 400 }}>They take a decade to teach.</span>
                     <br />
                     <strong>B</strong> <span style={{ fontWeight: 400 }}>They prevented migration in early times.</span>
                     <br />
                     <strong>C</strong> <span style={{ fontWeight: 400 }}>They have aroused the suspicions of some agencies.</span>
                     <br />
                     <strong>D</strong> <span style={{ fontWeight: 400 }}>They can be used by a limited range of occupations.</span>
                   </div>
                   {renderAbcdRadio("q31")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">32. The conditions encountered by the first migrants to Patagonia were unique.</div>
                   {renderTfngRadio("q32")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">33. In the high country the first migrants hunted wild animals for food.</div>
                   {renderTfngRadio("q33")}
                 </div>
                 ...
                 <div className="question question--plain">
                   <div className="question-text">35. Archaeological evidence can be moved from place to place in a variety of ways.</div>
                   {renderTfngRadio("q35")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p>
                   Complete the summary using the list of words and phrases, <strong>A-J</strong>, below.
                   <br />
                   Write the correct letter, <strong>A-J</strong>, in boxes 36-40 on your answer sheet.
                 </p>

                 <div className="question">
                   <div className="question-text">
                     <p style={{ margin: 0 }}>
                       <strong>The archaeological evidence from Patagonia</strong>
                     </p>
                   </div>
                   <div style={{ lineHeight: 1.8, color: "var(--text-soft)" }}>
                     <p style={{ marginTop: 0 }}>
                       Building remains and other evidence have been found in 36{renderLetterDropdown("q36")} at the Chinchihuapi Creek site, and because of this it has been possible to date them to around 12,500 years ago. However, the 37{renderLetterDropdown("q37")} of the samples taken from Los Toldos means that this site is of doubtful value. El Ceibo is a more promising dig, where the examination of artefacts would be beneficial in order to confirm the usefulness of discoveries there. The remains found at the Arroyo Feo site show 38{renderLetterDropdown("q38")} and date from around 9,000 years ago. Unfortunately, no 39{renderLetterDropdown("q39")} can be made between the samples taken from Las Buitreras and human presence. The findings of the work carried out at Cueva Fell cannot provide useful information beyond the 40{renderLetterDropdown("q40")}. In conclusion, though the evidence is mixed, it is believed that human population of Patagonia began about 11,000 years ago.
                     </p>
                   </div>
                 </div>
                 ...
                 <p style={{ marginTop: 12 }}>
                   ...
                   <br />
                   <strong>A</strong> Fixed date
                   <br />
                   <strong>B</strong> Random collection
                   <br />
                   <strong>C</strong> Similar properties
                   <br />
                   <strong>D</strong> Good condition
                   <br />
                   <strong>E</strong> Scientific evaluation
                   <br />
                   <strong>F</strong> huge quantities
                   <br />
                   <strong>G</strong> new samples
                   <br />
                   <strong>H</strong> reliable connection
                   <br />
                   <strong>I</strong> skilled preservation
                   <br />
                   <strong>J</strong> immediate surroundings
                 </p>
               </div>
             </div>
           </div>
