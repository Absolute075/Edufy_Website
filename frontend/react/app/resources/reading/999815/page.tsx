...
export default function Reading999815Page() {
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 3 – Robert Louis Stevenson</title>
         <link
           rel="stylesheet"
            ...
            >
              <div className="question-group">
                ...
                <div className="question question--plain">
                  <div className="question-text">27. In the opinion of the writer, the biographers Balfour and Crouch</div>
                  {renderRadioGroup("q27", [{ value: "A", text: "understated the role played by Stevenson's family" }, { value: "B", text: "misunderstood Stevenson's religious beliefs" }, { value: "C", text: "overestimated other writers' influence on Stevenson" }, { value: "D", text: "elevated Stevenson above his true status as a writer" }], true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">28. What point does the writer make about Stevenson in the second paragraph?</div>
                  {renderRadioGroup("q28", [{ value: "A", text: "The public judged him more fairly than the critics." }, { value: "B", text: "Recent criticism of him has been justified." }, { value: "C", text: "Critics argued that his style covered up his faults." }, { value: "D", text: "The ethical nature of his stories was often criticized." }], true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">29. According to the writer, the adventure story</div>
                  {renderRadioGroup("q29", [{ value: "A", text: "is more appropriate for books than films." }, { value: "B", text: "can be used by writers to tell moral stories." }, { value: "C", text: "is more fashionable today than in the past." }, { value: "D", text: "has been used by other writers but not Stevenson." }], true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">30. What point does the writer make about Stevenson and Scotland?</div>
                  {renderRadioGroup("q30", [{ value: "A", text: "His ideas contrasted with those of many Scots." }, { value: "B", text: "He demonstrated great sympathy for Scotland's problems." }, { value: "C", text: "He was not considered a true Scot as he was not born there." }, { value: "D", text: "His unflattering stories about Scotland angered many Scots." }], true)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">31. According to the writer, Stevenson's own lifestyle</div>
                  {renderRadioGroup("q31", [{ value: "A", text: "was envied by his friends." }, { value: "B", text: "was responsible for his early death." }, { value: "C", text: "attracted more attention than his books." }, { value: "D", text: "did not prepare him for living in Samoa." }], true)}
                </div>
              </div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  Choose <strong>YES</strong> if the statement agrees with the claims of the writer,
                  <br />
                  choose <strong>NO</strong> if the statement contradicts the claims of the writer,
                  <br />
                  or choose <strong>NOT GIVEN</strong> if it is impossible to say what the writer thinks about this.
                  <br />
                  Write your answers in boxes <strong>32–35</strong> on your answer sheet.
                </p>

                <div className="question question--plain">
                  <div className="question-text">32. Although Oscar Wilde admired Stevenson's work, he believed Stevenson could have written something better.</div>
                  {renderRadioGroup("q32", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">33. Stevenson encouraged Oscar Wilde to start writing.</div>
                  {renderRadioGroup("q33", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">34. Galsworthy had greater respect for Hardy than Stevenson.</div>
                  {renderRadioGroup("q34", tfngOptions, false)}
                </div>

                <div className="question question--plain">
                  <div className="question-text">35. More research is needed regarding Stevenson's influence on Chesterton.</div>
              ...
              <div className="question-group" style={{ marginTop: 16 }}>
                ...
                <p>
                  ...
                  <br />
                  Write your answers in boxes <strong>36–40</strong> on your answer sheet.
                </p>

                <p className="parncutt-summary">
                  <span className="summary-line"><strong>Robert Louis Stevenson and Sir Walter Scott</strong></span>
                  <span className="summary-line">
                    Opinions differ as to whether Robert Louis Stevenson or Sir Walter Scott should be considered Scotland's best writer. Scott had greater {renderDropdown("q36", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }, { value: "G", label: "G" }, { value: "H", label: "H" }, { value: "I", label: "I" }], "summary-dropdown")} but Stevenson had more {renderDropdown("q37", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }, { value: "G", label: "G" }, { value: "H", label: "H" }, { value: "I", label: "I" }], "summary-dropdown")} and the same distinction can be made between the two composers Shostakovich and Prokofiev.
                  </span>
                  <span className="summary-line">
                    It is true that Scott's books showed more {renderDropdown("q38", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }, { value: "G", label: "G" }, { value: "H", label: "H" }, { value: "I", label: "I" }], "summary-dropdown")} when it came to tragedy though in an old-fashioned way while Stevenson's books are still popular because of his {renderDropdown("q39", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }, { value: "G", label: "G" }, { value: "H", label: "H" }, { value: "I", label: "I" }], "summary-dropdown")}.
                  </span>
                  <span className="summary-line">
                    And Stevenson's understanding of {renderDropdown("q40", [{ value: "A", label: "A" }, { value: "B", label: "B" }, { value: "C", label: "C" }, { value: "D", label: "D" }, { value: "E", label: "E" }, { value: "F", label: "F" }, { value: "G", label: "G" }, { value: "H", label: "H" }, { value: "I", label: "I" }], "summary-dropdown")} has resulted in the widespread use of an expression from one of his books.
                  </span>

                  <span className="summary-line" style={{ marginTop: 10 }}><strong>Word Bank</strong></span>
                  <span className="summary-line">A natural ability</span>
                  <span className="summary-line">B critical acclaim</span>
                  <span className="summary-line">C humour</span>
                  <span className="summary-line">D romance</span>
                  <span className="summary-line">E colorful language</span>
                  <span className="summary-line">F technical control</span>
                  <span className="summary-line">G story telling</span>
                  <span className="summary-line">H depth</span>
                  <span className="summary-line">I human nature</span>
                </p>
              </div>
            </div>
          </div>
