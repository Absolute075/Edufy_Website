...
export default function Reading483129Page() {
  ...
  useEffect(() => {
   ...
   const renderTextInput = (key: QuestionKey) => {
     ...
     const placeholder = num >= 7 && num <= 13 ? String(num) : undefined;
     return (
       <input
         type="text"
   ...
   return (
     <div>
       <Head>
         ...
         <title>Reading Passage 1 – Herding</title>
         <link
           rel="stylesheet"
       ...
       >
         ...
         >
           <div className="passage-col" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
             ...
             >
               <h3 style={{ marginTop: 0, marginBottom: 16, fontSize: 20, fontWeight: 700 }}>Herding</h3>
               ...
               {passageHtml === null ? (
                 <div id="passage1" ref={passageRef}>
                   <p>
                     ...
                     against predators. They move from one fertile grass to another without an organized direction.
                     Herding is the practice of caring for these roaming groups of livestock over a large area.
                     Herding developed about 10,000 years ago, as prehistoric hunters domesticated wild animals such
                     as cows and goats. Hunters learned that by controlling animals they once pursued, they could
                     have reliable sources not only of meat, but also of milk and milk products, as well as animal
                     hides for tents and clothing.
                   </p>
                   <p>
                     There are several different types of herding. One of the most ancient forms is nomadic herding,
                     which involves tribal or extended-family groups moving with their animals from one grazing area
                     to another. Nomads live in arid and semi-arid parts of Africa, Asia and Europe, and in the
                     tundra regions of Asia and Europe, where land is not fertile enough for intensive agricultural
                     farming. In Africa, nomadic tribes herd various animals such as cattle, goats, sheep and camels.
                     The Fulani people of Nigeria are a typical example: their animals are used for producing milk
                     and are rarely slaughtered for meat. In the polar tundra, in the northernmost part of Europe,
                     nomads usually herd domesticated reindeer, horses, musk-oxen and yaks.
                   </p>
                   <p>
                     Nomadic herding is sometimes considered a form of subsistence agriculture. However, unlike
                     subsistence farmers, herders are traditionally wage-earners: they sell their herds’ materials
                     for goods and services, or herd other people’s animals for a fee. Often, this trade is popular
                     among the local economy, not accounted for by the government for a region. In Africa, the United
                     Nations estimates that herders are responsible for more than $100 million in economic activity
                     every year.
                   </p>
                   <p>
                     Nomadic herding as a way of life is declining because of natural disasters, loss of land area due
                     to development, and climate change, as well as pressure from governments to lead a settled
                     existence. Permanent residence allows members of a nomadic community to have access to education
                     and healthcare facilities. However, the complex social structure of herding communities is lost
                     as they are absorbed into mainstream culture. The unique language and customs of nomads become
                     redundant in settled urban or suburban life.
                   </p>
                   <p>
                     ...
                     the Bedouin people of the Arabian Peninsula and the Middle East were mostly nomads, herding sheep
                     and goats. However, recurring drought throughout Western Asia in the 1960s limited fertile areas;
                     plus oil production in Egypt and Saudi Arabia further limited land available for grazing.
                     Bedouins are now almost entirely semi-nomadic or settled.
                   </p>
                   <p>
                     Today, about a quarter of Mongolia’s population continues to live a semi-nomadic herding
                     lifestyle, herding sheep, goats, horses and camels. However, young people have recently been
                     rejecting this way of life and are instead moving to the city in search of an easier life.
                   </p>
                   <p>
                     The Sami are semi-nomadic herders indigenous to the Arctic. They live throughout northern Norway,
                     Sweden, Finland and on the Kola Peninsula of Russia. For centuries, the Sami have herded
                     reindeer as a principal means of livelihood, supplemented by fishing and trapping. Land
                     development has made it difficult for these semi-nomadic herders to sustain their traditional
                     way of life. State and national borders, for example, have divided traditional Sami land. Trees
                     are also being cut down for the timber industry, and mines dug to extract minerals, which is all
                     having a serious impact on grazing land. There are laws to protect the Sami and their grazing
                     rights, but conflicts still exist.
                   </p>
                   <p>
                     Another type of herding in mountainous regions is called transhumance. Transhumance herders
                     follow a seasonal migration pattern, usually to highlands in the summer and lowlands in the
                     winter. Unlike nomads, these herders move their animals between the same areas, and live in
                     fixed settlements.
                   </p>
                   <p>
                     Transhumance has had an enormous impact on the landscape. In the European Alps, for instance,
                     thousands of years of transhumance have transformed forests into grassland. Swiss and German
                     herders traditionally led sheep, cattle and pigs to pastures at elevations above 2,000 meters.
                   </p>
                   <p>
                     Transhumance in the Alps has traditionally involved three herding grounds. The lowest elevation
                     is where livestock are kept sheltered during the cold and snowy winter months. Shepherds lead
                     herds to the middle pastures during the spring. During the summer and fall, shepherds lead sheep
                     and cattle to the highest pastures, while pigs are kept in the middle area. Transhumance is
                     still widely practiced throughout agricultural areas in Switzerland, Germany, Austria, Italy and
                     Slovenia.
                   </p>
                 </div>
               ) : (
             ...
             >
               <div className="question-group">
                 ...
                 <div className="question question--plain">
                   <div className="question-text">1. Animals form herds as a way of defending themselves from being attacked.</div>
                   {renderTfngRadio("q1")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">2. Land used by nomadic herders is also suitable for producing a large amount of crops.</div>
                   {renderTfngRadio("q2")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">3. Sheep are the most common animals herded by nomadic herders.</div>
                   {renderTfngRadio("q3")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">4. The Fulani people frequently eat the animals which they herd.</div>
                   {renderTfngRadio("q4")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">5. In the tundra, reindeer are generally more valuable than other animals.</div>
                   {renderTfngRadio("q5")}
                 </div>

                 <div className="question question--plain">
                   <div className="question-text">6. Animals provide a source of income for nomadic herders.</div>
                   {renderTfngRadio("q6")}
                 </div>
               </div>
               ...
               <div className="question-group" style={{ marginTop: 16 }}>
                 ...
                 <p className="parncutt-summary">
                   <span className="summary-line">
                     <strong>Semi-nomadic and transhumance herding</strong>
                   </span>
                   <span className="summary-line">
                     <strong>Semi-nomadic herders</strong>
                   </span>
                   <span className="summary-line">
                     Almost all Bedouin are now semi-nomadic because of
                     {renderTextInput("q7")} and oil production.
                   </span>
                   <span className="summary-line">
                     Many young members of Mongolian semi-nomadic tribes now prefer to live in the
                     {renderTextInput("q8")}.
                   </span>
                   <span className="summary-line">
                     Sami have survived by herding, {renderTextInput("q9")} and catching wild animals.
                   </span>
                   <span className="summary-line">
                     Traditional Sami land is being exploited for its wood and
                     {renderTextInput("q10")}.
                   </span>
                   <span className="summary-line">&nbsp;</span>
                   <span className="summary-line">
                     <strong>Transhumance herders</strong>
                   </span>
                   <span className="summary-line">
                     Takes place in areas which are {renderTextInput("q11")}.
                   </span>
                   <span className="summary-line">
                     Herders stay in permanent {renderTextInput("q12")}.
                   </span>
                   <span className="summary-line">
                     Cattle and sheep spend the {renderTextInput("q13")} in the middle pastures.
                   </span>
                 </p>
               </div>
             </div>
