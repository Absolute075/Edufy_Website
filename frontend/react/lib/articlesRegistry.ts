...
export const articlesRegistry: Record<string, ArticleRule> = {
  ...
  "politics-02": {
    ...
    preview: "politics-02.png",
    tags: ["politics"],
    pages: 48,
    description: "AQ: Australian Quarterly is an analytical journal that publishes independent expert articles on politics and public policy, focusing on democracy, science, and major social challenges in Australia and globally.",
  },
  "research-04": {
    title: "New Scientist",
    file: "research-04.pdf",
    preview: "research-04.png",
    tags: ["research"],
    pages: 60,
    description: "The world, the universe and us",
  },
  "finance-03": {
    title: "The economist",
    file: "finance-03.pdf",
    preview: "finance-03.png",
    tags: ["finance"],
    pages: 68,
    description: "The angst over affordability",
  },
  "history-03": {
    title: "Welcome to history of WITCHCRAFT",
    file: "history-03.pdf",
    preview: "history-03.png",
    tags: ["history"],
    pages: 132,
    description: "Uncovering the truth behind the trials that tore Europe apart",
  },
  "history-04": {
    title: "History of Ghosts",
    file: "history-04.pdf",
    preview: "history-04.png",
    tags: ["history"],
    pages: 132,
    description: "Horrible hauntings and chilling tales",
  },
};